...
class Run(_RunBase):
    ...
    def log_table(self, name, value, description=""):
        ...
        :param name: The name of metric
        :type name: str
        :param value: The table value of the metric (dictionary where keys are columns to be posted to the service)
        :type value: dict
        :param description: An optional metric description
        :type description: str
        """
