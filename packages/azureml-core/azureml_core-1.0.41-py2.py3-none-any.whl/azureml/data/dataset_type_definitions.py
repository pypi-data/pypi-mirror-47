...
class HistogramCompareMethod(Enum):
    ...
    WASSERSTEIN = 0  #: Selects Wasserstein metric `https://wikipedia.org/wiki/Wasserstein_metric`
    ENERGY = 1  #: Selects Energy distance `https://wikipedia.org/wiki/Energy_distance`
