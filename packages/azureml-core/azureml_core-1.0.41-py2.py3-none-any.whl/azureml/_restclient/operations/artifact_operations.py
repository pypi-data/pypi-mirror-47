...
class ArtifactOperations(object):
    ...
    def list_in_container(
            self, subscription_id, resource_group_name, workspace_name, origin, container, continuationtoken=None, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def list_in_path(
            self, subscription_id, resource_group_name, workspace_name, origin, container, path, continuationtoken=None, custom_headers=None, raw=False, **operation_config):
        """
