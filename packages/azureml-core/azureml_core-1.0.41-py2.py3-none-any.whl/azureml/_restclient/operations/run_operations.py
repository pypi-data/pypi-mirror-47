...
class RunOperations(object):
    ...
    def get_child(
            self, subscription_id, resource_group_name, workspace_name, experiment_name, run_id, filter=None, continuationtoken=None, orderby=None, sortorder=None, top=None, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def update(
            self, subscription_id, resource_group_name, workspace_name, experiment_name, run_id, modify_run_dto=None, custom_headers=None, raw=False, **operation_config):
        """
        ...
        return deserialized
    update.metadata = {'url': '/history/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/experiments/{experimentName}/runs/{runId}'}
    ...
    def list(
            self, subscription_id, resource_group_name, workspace_name, experiment_name, filter=None, continuationtoken=None, orderby=None, sortorder=None, top=None, custom_headers=None, raw=False, **operation_config):
        """
        ...
        return deserialized
    list.metadata = {'url': '/history/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/experiments/{experimentName}/runs'}
