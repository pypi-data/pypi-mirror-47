...
class LegacyRunmetricOperations(object):
    """LegacyRunmetricOperations operations.
    ...
    def list(
            self, subscription_id, resource_group_name, workspace_name, project_name, filter=None, continuationtoken=None, orderby=None, sortorder=None, top=None, mergestrategytype=None, mergestrategyoptions=None, mergestrategysettingsversion=None, mergestrategysettingsselectmetrics=None, custom_headers=None, raw=False, **operation_config):
        """
        ...
        return deserialized
    list.metadata = {'url': '/history/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/projects/{projectName}/runmetrics'}

    def post(
            self, subscription_id, resource_group_name, workspace_name, project_name, run_id, run_metric_dto=None, custom_headers=None, raw=False, **operation_config):
        """
        ...
        # Construct body
        if run_metric_dto is not None:
            body_content = self._serialize.body(run_metric_dto, 'RunMetricDto')
        else:
            body_content = None
        ...
        if raw:
            ...
            return client_raw_response
    post.metadata = {'url': '/history/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/projects/{projectName}/runs/{runId}/runmetrics'}

    def get(
            self, subscription_id, resource_group_name, workspace_name, project_name, run_metric_id, custom_headers=None, raw=False, **operation_config):
        """
        ...
        path_format_arguments = {
            ...
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
            'projectName': self._serialize.url("project_name", project_name, 'str'),
            'runMetricId': self._serialize.url("run_metric_id", run_metric_id, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    get.metadata = {'url': '/history/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/projects/{projectName}/runmetrics/{runMetricId}'}
