...
class RunConfiguration(_AbstractRunConfigElement):
    ...
    def load(path, name):
        ...
        :param path: A user selected root directory for run configurations. Typically this is the Git Repository
            or the python project root directory. The configuration is loaded from a sub directory named .azureml.
        :type path: str
        :param name: The configuration file name.
        :type name: str
    ...
    def _get_all_run_configurations(path):
        ...
        :rtype: dict[string, RunConfiguration]
        """
            ...
            for file in filenames:
                ...
                if file_extension == RUNCONFIGURATION_EXTENSION:
                    ...
                    if os.path.isfile(run_config_file_path):
                        try:
                            run_config_object = RunConfiguration.load(path, name)
