...
from ..utils import (from_api,
                     ...
                     get_duplicate_features, camelize, underscorize,
...
class Project(APIObject):
    ...
    def get_associations(self, assoc_type, metric):
        ...
        metric : string
            the specified association metric, must be one of 'mutualInfo', 'cramersV', 'spearman',
            'pearson' or 'tau'
        ...
        features : list
            a list of dictionaries for each feature with the following keys:
                ...
                * alphabetic_sort_index : int
                    a number representing the alphabetical order of this feature compared to the
                    other features in this dataset
                * feature : string
                    the name of the feature
                * importance_sort_index: int
                    a number ranking the importance of this feature compared to the other features
                    in this dataset
                * strength_sort_index: int
                    a number ranking the strength of this feature compared to the other features in
                    this dataset
        ...
        """
        url = '{}{}/featureAssociationMatrix/'.format(self._path, self.id)
        params = {
            'metric': metric,
            'type': assoc_type
        }
    ...
    def get_association_matrix_details(self, feature1, feature2):
        ...
        types : list
            the type of ``feature1`` and ``feature2``, will be 'C' for categorical and 'N' for
            numeric.
        values : list
            a list of data triplets for pairwise plotting e.g.
        ...
        """
        url = '{}{}/featureAssociationMatrixDetails/'.format(self._path, self.id)
        params = {
            'feature1': feature1,
            'feature2': feature2
        }
    ...
    def batch_features_type_transform(self, parent_names, variable_type,
                                      prefix=None, suffix=None, max_wait=600):
        """
        ...
        variable_type : str
            The type new columns should have. Can be one of 'CATEGORICAL', 'CATEGORICAL_INT',
