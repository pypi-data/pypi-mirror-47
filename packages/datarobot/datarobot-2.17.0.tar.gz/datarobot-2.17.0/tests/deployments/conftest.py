...
def deployments_data():
    deployments = [{
        'id': '5c6f7a9e9ca9b20017ff95a2', 'label': 'is_bad Predictions', 'description': '',
        'model': {'projectId': '5c0a969859b00004ba52e41b', 'targetName': 'is_bad',
                  'id': '5cb9c8b979872d014a0bb080', 'type': 'TensorFlow Deep Learning Classifier'},
        'defaultPredictionServer': {'id': '5a7c7a72192765001fc22769',
                                    'url': 'https://pred.example.com', 'datarobot-key': '27782'},
        'predictionUsage': {'dailyRates': [5, 2, 10, 5, 13, 4, 7],
        ...
        'modelHealth': {'status': 'unknown', 'startDate': '2019-04-18T02:00:00.000000Z',
                        'endDate': '2019-04-22T02:00:00.000000Z'},
        'accuracyHealth': {'status': 'unavailable', 'startDate': None, 'endDate': None}
    }, {
        'id': '5c6f7a9e9ca9b20017ff93b7', 'label': 'is_bad Predictions2', 'description': None,
        'model': {'projectId': '5c0a969859b00004ba52e41b', 'targetName': 'is_bad',
                  'id': '5cb9c8b979872d014a0bb080', 'type': 'TensorFlow Deep Learning Classifier'},
        'defaultPredictionServer': {'id': '5a7c7a72192765001fc22769',
                                    'url': 'https://pred.example.com', 'datarobot-key': '27782'},
