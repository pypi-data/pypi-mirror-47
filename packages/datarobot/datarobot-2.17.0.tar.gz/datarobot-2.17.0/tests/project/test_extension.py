...
@responses.activate
@pytest.mark.usefixtures('client', 'project_creation_responses')
def test_create_with_extras(extras,
                            async_url):
    """
    ...
    with mock.patch.object(
            SpecialProject,
            'from_async',
            wraps=SpecialProject.from_async) as mock_from_async:
...
@responses.activate
@pytest.mark.usefixtures('client', 'project_aim_responses')
def test_set_target_with_extras(extras,
                                project_without_target_data):
    """
