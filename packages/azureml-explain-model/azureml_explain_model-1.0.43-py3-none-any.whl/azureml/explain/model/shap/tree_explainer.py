...
class TreeExplainer(PureStructuredModelExplainer):
    ...
    def __init__(self, model, explain_subset=None, features=None, classes=None,
                 shap_values_output=ShapValuesOutput.DEFAULT, transformations=None, **kwargs):
        ...
        if transformations is not None:
            self._datamapper, _ = get_datamapper_and_transformed_data(transformations=transformations)
