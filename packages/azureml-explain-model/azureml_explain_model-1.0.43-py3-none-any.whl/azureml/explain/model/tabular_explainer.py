        ...
        for uninitialized_explainer in uninitialized_explainers:
            try:
                if issubclass(uninitialized_explainer, PureStructuredModelExplainer):
                    self.explainer = uninitialized_explainer(self.model, transformations=transformations, **kwargs)
                else:
                    self.explainer = uninitialized_explainer(self.model, initialization_examples,
