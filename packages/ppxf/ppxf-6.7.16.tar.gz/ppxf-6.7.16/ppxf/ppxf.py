...
def rebin(x, factor):
    ...
    """
    if factor > 1:
        x = x.reshape(len(x)//factor, factor, -1).mean(1).squeeze()
...
class ppxf(object):
    ...
    galaxy:
        ...
        <http://adsabs.harvard.edu/abs/2017MNRAS.466..798C>`_ for details.
    ...
    noise:
        ...
        *relative* change of the fit residuals. For this reason, the penalty
        ...
        <http://adsabs.harvard.edu/abs/2004PASP..116..138C>`_ for details). If no
    ...
    bias:
        ...
        `Cappellari & Emsellem (2004)
        <http://adsabs.harvard.edu/abs/2004PASP..116..138C>`_ paper.
    ...
    regul:
        ...
        <http://adsabs.harvard.edu/abs/2017MNRAS.466..798C>`_ gives a
    ...
    .error:
        ...
        *assumes* that the fit is good, a corrected estimate of the errors is::
        ...
        <http://adsabs.harvard.edu/abs/2004PASP..116..138C>`_ for an explanation.
    .polyweights:
