...
from src.conversion import CP932Conversion
from src.environment import CP932
...
def c9conv(string: str, option: Option = Option.REPLACE.value) -> str:
    """
...
def _replacer(character: str, option: Option) -> str:
    ...
    try:
        ...
        if option == Option.REMOVE.value:
            return ""
        elif option == Option.KEEP.value:
            return character
        else:
            return "?"
