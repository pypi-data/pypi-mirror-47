    ...
    for line in source:
        ...
        if not reading_spectrum:
            ...
            if not lstrip or line[0] in _comments:
                ...
                # l = lstrip.split('=', 1)
                # llen = len(l)
                # if llen > 1: # spectrum-specific parameters!
                #     params[l[0].lower()] = l[1]#.strip()
                if '=' in lstrip:
                    try:
                        l = lstrip.split('=', 1)
                        params[l[0].lower()] = l[1]
                    except:
                        pass
                # elif llen == 1: # this must be a peak list
                    ...
                    if llen >= 2:
                        try:
                            ...
                            charges.append(aux._parse_charge(l[2]) if llen > 2 else 0)
                        except ValueError:
