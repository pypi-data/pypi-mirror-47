...
import web3
from snet_sdk.utils import normalize_private_key, get_contract_object, get_address_from_private
...
class Account:
    def __init__(self, w3, config, mpe_contract):
        ...
        self.token_contract = get_contract_object(self.web3, "SingularityNetToken.json")
