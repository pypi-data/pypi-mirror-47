...
class Da():
    ...
    def get_trigger(self, query):
        ...
        logging.info("trigger: {}".format(triggers))
        return triggers
    ...
    def get_parser(self, trigger, query):
        ...
        for pname in _res:
            ...
            for i in range(dict_count):
                dname = pattern_list[dict_count-i-1]
        ...
        logging.info("parser: {}".format(parsers))
        return parsers
...
if __name__ == '__main__':
    """test"""
    utils.init_logging(log_file='da', log_path=CUR_PATH)
    ...
    print(res)
    da = Da(dict_path=CUR_PATH + "/data/da/")
    # 意图分类
