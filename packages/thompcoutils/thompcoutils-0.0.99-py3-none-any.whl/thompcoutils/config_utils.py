    ...
    def write_value(self, entry, value):
        ...
        if value < cfg_last:
            ...
            if value < cfg_low:
                ...
                self.cfg_mgr.write_entry(section=entry, entry=self.change_amount_tag, value=cfg_low-value)
            ...
            if value > cfg_hi:
                ...
                self.cfg_mgr.write_entry(section=entry, entry=self.change_amount_tag, value=value-cfg_hi)
...
def test_hi_low_vals(file_name, section, value):
    ...
    assert_test(values[HiLow.hi_tag] == value, "value should match")
    assert_test(values[HiLow.last_tag] == value, "value should match")
    assert_test(values[HiLow.change_amount_tag] == 1, "value has not changed")
    ...
    assert_test(values[HiLow.hi_tag] == value, "value should match")
    assert_test(values[HiLow.last_tag] == value, "value should match")
    assert_test(round(values[HiLow.change_amount_tag], 2) == 1.1, "value has not changed")
    ...
    assert_test(values[HiLow.low_tag] == value, "value should match")
    assert_test(values[HiLow.last_tag] == value, "value should match")
    assert_test(values[HiLow.change_amount_tag] == 7.0, "value has not changed")
