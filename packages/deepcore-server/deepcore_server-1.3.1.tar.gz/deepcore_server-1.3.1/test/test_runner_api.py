...
from deepcore_server.api.runner_api import RunnerApi  # noqa: E501
...
class TestRunnerApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = deepcore_server.api.runner_api.RunnerApi()  # noqa: E501
