...
#	def plotMap(self, tet, clusts, var2bin='pos', ax=None, binsize=3,
...
#		axes = super(OptoClusterSummary, self).plotMap(tet, clusts, var2bin=var2bin, ax=ax, binsize=binsize, smooth_sz=smooth_sz, **kwargs)
#		for ax in axes:
#			if laser == 1:
#				ax.set_xlabel('Laser on')
#			elif laser == 0:
#				ax.set_xlabel('Laser off')
#				
#		return axes
...
#        stm_off.sort()
		...
		# print "Firing ratio: {0:.4f}".format(change)
