...
from morphenepython.price import Order, FilledOrder
...
class Notify(Events):
    """ Notifications on Blockchain events.
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            from morphenepython.notify import Notify
    ...
    def __init__(
        ...
        # Open the websocket
        self.websocket = MorpheneWebsocket(
            urls=self.morphene.rpc.nodes,
            user=self.morphene.rpc.user,
            password=self.morphene.rpc.password,
