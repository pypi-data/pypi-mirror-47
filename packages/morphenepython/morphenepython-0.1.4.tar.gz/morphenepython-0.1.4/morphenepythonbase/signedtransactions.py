...
from morphenepythongraphenebase.signedtransactions import Signed_Transaction as GrapheneSigned_Transaction
...
class Signed_Transaction(GrapheneSigned_Transaction):
    """ Create a signed transaction and offer method to create the
        ...
        :param num refNum: parameter ref_block_num (see :func:`morphenepythonbase.transactions.getBlockParams`)
        :param num refPrefix: parameter ref_block_prefix (see :func:`morphenepythonbase.transactions.getBlockParams`)
