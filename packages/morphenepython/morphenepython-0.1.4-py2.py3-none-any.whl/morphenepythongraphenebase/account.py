...
class PasswordKey(object):
    ...
    def __init__(self, account, password, role="active", prefix="MPH"):
...
class Address(object):
    """ Address class
        ...
        :param str prefix: Network prefix (defaults to ``MPH``)

        Example::

           Address("MPHFN9r6VYzBK8EKtMewfNbfiGCr56pHDBFi")

    """
    def __init__(self, address=None, pubkey=None, prefix="MPH"):
        self.prefix = prefix
...
class PublicKey(Address):
    """ This class deals with Public Keys and inherits ``Address``.
        ...
        Example::
           ...
           PublicKey("MPH6UtYWWs3rkZGV8JA86qrgkG6tyFksgECefKE1MiH4HkLD8PFGL")
    ...
    """
    def __init__(self, pk, prefix="MPH"):
        """Init PublicKey
            :param str pk: Base58 encoded public key
            :param str prefix: Network prefix (defaults to ``MPH``)
        """
...
class PrivateKey(PublicKey):
    ...
    """
    def __init__(self, wif=None, prefix="MPH"):
        if wif is None:
