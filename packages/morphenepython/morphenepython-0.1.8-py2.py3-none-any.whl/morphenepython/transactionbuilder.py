...
class TransactionBuilder(dict):
    """ This class simplifies the creation of transactions by adding
        ...
        .. testcode::
           ...
           mph = MorpheneClient(nobroadcast=True, keys={'active': wif})
           tx = TransactionBuilder(morphene_instance=mph)
    ...
    def broadcast(self, max_block_age=-1):
        ...
        try:
            ...
            for op in args['operations']:
                formattedOps.append({"type":f"{op[0]}_operation","value":op[1]})
            args['operations'] = formattedOps
