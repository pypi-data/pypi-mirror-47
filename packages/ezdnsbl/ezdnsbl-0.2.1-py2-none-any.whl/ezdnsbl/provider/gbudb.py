...
http_ref = 'http://www.gbudb.com/index.jsp'

return_codes = {
    '127.0.0.2': 'Email spam, scams, viruses, or other malware',
}


class Truncate(DNSBLBase):
    def __init__(self, ip, **kwargs):
        super(Truncate, self).__init__(**kwargs)
        self.http_ref = 'http://www.gbudb.com/truncate/index.jsp'
        self.ip = ip
        self.resolver = dns.resolver.Resolver()
        reverse_ip = self.reverse_ip(self.ip)
        self.host = 'truncate.gbudb.net'
        self.query_type = 'A'
