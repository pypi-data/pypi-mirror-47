...
http_ref = 'https://surriel.com/'

return_codes = {
    '127.0.0.2': 'Email Spam',
}


class PSBL(DNSBLBase):
    def __init__(self, ip, **kwargs):
        super(PSBL, self).__init__(**kwargs)
        self.http_ref = 'https://psbl.org/'
        self.ip = ip
        self.resolver = dns.resolver.Resolver()
        reverse_ip = self.reverse_ip(self.ip)
        self.host = 'psbl.surriel.com'
        self.query_type = 'A'
