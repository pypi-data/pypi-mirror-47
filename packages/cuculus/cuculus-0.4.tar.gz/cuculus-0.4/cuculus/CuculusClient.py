...
from cuculus.CuculusClientOptions import CuculusClientOptions
...
class CuculusClient:
    ...
    def __init__(self,
                 collectorUrl,
                 options: CuculusClientOptions,
                 logger=None):
        '''
        :param appId:string Application Id
        :param collectorUrl:string url of collector service. eg: http://localhost:6280/api/v1/Log
