...
__props__ = {
    '__Git_Branch__': '0.0.6',
    '__Git_Commit_Id__': 'ca849a300310f3c91cdbebf2d8633f4b60f7a0af',
    '__Git_Commit_Time__': '2019-06-08 20:09:05+02:00',
    '__Git_Dirty__': 'False',
    '__Git_Remote_Origin_Url__': 'https://gitlab-ci-token:zwbi9Ga7_BDd4WetxFzx@gitlab.com/intergral/agents/python-client.git',
    '__Git_Tags__': '[<git.TagReference "refs/tags/0.0.1">, <git.TagReference "refs/tags/0.0.2">, <git.TagReference "refs/tags/0.0.3">, <git.TagReference "refs/tags/0.0.4">, <git.TagReference "refs/tags/0.0.5">, <git.TagReference "refs/tags/0.0.6">]',
