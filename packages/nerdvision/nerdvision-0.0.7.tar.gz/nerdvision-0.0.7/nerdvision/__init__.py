...
__props__ = {
    '__Git_Branch__': '0.0.7',
    '__Git_Commit_Id__': '4efe16e725f4961d5b29fad50a7a8fe3f21d7013',
    '__Git_Commit_Time__': '2019-06-08 20:11:10+02:00',
    '__Git_Dirty__': 'False',
    '__Git_Remote_Origin_Url__': 'https://gitlab-ci-token:s1qGJV8zHfQkPCRxGRvc@gitlab.com/intergral/agents/python-client.git',
    '__Git_Tags__': '[<git.TagReference "refs/tags/0.0.1">, <git.TagReference "refs/tags/0.0.2">, <git.TagReference "refs/tags/0.0.3">, <git.TagReference "refs/tags/0.0.4">, <git.TagReference "refs/tags/0.0.5">, <git.TagReference "refs/tags/0.0.6">, <git.TagReference "refs/tags/0.0.7">]',
