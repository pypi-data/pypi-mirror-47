...
pyArchOps/helpers could always use more documentation, whether as part of the
official pyArchOps/helpers docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.7. Check
   https://gitlab.com/pyarchops/helpers/pipelines
