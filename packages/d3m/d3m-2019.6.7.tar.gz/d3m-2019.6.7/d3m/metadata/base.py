...
class Metadata:
    ...
    def query_field_with_exceptions(self, selector: Selector, field: str) -> typing.Tuple[typing.Any, typing.Dict[TupleSelector, typing.Any]]:
        ...
        Returns
        -------
        Tuple[Any, Dict[TupleSelector, Any]]
    ...
    def compact(self: T, fields_to_compact: typing.Sequence[str]) -> T:
        ...
        Parameters
        ----------
        fields_to_compact: Sequence[str]
    ...
    def to_internal_json_structure(self) -> typing.List[typing.Dict]:
        """
        ...
        return utils.to_json_structure(self.to_internal_simple_structure())

    def to_internal_simple_structure(self) -> typing.List[typing.Dict]:
        """
...
class PrimitiveMetadata(Metadata):
    ...
    def _validate(self) -> None:
        ...
        self._validate_docker_containers()
    ...
    def _validate_docker_containers(self) -> None:
        installation = self.query().get('installation', [])
    ...
    def get_volumes(self) -> typing.Sequence[typing.Dict]:
        ...
        # and "entry['type']" can be both a string or an enumeration instance.
        return [
            entry for entry in self.query().get('installation', [])
