...
setup(
    ...
    url='https://github.com/linhd-postdata/jollyjumper',
    ...
    project_urls={
        'Documentation': 'https://jollyjumper.readthedocs.io/',
        'Changelog': 'https://jollyjumper.readthedocs.io/en/latest/changelog.html',
        'Issue Tracker': 'https://github.com/linhd-postdata/jollyjumper/issues',
    },
    keywords=[
    ...
    entry_points={
        'console_scripts': [
            'jollyjumper = jollyjumper.cli:main',
        ]
    },
    cmdclass={
