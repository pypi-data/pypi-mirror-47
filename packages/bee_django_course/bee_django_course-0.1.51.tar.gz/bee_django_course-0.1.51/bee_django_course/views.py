...
def get_qiniu_token(key):
    ...
    access_key = 'XZAFb3ssi1knGIFVZWgNr9Mtpim96IOLy-Ph_6S6'
    secret_key = 'ZRL_uuv5Yodqk496Lytru26NCJxwxxygS3x1VQva'
    # 构建鉴权对象
    q = Auth(access_key, secret_key)
    # 要上传的空间
    bucket_name = 'chajia-upload'
    # key 上传后保存的文件名
...
def uptoken(request):
    ...
    return JsonResponse(data={
        'uptoken': token,
        'domain': 'qiniu.chajiatongmen.com',
    })