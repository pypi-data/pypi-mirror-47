...
class TcExRun(TcExBin):
    ...
    def deep_diff(self, db_data, user_data):
        ...
        try:
            ...
            return False
        if ddiff:
            self.tcex.log.info('[validate] Diff      : {}'.format(ddiff))
            return False
        return True
    ...
    def load_tcex(self):
        ...
        for arg, value in list(self.profile.get('profile_args', {}).data.items()):
    ...
    def stage_redis(self, variable, data):
        ...
        if variable.endswith('Binary'):
            ...
            try:
                ...
                msg = msg.format(variable)
                sys.exit(msg)
        self.log.info('[stage] Creating variable {}'.format(variable))
...
class ArgBuilder(object):
    ...
    def load(self, profile_args):
        ...
        """
        for key, value in list(profile_args.items()):
            self.add(key, value)
