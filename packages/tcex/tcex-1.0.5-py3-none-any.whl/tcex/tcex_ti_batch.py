...
class TcExBatch(object):
            ...
            if resource_type in self.tcex.group_types:
                ...
                if saved:
                    try:
                        ...
                        pass
            elif resource_type in list(self.tcex.indicator_types_data.keys()):
                try:
                    # indicators
    ...
    def __str__(self):
        ...
        groups = []
        for group_data in list(self.groups.values()):
            if isinstance(group_data, dict):
                groups.append(group_data)
            else:
                groups.append(group_data.data)
        for group_data in list(self.groups_shelf.values()):
            if isinstance(group_data, dict):
                groups.append(group_data)
            else:
                groups.append(group_data.data)
        ...
        indicators = []
        for indicator_data in list(self.indicators.values()):
            if isinstance(indicator_data, dict):
                indicators.append(indicator_data)
            else:
                indicators.append(indicator_data.data)
        for indicator_data in list(self.indicators_shelf.values()):
            if isinstance(indicator_data, dict):
                indicators.append(indicator_data)
            else:
                indicators.append(indicator_data.data)
