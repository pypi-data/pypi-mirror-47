...
class TektronixMDO3054(TektronixScope):
    ...
    def test(self):
        print("TektronixMDO3054 analog channel_names: {}".format(
              self._analog_channel_names))


if __name__ == "__main__":
    import collections
    data = {'info': {'instrument_type': 'TektronixMDO3054'}}
    command = collections.defaultdict(str, data)
    tester = TektronixMDO3054(command=command)
    tester.test()
