...
class TektronixMDO3034(TektronixScope):
    ...
    def test(self):
        print("TektronixMDO3034 analog channel_names: {}".format(
              self._analog_channel_names))


if __name__ == "__main__":
    import collections
    data = {'info': {'instrument_type': 'TektronixMDO3034'}}
    command = collections.defaultdict(str, data)
    tester = TektronixMDO3034(command=command)
    tester.test()
