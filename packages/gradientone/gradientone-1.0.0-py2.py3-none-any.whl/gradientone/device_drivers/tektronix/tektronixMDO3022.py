...
class TektronixMDO3022(TektronixScope):
    ...
    def test(self):
        print("TektronixMDO3022 analog channel_names: {}".format(
              self._analog_channel_names))


if __name__ == "__main__":
    import collections
    data = {'info': {'instrument_type': 'TektronixMDO3022'}}
    command = collections.defaultdict(str, data)
    tester = TektronixMDO3022(command=command)
    tester.test()
