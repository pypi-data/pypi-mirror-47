...
class TektronixMDO3102(TektronixScope):
    ...
    def test(self):
        print("TektronixMDO3102 analog channel_names: {}".format(
              self._analog_channel_names))


if __name__ == "__main__":
    import collections
    data = {'info': {'instrument_type': 'TektronixMDO3102'}}
    command = collections.defaultdict(str, data)
    tester = TektronixMDO3102(command=command)
    tester.test()
