...
class TektronixMDO3024(TektronixScope):
    ...
    def test(self):
        print("TektronixMDO3024 analog channel_names: {}".format(
              self._analog_channel_names))


if __name__ == "__main__":
    import collections
    data = {'info': {'instrument_type': 'TektronixMDO3024'}}
    command = collections.defaultdict(str, data)
    tester = TektronixMDO3024(command=command)
    tester.test()
