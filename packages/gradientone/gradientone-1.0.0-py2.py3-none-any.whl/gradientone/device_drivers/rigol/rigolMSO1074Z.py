...
class RigolMSO1074Z(RigolScope):

    def __init__(self, command, instrument=None):
        super(RigolMSO1074Z, self).__init__(command, instrument)
...
if __name__ == "__main__":
    import collections
    data = {'info': {'instrument_type': 'RigolMSO1074Z'}}
    command = collections.defaultdict(str, data)
    tester = RigolMSO1074Z(command=command)
    tester.test()
