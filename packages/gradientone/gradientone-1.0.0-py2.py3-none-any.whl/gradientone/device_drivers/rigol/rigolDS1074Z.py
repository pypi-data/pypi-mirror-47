...
class RigolDS1074Z(RigolScope):

    def __init__(self, command, instrument=None):
        super(RigolDS1074Z, self).__init__(command, instrument)
...
if __name__ == "__main__":
    import collections
    data = {'info': {'instrument_type': 'RigolDS1074Z'}}
    command = collections.defaultdict(str, data)
    tester = RigolDS1074Z(command=command)
    tester.test()
