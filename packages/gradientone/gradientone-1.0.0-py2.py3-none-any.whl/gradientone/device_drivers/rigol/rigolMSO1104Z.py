...
class RigolMSO1104Z(RigolScope):

    def __init__(self, command, instrument=None):
        super(RigolMSO1104Z, self).__init__(command, instrument)
...
if __name__ == "__main__":
    import collections
    data = {'info': {'instrument_type': 'RigolMSO1104Z'}}
    command = collections.defaultdict(str, data)
    tester = RigolMSO1104Z(command=command)
    tester.test()
