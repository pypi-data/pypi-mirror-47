...
class RigolMSO1000Z(RigolScope):

    def __init__(self, command, instrument=None):
        super(RigolMSO1000Z, self).__init__(command, instrument)
...
if __name__ == "__main__":
    import collections
    data = {'info': {'instrument_type': 'RigolMSO1000Z'}}
    command = collections.defaultdict(str, data)
    tester = RigolMSO1000Z(command=command)
    tester.test()
