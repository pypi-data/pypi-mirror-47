...
# Base information
ab1 = scopus.AbstractRetrieval("2-s2.0-84930616647", view="FULL", refresh=False)
# Conference proceeding and no references
ab2 = scopus.AbstractRetrieval("2-s2.0-0029486824", view="FULL", refresh=False)
# Issuetitle and no affiliation
ab3 = scopus.AbstractRetrieval("2-s2.0-0001270077", view="FULL", refresh=False)
# Author group broken and author keywords
ab4 = scopus.AbstractRetrieval("2-s2.0-0000016206", view="FULL", refresh=False)
# ISBN
ab5 = scopus.AbstractRetrieval("2-s2.0-84919546381", view="FULL", refresh=False)
# Funding, sequencebanks, chemicals
ab6 = scopus.AbstractRetrieval("2-s2.0-85053478849", view="FULL", refresh=False)
# Contributor group
ab7 = scopus.AbstractRetrieval("2-s2.0-85050253030", view="FULL", refresh=False)
# REF view
ab8 = scopus.AbstractRetrieval("2-s2.0-84951753303", view="REF", refresh=False)
