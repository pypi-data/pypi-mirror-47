#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Tests for `ContentAffiliationRetrieval` module."""
...
aff = scopus.ContentAffiliationRetrieval('60000356', refresh=False)
...
def test_name_variants():
    ...
    expected = "<class 'scopus.affiliation_retrieval.Variant'>"
