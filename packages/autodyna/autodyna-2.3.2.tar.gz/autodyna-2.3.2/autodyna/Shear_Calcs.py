...
class Shear_Calcs():
    ...
    def __Conc_Cap__(self, Ned):
        ...
        if self.codeOption == 'EC2':
            ...
            if (self.shape == 'Rectangular Beam') |\
                ...
                bwx = min(self.bx, self.by)
                bwy = min(self.hx, self.hy)
    ...
    def prLimits(self):
        '''
        Calculates plastic rotation thresholds following procedures from ASCE 41-17
        '''
        ...
        if self.fParams:
            ...
            if (self.shape == 'Circular') |\
                ...
                # Determine values required to calculate table constants (ASCE
                # 41 Tables 10-8 and 10-9)
