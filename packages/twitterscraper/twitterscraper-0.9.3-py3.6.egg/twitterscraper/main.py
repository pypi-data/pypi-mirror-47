        ...
        if args.dump:
            ...
            if args.profiles and tweets:
                ...
                with open(filename, "w", encoding="utf-8") as output:
                    ...
                    # f = csv.writer(output)
                    # f.writerow(['id','fullname','date_joined','location','blog', 'num_tweets','following','followers','likes','lists'])
                    # for x in list_users_info:
                        # f.writerow([x.id, x.full_name, x.date_joined, x.location, x.blog,
                                    # x.tweets, x.following, x.followers,
                                    # x.likes, x.lists])
