...
def plot_history(history: Dict[str, List[float]], interpolate:bool=False, side: float = 5, graphs_per_row: int = 4, x_label:str="Epochs"):
    """Plot given training history.
        ...
        x_label:str="Epochs", label for the X axis.
    """
