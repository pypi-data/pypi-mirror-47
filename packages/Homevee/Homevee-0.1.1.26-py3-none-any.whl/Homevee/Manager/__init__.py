...
class Manager():
    ...
    @abstractmethod
    def item_exists(self, item: Type[Item], db: Database = None) -> bool:
        """
    ...
    @abstractmethod
    def create(self, item: Type[Item], db: Database = None) -> bool:
        """
    ...
    @abstractmethod
    def update(self, item: Type[Item], db: Database = None) -> bool:
        """
    ...
    @abstractmethod
    def delete(self, item: Type[Item], db: Database = None) -> bool:
        """
    ...
    @abstractmethod
    def get_all(self, db: Database = None) -> List[Type[Item]]:
        """
    ...
    @abstractmethod
    def find_by_id(self, id: int, db: Database = None) -> Type[Item]:
        """
