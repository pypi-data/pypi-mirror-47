...
def hessian(im):
    """
    This fuction computes the hessian matrix of grey values (the double gradient)
    and returns eigenvavlues and eigenvectors of the hessian matrix for each voxel...
