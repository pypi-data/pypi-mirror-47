...
void labelToFloat(   int volSizeZin,    int volSizeYin,  int volSizeXin,   labels::label* volLab,
                     int maxLabel,                                                 float* labelFloats,
                     int volSizeZout,   int volSizeYout, int volSizeXout,          float* volOutput
                    )
{
