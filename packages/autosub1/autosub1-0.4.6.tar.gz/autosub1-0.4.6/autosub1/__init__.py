"""
Defines autosub1's main functionality.
"""
...
from autosub1.constants import (
    LANGUAGE_CODES, GOOGLE_SPEECH_API_KEY, GOOGLE_SPEECH_API_URL,
)
from autosub1.formatters import FORMATTERS

DEFAULT_SUBTITLE_FORMAT = 'json'
DEFAULT_CONCURRENCY = 10
DEFAULT_SRC_LANGUAGE = 'hi'
DEFAULT_DST_LANGUAGE = 'hi'
...
def find_speech_regions(filename, frame_width=4096, min_region_size=6.4, max_region_size=20): # pylint: disable=too-many-locals
    """
    ...
    threshold = percentile(energies, 0.16)
    ...
    for energy in energies:
        ...
        if (max_exceeded or is_silence) and region_start:
            if elapsed_time - region_start >= min_region_size:
                regions.append((prev_end, elapsed_time))
		prev_end = elapsed_time
                region_start = None
...
def validate(args):
    """
    Check that the CLI arguments passed to autosub1 are valid.
    """
...
def main():
    """
    Run autosub1 as a command-line program.
    """
