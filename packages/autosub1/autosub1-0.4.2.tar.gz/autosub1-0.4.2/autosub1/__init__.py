...
def find_speech_regions(filename, frame_width=4096, min_region_size=3.5, max_region_size=20): # pylint: disable=too-many-locals
    """
    ...
    threshold = percentile(energies, 0.05)
