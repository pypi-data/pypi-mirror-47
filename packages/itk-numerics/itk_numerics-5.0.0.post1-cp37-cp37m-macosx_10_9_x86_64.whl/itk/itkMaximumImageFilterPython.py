...
class itkMaximumImageFilterIF2IF2IF2(itkBinaryGeneratorImageFilterPython.itkBinaryGeneratorImageFilterIF2IF2IF2):
    ...
    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/MaximumImageFilt
    er Pixel wise compare two input images and set the output pixel to
    their max

    C++ includes: itkMaximumImageFilter.h 
    """
