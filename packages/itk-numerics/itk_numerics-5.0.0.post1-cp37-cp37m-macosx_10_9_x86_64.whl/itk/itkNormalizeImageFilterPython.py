...
class itkNormalizeImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    See:   NormalizeToConstantImageFilter Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/NormalizeImageFi
    lter Normalize an image
