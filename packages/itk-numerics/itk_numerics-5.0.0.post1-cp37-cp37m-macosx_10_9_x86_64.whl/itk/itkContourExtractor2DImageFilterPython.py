...
class itkContourExtractor2DImageFilterIF2(itkImageToPathFilterPython.itkImageToPathFilterIF2PLPP2):
    ...
    See:   PolyLineParametricPath Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/Segmentation/ContourExtractor2DI
    mageFilter Extract contours from an image
