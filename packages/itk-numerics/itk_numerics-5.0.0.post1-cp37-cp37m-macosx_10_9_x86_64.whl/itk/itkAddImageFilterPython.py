...
class itkAddImageFilterIF2IF2IF2(itkBinaryGeneratorImageFilterPython.itkBinaryGeneratorImageFilterIF2IF2IF2):
    ...
    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/AddImageFilter
    Add two images together

    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/AddConstantToIma
    geFilter Add a constant to every pixel in an image
