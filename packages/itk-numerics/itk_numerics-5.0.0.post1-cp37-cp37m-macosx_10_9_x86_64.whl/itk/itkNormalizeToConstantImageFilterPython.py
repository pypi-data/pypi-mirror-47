...
class itkNormalizeToConstantImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    See:   DivideImageFilter Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/NormalizeToConst
    antImageFilter Scale all pixels so that their sum is a specified
    constant
