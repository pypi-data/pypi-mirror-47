...
class itkBSplineExponentialDiffeomorphicTransformD2(itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD2):
    ...
    C++ includes: itkBSplineExponentialDiffeomorphicTransform.h 
    """
    ...
    def SetNumberOfControlPointsForTheConstantVelocityField(self, _arg: 'itkFixedArrayUI2') -> "void":
        ...
        Set/Get the control point grid size defining the B-spline estimate of
        the smoothed velocity field. In each dimension, the B-spline mesh size
        is equal to the number of control points in that dimension minus the
        spline order. Default = 4 control points in each dimension for a mesh
        size of 1 in each dimension. 
        """
    ...
    def SetNumberOfControlPointsForTheUpdateField(self, _arg: 'itkFixedArrayUI2') -> "void":
        ...
        Set the control
        point grid size defining the B-spline estimate of the smoothed update
    ...
    def SetMeshSizeForTheConstantVelocityField(self, arg0: 'itkFixedArrayUI2') -> "void":
        ...
        Set the update
        field mesh size which is used to specify the control point grid size.
        The mesh size in each dimension is calculated as the difference
    ...
    def SetMeshSizeForTheUpdateField(self, arg0: 'itkFixedArrayUI2') -> "void":
        ...
        Set
        the velocity field mesh size which is used to specify the control
        point grid size. The mesh size in each dimension is calculated as the
