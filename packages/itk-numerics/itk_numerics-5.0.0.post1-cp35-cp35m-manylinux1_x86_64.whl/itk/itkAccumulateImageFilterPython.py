...
class itkAccumulateImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    C++ includes: itkAccumulateImageFilter.h 
    """
    ...
    def GetAccumulateDimension(self) -> "unsigned int":
        ...
        Input and
        output images must be the same dimension, or the output's dimension
        must be one less than that of the input. Set the direction in which to
        accumulate the data. It must be set before the update of the filter.
    ...
    def SetAverage(self, _arg: 'bool const') -> "void":
        ...
        Perform a division by
        the size of the accumulated dimension after the accumulation is done.
        If true, the output image is the average of the accumulated dimension,
        if false the output is the sum of the pixels along the selected
