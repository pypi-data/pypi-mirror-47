...
class itkRegionOfInterestImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    See:  ExtractImageFilter Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/RegionOfInterest
    ImageFilter Extract a portion of an image (region of interest)
