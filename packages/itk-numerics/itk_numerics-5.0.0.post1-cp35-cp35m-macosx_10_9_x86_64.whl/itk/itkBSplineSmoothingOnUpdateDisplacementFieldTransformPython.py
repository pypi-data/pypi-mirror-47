...
class itkBSplineSmoothingOnUpdateDisplacementFieldTransformD2(itkDisplacementFieldTransformPython.itkDisplacementFieldTransformD2):
    ...
    C++ includes: itkBSplineSmoothingOnUpdateDisplacementFieldTransform.h
    ...
    def UpdateTransformParameters(self, update: 'itkArrayD', factor: 'double'=1.) -> "void":
        ...
        is of the same length as Parameters. Throw exception otherwise. The
        update process performs an smoothing on the displacement field by
        using BSplines. factor is a scalar multiplier for each value in
        update. BSplineSmoothDisplacementField is called after the update is
    ...
    def SetSplineOrder(self, _arg: 'unsigned int const') -> "void":
        ...
        defining the bias field estimate. Default = 3. 
        """
    ...
    def GetSplineOrder(self) -> "unsigned int":
        ...
        defining the displacement field estimate. Default = 3. 
        """
    ...
    def SetNumberOfControlPointsForTheUpdateField(self, _arg: 'itkFixedArrayUI2') -> "void":
        ...
        Set the control
        point grid size defining the B-spline estimate of the update field. In
        each dimension, the B-spline mesh size is equal to the number of
        control points in that dimension minus the spline order. Default = 4
        control points in each dimension for a mesh size of 1 in each
        dimension. 
        """
    ...
    def SetMeshSizeForTheUpdateField(self, arg0: 'itkFixedArrayUI2') -> "void":
        ...
        Set
        the update field mesh size which is used to specify the control point
        grid size. The mesh size in each dimension is calculated as the
        difference between the control point grid size and the spline order,
        i.e. meshSize = controlPointGridSize - SplineOrder. 
        """
    ...
    def SetNumberOfControlPointsForTheTotalField(self, _arg: 'itkFixedArrayUI2') -> "void":
        ...
        Set the control
        point grid size defining the B-spline estimate of the total field. In
        each dimension, the B-spline mesh size is equal to the number of
        control points in that dimension minus the spline order. Default = 4
        control points in each dimension for a mesh size of 1 in each
        dimension. 
    ...
    def GetNumberOfControlPointsForTheTotalField(self) -> "itkFixedArrayUI2":
        ...
        Get the control
        point grid size defining the B-spline estimate of the scalar bias
        field. In each dimension, the B-spline mesh size is equal to the
        number of control points in that dimension minus the spline order.
        Default = 4 control points in each dimension for a mesh size of 1 in
        each dimension. 
        """
    ...
    def SetMeshSizeForTheTotalField(self, arg0: 'itkFixedArrayUI2') -> "void":
        ...
        Set the
        total field mesh size which is used to specify the control point grid
        size. The mesh size in each dimension is calculated as the difference
    ...
    def EnforceStationaryBoundaryOn(self) -> "void":
        ...
        Enforce
        stationary boundaries. Important for diffeomorphic transforms. 
        """
