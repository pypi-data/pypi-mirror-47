...
class itkPolyLineParametricPath2(itkParametricPathPython.itkParametricPath2):
    ...
    See:  Vector Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/Curves/PolyLineParametricPath A
    data structure for a piece-wise linear curve
    ...
    def AddVertex(self, vertex: 'itkContinuousIndexD2') -> "void":
        ...
        of consecutive verticies is separated by one unit of input). 
        """
