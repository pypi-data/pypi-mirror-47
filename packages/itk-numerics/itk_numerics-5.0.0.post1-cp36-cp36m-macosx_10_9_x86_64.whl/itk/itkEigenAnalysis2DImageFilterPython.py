...
class itkEigenAnalysis2DImageFilterIF2IF2IVF22(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    C++ includes: itkEigenAnalysis2DImageFilter.h 
    """
    ...
    def SetInput1(self, image1: 'itkImageF2') -> "void":
        ...
        Connect the image
        containting the elements [0,0] of the input 2D matrix 
        """
    ...
    def SetInput2(self, image2: 'itkImageF2') -> "void":
        ...
        Connect the image
        containting the elements [0,1] of the input 2D matrix. This is the
        same [1,0] element given that the input matrix is expected to be
        symmetric 
        """
    ...
    def SetInput3(self, image3: 'itkImageF2') -> "void":
        ...
        Connect the image
        containting the elements [1,1] of the input 2D matrix 
        """
    ...
    def GetMaxEigenValue(self) -> "itkImageF2 *":
        ...
        Get the Output
        image with the greatest eigenvalue 
        """
    ...
    def GetMinEigenValue(self) -> "itkImageF2 *":
        ...
        Get the Output
        image with the smallest eigenvalue 
        """
    ...
    def GetMaxEigenVector(self) -> "itkImageVF22 *":
        ...
        Get the Output
        image with the eigen vector associated with the greatest eigen value
