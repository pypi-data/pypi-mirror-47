...
class AWSStatusMaintainer:
    ...
    def update_app_instance_outputs(self, instance_logical_id, instance_id, app_name, outputs: str):
        try:
        ...
        self.table_data["apps"][instance_logical_id]["instances"][instance_id]["apps"][app_name]["outputs"] = outputs
