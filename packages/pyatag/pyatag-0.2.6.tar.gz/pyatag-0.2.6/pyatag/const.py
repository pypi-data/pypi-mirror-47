...
SENSOR_TYPES = {
    'device_id': ['Atag One ID', '', 'mdi:account-card-details-outline', 'device_id'],
    'device_status': ['Atag One status', '', 'mdi:account-card-details-outline', 'device_status'],
    'connection_status': ['Atag One ID', '', 'mdi:wifi', 'connection_status'],
    'date_time': ['Atag One ID', '', 'mdi:calendar-clock', 'date_time'],
