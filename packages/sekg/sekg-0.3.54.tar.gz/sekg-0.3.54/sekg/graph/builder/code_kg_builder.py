...
class CodeElementGraphDataBuilder:
    ...
    def add_relation_by_not_creating_entity(self, start_name, end_name, relation_type):
        ...
        if not start_name:
            print("start name not valid, start name=%r" % start_name)
            return False
        if not end_name:
            print("end name not valid, end name=%r" % end_name)
            return False
    ...
    def add_relation_by_creating_not_exist_entity(self, start_entity_name, end_entity_name, relation_type):
        ...
        if not start_name:
            print("start name not valid, start name=%r" % start_entity_name)
            return False
        if not end_name:
            print("end name not valid, end name=%r" % end_entity_name)
            return False
