...
class IdentifierInfoExtractor:
    ...
    def extract_from_method_name(self, method_name, mark_for_identifier_in_relation=IDENTIFIER_ENTITY):
        terms = set()
        operations = set()
    ...
    def extract_from_variable(self, variable, mark_for_identifier_in_relation=IDENTIFIER_ENTITY):
        ...
        identifier_relations = set()
        for lemma in terms:
            identifier_relations.add((mark_for_identifier_in_relation, RelationType.NAME_RELATED_TO.value, lemma))
