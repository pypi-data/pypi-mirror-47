...
from ..estimator import _FrameworkBaseEstimator
from .._estimator_helper import _estimator_submit_method, _update_environment_variables
...
class Chainer(_FrameworkBaseEstimator):
    ...
    :param distributed_training: Parameters for running a distributed training job. Please use this option
        ...
        For running a distributed job with MPI backend, use :class:`azureml.core.runconfig.MpiConfiguration` object to
        specify process_count_per_node.
    ...
    def __init__(self,
        ...
        if self._estimator_config.communicator == "IntelMpi":
            _update_environment_variables(self._estimator_config,
