...
from .run import Run, HyperDriveRun
...
# TODO RK: this is not the right place to have this, it requires the user to import HD module
Run.add_type_provider(HyperDriveRun.RUN_TYPE, HyperDriveRun._from_run_dto)
