...
class MUDSocket(MUDServer):
    ...
    class Client(MUDObject):

        def __str__(self):
            return "Client({}, <{}>)".format(self.socket, self.address)
        ...
        def parse_message(self, message):
            return MUDSocket.TelnetMessage(self, message)
    ...
    def handle_incoming_connections(self):
        ...
        client = MUDSocket.Client(client_socket, addr)
