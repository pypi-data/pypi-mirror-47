...
def surf_import_irap_bin(filename, mode, swig_np_dbl_aout_v1, option, debug):
    return _cxtgeo.surf_import_irap_bin(filename, mode, swig_np_dbl_aout_v1, option, debug)
surf_import_irap_bin = _cxtgeo.surf_import_irap_bin

def surf_import_irap_ascii(filename, mode, swig_np_dbl_aout_v1, option, debug):
    return _cxtgeo.surf_import_irap_ascii(filename, mode, swig_np_dbl_aout_v1, option, debug)
surf_import_irap_ascii = _cxtgeo.surf_import_irap_ascii

def surf_import_ijxyz(file, mode, swig_np_int_aout_v1, swig_np_int_aout_v2, swig_np_dbl_aout_v1, option, debug):
    return _cxtgeo.surf_import_ijxyz(file, mode, swig_np_int_aout_v1, swig_np_int_aout_v2, swig_np_dbl_aout_v1, option, debug)
surf_import_ijxyz = _cxtgeo.surf_import_ijxyz

def surf_import_ijxyz_tmpl(file, swig_np_int_in_v1, swig_np_int_in_v2, swig_np_dbl_aout_v1, option, debug):
    return _cxtgeo.surf_import_ijxyz_tmpl(file, swig_np_int_in_v1, swig_np_int_in_v2, swig_np_dbl_aout_v1, option, debug)
surf_import_ijxyz_tmpl = _cxtgeo.surf_import_ijxyz_tmpl

def surf_export_irap_bin(filename, mx, my, xori, yori, xinc, yinc, rot, swig_np_dbl_in_v1, option, debug):
    return _cxtgeo.surf_export_irap_bin(filename, mx, my, xori, yori, xinc, yinc, rot, swig_np_dbl_in_v1, option, debug)
surf_export_irap_bin = _cxtgeo.surf_export_irap_bin

def surf_export_irap_ascii(filename, mx, my, xori, yori, xinc, yinc, rot, swig_np_dbl_in_v1, zmin, zmax, option, debug):
    return _cxtgeo.surf_export_irap_ascii(filename, mx, my, xori, yori, xinc, yinc, rot, swig_np_dbl_in_v1, zmin, zmax, option, debug)
surf_export_irap_ascii = _cxtgeo.surf_export_irap_ascii

def surf_export_zmap_ascii(filename, mx, my, xori, yori, xinc, yinc, swig_np_dbl_in_v1, zmin, zmax, option, debug):
    return _cxtgeo.surf_export_zmap_ascii(filename, mx, my, xori, yori, xinc, yinc, swig_np_dbl_in_v1, zmin, zmax, option, debug)
surf_export_zmap_ascii = _cxtgeo.surf_export_zmap_ascii

def surf_export_storm_bin(filename, mx, my, xori, yori, xinc, yinc, swig_np_dbl_in_v1, zmin, zmax, option, debug):
    return _cxtgeo.surf_export_storm_bin(filename, mx, my, xori, yori, xinc, yinc, swig_np_dbl_in_v1, zmin, zmax, option, debug)
surf_export_storm_bin = _cxtgeo.surf_export_storm_bin

def surf_export_ijxyz(filename, mx, my, xori, yori, xinc, yinc, rot, yflip, swig_np_int_in_v1, swig_np_int_in_v2, swig_np_dbl_in_v1, option, debug):
    return _cxtgeo.surf_export_ijxyz(filename, mx, my, xori, yori, xinc, yinc, rot, yflip, swig_np_int_in_v1, swig_np_int_in_v2, swig_np_dbl_in_v1, option, debug)
...
def surf_xyz_from_ij(i, j, xori, xinc, yori, yinc, nx, ny, yflip, rot_deg, swig_np_dbl_in_v1, flag, debug):
    return _cxtgeo.surf_xyz_from_ij(i, j, xori, xinc, yori, yinc, nx, ny, yflip, rot_deg, swig_np_dbl_in_v1, flag, debug)
...
def surf_get_z_from_ij(ic, jc, x, y, nx, ny, xinc, yinc, xori, yori, p_map_v, debug):
    return _cxtgeo.surf_get_z_from_ij(ic, jc, x, y, nx, ny, xinc, yinc, xori, yori, p_map_v, debug)
surf_get_z_from_ij = _cxtgeo.surf_get_z_from_ij

def surf_get_z_from_xy(x, y, nx, ny, xori, yori, xinc, yinc, yflip, rot_deg, swig_np_dbl_in_v1, debug):
    return _cxtgeo.surf_get_z_from_xy(x, y, nx, ny, xori, yori, xinc, yinc, yflip, rot_deg, swig_np_dbl_in_v1, debug)
surf_get_z_from_xy = _cxtgeo.surf_get_z_from_xy

def surf_get_zv_from_xyv(swig_np_dbl_in_v1, swig_np_dbl_in_v2, swig_np_dbl_inplace_v1, nx, ny, xori, yori, xinc, yinc, yflip, rot_deg, swig_np_dbl_in_v3, debug):
    return _cxtgeo.surf_get_zv_from_xyv(swig_np_dbl_in_v1, swig_np_dbl_in_v2, swig_np_dbl_inplace_v1, nx, ny, xori, yori, xinc, yinc, yflip, rot_deg, swig_np_dbl_in_v3, debug)
...
def surf_resample(nx1, ny1, xori1, xinc1, yori1, yinc1, yflip1, rota1, swig_np_dbl_in_v1, nx2, ny2, xori2, xinc2, yori2, yinc2, yflip2, rota2, swig_np_dbl_inplace_v1, option, debug):
    return _cxtgeo.surf_resample(nx1, ny1, xori1, xinc1, yori1, yinc1, yflip1, rota1, swig_np_dbl_in_v1, nx2, ny2, xori2, xinc2, yori2, yinc2, yflip2, rota2, swig_np_dbl_inplace_v1, option, debug)
surf_resample = _cxtgeo.surf_resample

def surf_get_dist_values(xori, xinc, yori, yinc, nx, ny, rot_deg, x0, y0, azimuth, swig_np_dbl_inplace_v1, flag, debug):
    return _cxtgeo.surf_get_dist_values(xori, xinc, yori, yinc, nx, ny, rot_deg, x0, y0, azimuth, swig_np_dbl_inplace_v1, flag, debug)
...
def surf_sample_grd3d_lay(nx, ny, nz, p_coord_v, p_zcorn_v, p_actnum_v, klayer, mx, my, xori, xstep, yori, ystep, rotation, swig_np_dbl_inplace_v1, swig_np_dbl_inplace_v2, swig_np_dbl_inplace_v3, option, debug):
    return _cxtgeo.surf_sample_grd3d_lay(nx, ny, nz, p_coord_v, p_zcorn_v, p_actnum_v, klayer, mx, my, xori, xstep, yori, ystep, rotation, swig_np_dbl_inplace_v1, swig_np_dbl_inplace_v2, swig_np_dbl_inplace_v3, option, debug)
...
def pol_geometrics(nlen, xv, yv, zv, hlenv, debug):
    return _cxtgeo.pol_geometrics(nlen, xv, yv, zv, hlenv, debug)
...
def sucu_ij_from_xy(i, j, rx, ry, x, y, xori, xinc, yori, yinc, nx, ny, yflip, rot_azi_deg, flag, debug):
    return _cxtgeo.sucu_ij_from_xy(i, j, rx, ry, x, y, xori, xinc, yori, yinc, nx, ny, yflip, rot_azi_deg, flag, debug)
sucu_ij_from_xy = _cxtgeo.sucu_ij_from_xy

def cube_scan_segy_hdr(file, gn_bitsheader, gn_formatcode, gf_segyformat, gn_samplespertrace, gn_measuresystem, option, outfile, debug):
    return _cxtgeo.cube_scan_segy_hdr(file, gn_bitsheader, gn_formatcode, gf_segyformat, gn_samplespertrace, gn_measuresystem, option, outfile, debug)
cube_scan_segy_hdr = _cxtgeo.cube_scan_segy_hdr

def cube_import_storm(nx, ny, nz, file, lstart, swig_np_flt_aout_v1, option, debug):
    return _cxtgeo.cube_import_storm(nx, ny, nz, file, lstart, swig_np_flt_aout_v1, option, debug)
cube_import_storm = _cxtgeo.cube_import_storm

def cube_import_segy(file, hbitoffset, formatcode, segyformat, samplespertrace, nx, ny, nz, p_val_v, xori, xinc, yori, yinc, zori, zinc, rotation, yflip, zflip, minval, maxval, optscan, option, outfile, debug):
    return _cxtgeo.cube_import_segy(file, hbitoffset, formatcode, segyformat, samplespertrace, nx, ny, nz, p_val_v, xori, xinc, yori, yinc, zori, zinc, rotation, yflip, zflip, minval, maxval, optscan, option, outfile, debug)
cube_import_segy = _cxtgeo.cube_import_segy

def cube_import_rmsregular(iline, ndef, ndefsum, nx, ny, nz, val_v, vmin, vmax, file, ierr, debug):
    return _cxtgeo.cube_import_rmsregular(iline, ndef, ndefsum, nx, ny, nz, val_v, vmin, vmax, file, ierr, debug)
cube_import_rmsregular = _cxtgeo.cube_import_rmsregular

def cube_export_segy(sfile, nx, ny, nz, swig_np_flt_in_v1, xori, xinc, yori, yinc, zori, zinc, rotation, yflip, zflip, ilinesp, xlinesp, tracidp, option, debug):
    return _cxtgeo.cube_export_segy(sfile, nx, ny, nz, swig_np_flt_in_v1, xori, xinc, yori, yinc, zori, zinc, rotation, yflip, zflip, ilinesp, xlinesp, tracidp, option, debug)
cube_export_segy = _cxtgeo.cube_export_segy

def cube_export_rmsregular(nx, ny, nz, xmin, ymin, zmin, xinc, yinc, zinc, rotation, yflip, swig_np_flt_in_v1, file, debug):
    return _cxtgeo.cube_export_rmsregular(nx, ny, nz, xmin, ymin, zmin, xinc, yinc, zinc, rotation, yflip, swig_np_flt_in_v1, file, debug)
cube_export_rmsregular = _cxtgeo.cube_export_rmsregular

def cube_swapaxes(nx, ny, nz, yflip, xori, xinc, yori, yinc, rotation, swig_np_flt_inplace_v1, swig_np_int_inplace_v1, option, debug):
    return _cxtgeo.cube_swapaxes(nx, ny, nz, yflip, xori, xinc, yori, yinc, rotation, swig_np_flt_inplace_v1, swig_np_int_inplace_v1, option, debug)
cube_swapaxes = _cxtgeo.cube_swapaxes

def cube_coord_val_ijk(i, j, k, nx, ny, nz, xori, xinc, yori, yinc, zori, zinc, rot_deg, yflip, p_val_v, x, y, z, value, option, debug):
    return _cxtgeo.cube_coord_val_ijk(i, j, k, nx, ny, nz, xori, xinc, yori, yinc, zori, zinc, rot_deg, yflip, p_val_v, x, y, z, value, option, debug)
cube_coord_val_ijk = _cxtgeo.cube_coord_val_ijk

def cube_xy_from_ij(i, j, xori, xinc, yori, yinc, nx, ny, yflip, rot_azi_deg, flag, debug):
    return _cxtgeo.cube_xy_from_ij(i, j, xori, xinc, yori, yinc, nx, ny, yflip, rot_azi_deg, flag, debug)
cube_xy_from_ij = _cxtgeo.cube_xy_from_ij

def cube_ijk_from_xyz(i, j, k, rx, ry, rz, x, y, z, xori, xinc, yori, yinc, zori, zinc, nx, ny, nz, rot_deg, yflip, flag, debug):
    return _cxtgeo.cube_ijk_from_xyz(i, j, k, rx, ry, rz, x, y, z, xori, xinc, yori, yinc, zori, zinc, nx, ny, nz, rot_deg, yflip, flag, debug)
cube_ijk_from_xyz = _cxtgeo.cube_ijk_from_xyz

def cube_value_ijk(i, j, k, nx, ny, nz, p_val_v, value, debug):
    return _cxtgeo.cube_value_ijk(i, j, k, nx, ny, nz, p_val_v, value, debug)
cube_value_ijk = _cxtgeo.cube_value_ijk

def cube_value_xyz_cell(x, y, z, xori, xinc, yori, yinc, zori, zinc, rot_deg, yflip, nx, ny, nz, p_val_v, value, option, debug):
    return _cxtgeo.cube_value_xyz_cell(x, y, z, xori, xinc, yori, yinc, zori, zinc, rot_deg, yflip, nx, ny, nz, p_val_v, value, option, debug)
cube_value_xyz_cell = _cxtgeo.cube_value_xyz_cell

def cube_value_xyz_interp(x, y, z, xori, xinc, yori, yinc, zori, zinc, rot_deg, yflip, nx, ny, nz, p_val_v, value, option, debug):
    return _cxtgeo.cube_value_xyz_interp(x, y, z, xori, xinc, yori, yinc, zori, zinc, rot_deg, yflip, nx, ny, nz, p_val_v, value, option, debug)
cube_value_xyz_interp = _cxtgeo.cube_value_xyz_interp

def cube_vertical_val_list(i, j, nx, ny, nz, p_val_v, p_vertical_v, debug):
    return _cxtgeo.cube_vertical_val_list(i, j, nx, ny, nz, p_val_v, p_vertical_v, debug)
cube_vertical_val_list = _cxtgeo.cube_vertical_val_list

def cube_resample_cube(ncx1, ncy1, ncz1, cxori1, cxinc1, cyori1, cyinc1, czori1, czinc1, crotation1, yflip1, swig_np_flt_inplace_v1, ncx2, ncy2, ncz2, cxori2, cxinc2, cyori2, cyinc2, czori2, czinc2, crotation2, yflip2, swig_np_flt_in_v1, option1, option2, ovalue, debug):
    return _cxtgeo.cube_resample_cube(ncx1, ncy1, ncz1, cxori1, cxinc1, cyori1, cyinc1, czori1, czinc1, crotation1, yflip1, swig_np_flt_inplace_v1, ncx2, ncy2, ncz2, cxori2, cxinc2, cyori2, cyinc2, czori2, czinc2, crotation2, yflip2, swig_np_flt_in_v1, option1, option2, ovalue, debug)
cube_resample_cube = _cxtgeo.cube_resample_cube

def cube_get_randomline(swig_np_dbl_in_v1, swig_np_dbl_in_v2, zmin, zmax, nzsam, xori, xinc, yori, yinc, zori, zinc, rot_deg, yflip, nx, ny, nz, swig_np_flt_in_v1, swig_np_dbl_aout_v1, option, debug):
    return _cxtgeo.cube_get_randomline(swig_np_dbl_in_v1, swig_np_dbl_in_v2, zmin, zmax, nzsam, xori, xinc, yori, yinc, zori, zinc, rot_deg, yflip, nx, ny, nz, swig_np_flt_in_v1, swig_np_dbl_aout_v1, option, debug)
...
def grd3d_scan_roff_bingrid(nx, ny, nz, nsubs, filename, debug):
    return _cxtgeo.grd3d_scan_roff_bingrid(nx, ny, nz, nsubs, filename, debug)
...
def grd3d_read_eclrecord(fc, recstart, rectype, swig_np_int_inplace_v1, swig_np_flt_inplace_v1, swig_np_dbl_inplace_v1, debug):
    return _cxtgeo.grd3d_read_eclrecord(fc, recstart, rectype, swig_np_int_inplace_v1, swig_np_flt_inplace_v1, swig_np_dbl_inplace_v1, debug)
...
def grd3d_zcorn_convert(nx, ny, nz, zcorn, p_zcorn_v, option, debug):
    return _cxtgeo.grd3d_zcorn_convert(nx, ny, nz, zcorn, p_zcorn_v, option, debug)
...
def grd3d_imp_ecl_egrid(fc, nx, ny, nz, bpos_mapaxes, bpos_coord, bpos_zcorn, bpos_actnum, p_coord_v, p_zcorn_v, actnum_v, debug):
    return _cxtgeo.grd3d_imp_ecl_egrid(fc, nx, ny, nz, bpos_mapaxes, bpos_coord, bpos_zcorn, bpos_actnum, p_coord_v, p_zcorn_v, actnum_v, debug)
...
def well_geometrics(np, xv, yv, zv, md, incl, az, option, debug):
    return _cxtgeo.well_geometrics(np, xv, yv, zv, md, incl, az, option, debug)
well_geometrics = _cxtgeo.well_geometrics

def well_trunc_parallel(swig_np_dbl_inplace_v1, swig_np_dbl_inplace_v2, swig_np_dbl_inplace_v3, swig_np_dbl_in_v1, swig_np_dbl_in_v2, swig_np_dbl_in_v3, xtol, ytol, ztol, itol, atol, option, debug):
    return _cxtgeo.well_trunc_parallel(swig_np_dbl_inplace_v1, swig_np_dbl_inplace_v2, swig_np_dbl_inplace_v3, swig_np_dbl_in_v1, swig_np_dbl_in_v2, swig_np_dbl_in_v3, xtol, ytol, ztol, itol, atol, option, debug)
