...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-logs", "0.33.0", __name__, "aws-logs@0.33.0.jsii.tgz")
...
class ILogSubscriptionDestination(jsii.compat.Protocol):
    ...
    def bind(self, scope: aws_cdk.cdk.Construct, source_log_group: "ILogGroup") -> "LogSubscriptionDestinationProperties":
...
class CrossAccountDestination(aws_cdk.cdk.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-logs.CrossAccountDestination"):
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, _scope: aws_cdk.cdk.Construct, _source_log_group: "ILogGroup") -> "LogSubscriptionDestinationProperties":
        """Return the properties required to send subscription events to this destination.
...
@jsii.data_type_optionals(jsii_struct_bases=[])
class _LogSubscriptionDestinationProperties(jsii.compat.TypedDict, total=False):
    role: aws_cdk.aws_iam.IRole
...
@jsii.data_type(jsii_type="@aws-cdk/aws-logs.LogSubscriptionDestinationProperties", jsii_struct_bases=[_LogSubscriptionDestinationProperties])
class LogSubscriptionDestinationProperties(_LogSubscriptionDestinationProperties):
...
__all__ = ["CfnDestination", "CfnDestinationProps", "CfnLogGroup", "CfnLogGroupProps", "CfnLogStream", "CfnLogStreamProps", "CfnMetricFilter", "CfnMetricFilterProps", "CfnSubscriptionFilter", "CfnSubscriptionFilterProps", "ColumnRestriction", "CrossAccountDestination", "CrossAccountDestinationProps", "FilterPattern", "IFilterPattern", "ILogGroup", "ILogStream", "ILogSubscriptionDestination", "JSONPattern", "LogGroup", "LogGroupProps", "LogStream", "LogStreamProps", "LogSubscriptionDestinationProperties", "MetricFilter", "MetricFilterProps", "NewLogStreamProps", "NewMetricFilterProps", "NewSubscriptionFilterProps", "RetentionDays", "SpaceDelimitedTextPattern", "SubscriptionFilter", "SubscriptionFilterProps", "__jsii_assembly__"]
