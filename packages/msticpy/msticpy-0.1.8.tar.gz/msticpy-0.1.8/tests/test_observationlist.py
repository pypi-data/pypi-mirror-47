...
class TestObservations(unittest.TestCase):
    ...
    def test_create_observation_class(self):
        ...
        test_set = {'caption', 'description', 'data', 'data_type',
                    'link', 'tags', 'additional_properties'}
        ...
        ob1 = Observation(caption='O1', description='Description1',
                          data=obs, data_type='object', 
                          tags=['t1', 't2', 't3'])
    ...
    def test_create_observations(self):
        ...
        ob1 = Observation(caption='O1', description='Description1',
                          data=test_set, data_type='object', 
                          tags=['t1', 't2', 't3'])
        ...
        ob2 = Observation(caption='O1', description='Description2',
                          data=test_set, data_type='object', 
                          tags=['t1', 't2', 't3'])
        ...
        obs_list.add_observation(caption='O3', description='Description1',
                                 data=test_set, data_type='object', 
                                 tags=['t1', 't2', 't3'], foo='some extra data')
        self.assertEqual(len(obs_list.observations), 3)
        self.assertEqual(obs_list.observations['O3'].additional_properties['foo'], 'some extra data')
