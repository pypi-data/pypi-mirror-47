...
class TF(BasicModel):
    ...
    cfg.dropout = None
    cfg.save_step = 1000000000
    cfg.val_batch_size = cfg.batch_size*4
    cfg.val_step = 1000000000
    cfg.val_batchs = 1000000000
    ...
    def restore(self, global_step=None, var_list=None, model_dir=None):
        ...
        with self.sess.graph.as_default():
            ...
            if global_step is None:
                ...
                model_path = os.path.join(model_dir, 'model-{}'.format(global_step))
    ...
    def _fit_epoch(self, x, y, xV = None, yV = None, no_validate=False, epoch=None, xTest = None, save_epoch=10000000, only_validate=False):
        ...
        if xV is not None and not no_validate:
            val_loss = self._val_epoch(xV, yV, epoch, global_step)
        else:
            val_loss = None
        return loss, val_loss

    def _val_epoch(self, xV, yV, epoch, global_step):
        loss_hist = LossHist()
        num_sample = 0
