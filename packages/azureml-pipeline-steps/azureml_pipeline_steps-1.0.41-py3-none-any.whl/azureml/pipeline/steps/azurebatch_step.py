...
class AzureBatchStep(PipelineStep):
    ...
    def create_node(self, graph, default_datastore, context):
        ...
        """
        azurebatch_config = self._get_azurebatch_config(context)
        self._metadata_parameters.update(azurebatch_config)
        ...
        arguments = super(AzureBatchStep, self).resolve_input_arguments(
            self._arguments, self._inputs, self._outputs, self._parameters)
    ...
    def _get_azurebatch_config(self, context):
        """
        ...
        :rtype: dict
        """
        azurebatch_resource_id = self._get_azurebatch_resource_id(context)
        resource_id_regex = \
    ...
    def _get_azurebatch_resource_id(self, context):
        """
