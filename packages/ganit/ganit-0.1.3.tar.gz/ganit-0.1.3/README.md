...
`%` | Basic Operation
`^` | Basic Operation
`gcd` | Arithmatic Function
`pow` | Algebraic Function
`floor` | Algebraic Function 
`abs` | Algebraic Function
`exp` | Algebraic Function
`factorial` | Algebraic Function
`ceil` | Algebraic Function
`sqrt` | Algebraic Function
`log` | Algebraic Function
`ln` | Algebraic Function
`log2` | Algebraic Function
`Log` | Algebraic Function
`sin` | Trigonometric Function
`cos` | Trigonometric Function
`asin` | Trigonometric Function
`acos` | Trigonometric Function
`acosh` | Trigonometric Function
`sinh`  | Trigonometric Function
`cosh` | Trigonometric Function
`asinh` | Trigonometric Function
`atanh` | Trigonometric Function
`tan` | Trigonometric Function
`tanh` | Trigonometric Function
`hypot` | Trigonometric Function
`atan` | Trigonometric Function
`deg` | Angle Conversion
...
`e` | Predefined Variable
`tau` | Predefined Variable
`True` | Predefined Variable
`False` | Predefined Variable
...
## Changelog
#### Version 0.1.0
First pulished version. Supports all the Basic Arithmetic, Algeraic and Trigonometric functions.

#### Version 0.1.1
Addition of Ternary operator. Added support for ternary operator, Greated Than, Less Than operator.
...
------- | -------------------- | -------- | -----------------------| ------------------- | --------------
 | `-` | `No Variable` | `0-` | `'Expression ends with an operator, which is invalid. System will exit'` | `'Expressionends with an operator, which is invalid. System will exit'`
...
22 | `------` | `No Variable` | `0+` | `'Expression ends with an operator, which is invalid. System will exit'` | `'Expression ends with an operator, which is invalid. System will exit'`
...
124 | `{'exp': 'cos(x^2 + y^2)^2 + sin(x^2 + y^2)^2', 'variables': {'y': 20, 'x': 30}}` | `{'y': 20, 'x': 30}` | `cos(x^2+y^2)^2+sin(x^2+y^2)^2` | `x 2 ^ y 2 ^ + cos 2 ^ x 2 ^ y 2 ^ + sin 2 ^ + ` | `1`
