""" Module containing ADFGVX cipher """
import logging
import math
import secrets
import string
...
class ADFGVXCipher(Cipher):
    ...
    def __init__(self):
        logging.info("Created ADFGVX cipher")
        self.header = ['A', 'D', 'F', 'G', 'V', 'X']
        pass

    def encrypt(self, plaintext, polybius, key):
        """ Encrypt plain text using ADFGVX cipher """
        logging.info("Attempting to encrypt plain text...")
        ciphertext = ''

        plaintext = self.sanitise_alphanumeric(plaintext)
    ...
    def decrypt(self, ciphertext, polybius, key):
        """ Decrypt cipher text using ADFGVX cipher """
    ...
    def generate_polybius(self):
        """ Generates a polybius for use with the ADFGVX cipher """
