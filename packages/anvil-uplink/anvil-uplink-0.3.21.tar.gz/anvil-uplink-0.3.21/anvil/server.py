...
from ._threaded_server import live_object_backend, LazyMedia, _switch_session
...
class _Connection(WebSocketClient):
    ...
    def opened(self):
        ...
        self.send(json.dumps({'key': _key, 'v': 6}))
...
def connect(key, url='wss://anvil.works/uplink', quiet=False, init_session=None):
    global _key, _url, _fatal_error, _quiet, _init_session
    _key = key
    _url = url
