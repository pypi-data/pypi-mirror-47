    ...
    class lifetree_generic : public lifetree_abstract<I> {
        ...
        hypernode<I> read_macrocell(std::istream &instream, std::string &rule) {
            ...
            */
            ...
            RuleMapper *grm = new IdentityMapper();
            ...
            if (reading_rle) {
                result_hn = this->fromrle(rlestream.str(), ((golly_numbering & 2) ? grm : 0));
            } else {
        ...
        hypernode<I> boolean_recurse(hypernode<I> lnode, hypernode<I> rnode, int operation,
            ...
            */
            ...
            if ((lnode.index == 0) && (lnode.index2 == 0)) {
                ...
                return boolean_recurse(breach(lnode), breach(rnode), operation, memmap, solids);
        ...
        hypernode<I> boolean_recurse(hypernode<I> lnode, hypernode<I> rnode, int operation,
            ...
            return boolean_recurse(lnode, rnode, operation, memmap, ((operation <= 1) ? (&solids) : 0));
                    ...
                    for (int j = 0; j < 4; j++) {
                        ...
                        if (q.index) {
                            ...
                            for (int k = 0; k < 4; k++) {
                                ...
                                int c = ((b & 4) | (a & 2)) >> 1;
                                int d = ((b & 2) | (a & 1));
                                pconvs[c][d] = boolean_recurse(pconvs[c][d], hijk, op, memmap1, 0);
                            }
                        }
                    }
                }
