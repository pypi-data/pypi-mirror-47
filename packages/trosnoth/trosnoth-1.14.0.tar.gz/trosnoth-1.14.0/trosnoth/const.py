...
ACTION_MAIN_MENU = 'menu'
ACTION_UPGRADE_MENU = 'select upgrade'
ACTION_MORE_MENU = 'more actions'
...
ACTION_EDIT_PLAYER_INFO = 'edit player info'
ACTION_READY = 'ready'
ACTION_CHAT = 'chat'
ACTION_LEADERBOARD_TOGGLE = 'leaderboard'
ACTION_HUD_TOGGLE = 'toggle interface'
...
# Special server strings
CREATE_GAME = 'create'
JOIN_AUTH_LAN_GAME = 'lanauth'
JOIN_LAN_GAME = 'lan'
JOIN_LOCAL_GAME = 'self'
