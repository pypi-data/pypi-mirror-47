...
class QLearningAgent(TrainableAgent):
    ...
    def __init__(self, action_space, name="QLearning", train=True, load_from=None,
        ...
        super(QLearningAgent, self).__init__(name, evaluation_policy, training_policy, train, load_from)
    ...
    def _reinforce(self, timestep):
        ...
        max_Q_s2_a = max(Q_s2_a)

        self._Q[s1][a] = (1 - alpha) * Q_s1_a + alpha * (r + gamma * max_Q_s2_a)
