...
def logoutSession(nb_url, token):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return "NetBrain Logout Failed! - " + str(response.text)
    except Exception as e:
        return str(e)
...
def loginDomain(nb_url, token, tenantId, domainId):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return "NetBrain Login Failed! - " + str(response.text)
    except Exception as e:
        return str(e)
...
def getInterfaceAttributes(nb_url, token, hostname, interfaceName, attributeName):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return "Get interfaces attributes failed! - " + str(response.text)
    except Exception as e:
        return str(e)
