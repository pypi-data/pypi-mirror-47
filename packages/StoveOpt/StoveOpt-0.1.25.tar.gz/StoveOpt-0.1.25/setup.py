...
setup(
	  ...
	  package_dir={'StoveOpt': 'StoveOpt',
				   ...
				   'case_25_zerofiles': 'StoveOpt/foamfiles/counteerFlowFlame2D/case_25/0/folder',
				   'case_25_constantfiles': 'StoveOpt/foamfiles/counteerFlowFlame2D/case_25/constant/folder',
				   'case_25_systemfiles': 'StoveOpt/foamfiles/counteerFlowFlame2D/case_25/system/folder',
