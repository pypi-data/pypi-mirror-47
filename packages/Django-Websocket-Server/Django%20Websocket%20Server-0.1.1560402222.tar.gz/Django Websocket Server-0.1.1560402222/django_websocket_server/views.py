...
def authenticate(request,port=None):
    ...
    return JsonResponse({'public_key':key_model.get_public_key_base64(),'ws_protocol':ws_server.protocol,'ws_port':ws_server.port,'success':True,'user': request.user.id})