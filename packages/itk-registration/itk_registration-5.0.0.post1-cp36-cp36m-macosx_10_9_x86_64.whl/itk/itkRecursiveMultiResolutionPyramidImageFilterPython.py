...
class itkRecursiveMultiResolutionPyramidImageFilterIF2IF2(itkMultiResolutionPyramidImageFilterPython.itkMultiResolutionPyramidImageFilterIF2IF2):
    ...
    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/RecursiveMultiRe
    solutionPyramidImageFilter Construct a multiresolution pyramid from an
    image

    C++ includes: itkRecursiveMultiResolutionPyramidImageFilter.h 
    """
