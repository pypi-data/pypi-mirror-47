...
class itkMeanReciprocalSquareDifferenceImageToImageMetricIF2IF2(itkImageToImageMetricPython.itkImageToImageMetricIF2IF2):
    ...
    C++ includes: itkMeanReciprocalSquareDifferenceImageToImageMetric.h 
    """
    ...
    def GetLambda(self) -> "double":
        ...
        This factor regulates the capture radius of this metric 
        """
    ...
    def GetDelta(self) -> "double":
        ...
        Set/Get Delta value. This
        value is used as the differential in the computation of the metric
        derivative using the finite differences method. 
        """
