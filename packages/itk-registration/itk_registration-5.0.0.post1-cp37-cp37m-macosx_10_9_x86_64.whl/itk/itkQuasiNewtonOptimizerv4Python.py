...
class itkQuasiNewtonOptimizerv4TemplateF(itkGradientDescentOptimizerv4Python.itkGradientDescentOptimizerv4TemplateF):
    ...
    def SetMaximumIterationsWithoutProgress(self, _arg: 'unsigned long const') -> "void":
        """SetMaximumIterationsWithoutProgress(itkQuasiNewtonOptimizerv4TemplateF self, unsigned long const _arg)"""
