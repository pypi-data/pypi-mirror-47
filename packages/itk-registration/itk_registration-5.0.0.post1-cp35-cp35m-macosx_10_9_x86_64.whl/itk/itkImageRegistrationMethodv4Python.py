...
class itkImageRegistrationMethodv4REGv4F2F2(ITKCommonBasePython.itkProcessObject):
    ...
    def SetOptimizerWeights(self, arg0: 'itkOptimizerParametersD') -> "void":
        ...
        to mask out a particular parameter during optimzation to hold it
    ...
    def SetShrinkFactorsPerLevel(self, factors: 'itkArrayUL') -> "void":
        ...
        Set the
        shrink factors for each level where each level has a constant shrink
        factor for each dimension. For example, input to the function of
