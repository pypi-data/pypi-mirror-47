...
class itkObjectToObjectMetric22(itkObjectToObjectMetricBasePython.itkObjectToObjectMetricBaseTemplateD):
    ...
    def SetVirtualDomain(self, spacing: 'itkVectorD2', origin: 'itkPointD2', direction: 'itkMatrixD22', region: 'itkImageRegion2') -> "void":
        ...
        derived classes. A default domain is created during initializaiton in
    ...
    def SupportsArbitraryVirtualDomainSamples(self) -> "bool":
        ...
        Returns a flag. True if arbitrary virtual domain points will always
        correspond to data points. False if not. For example, point-set
        metrics return false because only some virtual domain points will
    ...
    def IsInsideVirtualDomain(self, *args) -> "bool":
        ...
        domain has not been defined. This allows, for example, use in point
        set metrics where the virtual domain is implicitly defined by the
        point sets and transforms. 
        """
