...
class itkMultiResolutionPDEDeformableRegistrationIF2IF2IVF22F(itkImageToImageFilterAPython.itkImageToImageFilterIVF22IVF22):
    ...
    and moving images. A VectorExpandImageFilter is used to upsample the
    ...
    See:  VectorExpandImageFilter  The current implementation of this
    class does not support streaming.
