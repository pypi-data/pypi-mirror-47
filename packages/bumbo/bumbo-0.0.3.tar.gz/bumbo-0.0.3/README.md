...
Bumbo is a Python web framework built for learning purposes. It is a WSGI framework
and can be used with any WSGI application server such as Gunicorn.
...
You can create custom middleware classes by inheriting from the `bumbo.middleware.Middleware` class and override its two methods
