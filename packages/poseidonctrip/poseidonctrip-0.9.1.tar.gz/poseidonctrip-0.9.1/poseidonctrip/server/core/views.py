...
from poseidonctrip.server.core.response import JsonResponse
from poseidonctrip.cmd.init import PROJECTS_FOLDER
from poseidonctrip.server.server.settings import TIME_ZONE
from poseidonctrip.server.core.models import Client, Project, Deploy, Monitor, Task
from poseidonctrip.server.core.build import build_project, find_egg
from poseidonctrip.server.core.utils import IGNORES, is_valid_name, copy_tree, TEMPLATES_DIR, TEMPLATES_TO_RENDER, \
    render_template, get_traceback, scrapyd_url, log_url, get_tree, get_scrapyd, get_job_id, process_html, \
    clients_of_task
...
def task_create(request):
    ...
    task = Task.objects.create(
        clients=json.dumps(data.get("clients")),
