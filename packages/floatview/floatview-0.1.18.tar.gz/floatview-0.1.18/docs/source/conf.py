...
# -*- coding: utf-8 -*-
#
# floatview documentation build configuration file
#
...
_version_py = os.path.join(repo, 'floatview', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'floatviewdoc'
...
latex_documents = [
    (master_doc, 'floatview.tex', 'floatview Documentation',
