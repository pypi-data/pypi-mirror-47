...
class XreCompiler(_object):
    ...
    def getOutputToConsole(self):
        return _libhfst_dev.XreCompiler_getOutputToConsole(self)
    ...
    def setOutputToConsole(self, value):
        return _libhfst_dev.XreCompiler_setOutputToConsole(self, value)
...
class LexcCompiler(_object):
    ...
    def setOutputToConsole(self, arg2):
        return _libhfst_dev.LexcCompiler_setOutputToConsole(self, arg2)
...
class XfstCompiler(_object):
    ...
    def setOutputToConsole(self, value):
        return _libhfst_dev.XfstCompiler_setOutputToConsole(self, value)
...
def get_hfst_regex_error_message():
    return _libhfst_dev.get_hfst_regex_error_message()
get_hfst_regex_error_message = _libhfst_dev.get_hfst_regex_error_message

def hfst_regex(comp, regex_string, error_stream):
    return _libhfst_dev.hfst_regex(comp, regex_string, error_stream)
hfst_regex = _libhfst_dev.hfst_regex

def get_hfst_xfst_string_one():
    return _libhfst_dev.get_hfst_xfst_string_one()
get_hfst_xfst_string_one = _libhfst_dev.get_hfst_xfst_string_one

def get_hfst_xfst_string_two():
    return _libhfst_dev.get_hfst_xfst_string_two()
get_hfst_xfst_string_two = _libhfst_dev.get_hfst_xfst_string_two

def hfst_compile_xfst_to_string_one(comp, input):
    return _libhfst_dev.hfst_compile_xfst_to_string_one(comp, input)
hfst_compile_xfst_to_string_one = _libhfst_dev.hfst_compile_xfst_to_string_one

def hfst_compile_xfst(comp, input, output_stream, error_stream):
    return _libhfst_dev.hfst_compile_xfst(comp, input, output_stream, error_stream)
hfst_compile_xfst = _libhfst_dev.hfst_compile_xfst

def get_hfst_lexc_output():
    return _libhfst_dev.get_hfst_lexc_output()
get_hfst_lexc_output = _libhfst_dev.get_hfst_lexc_output

def hfst_compile_lexc_files(comp, filenames, error_stream):
    return _libhfst_dev.hfst_compile_lexc_files(comp, filenames, error_stream)
hfst_compile_lexc_files = _libhfst_dev.hfst_compile_lexc_files

def hfst_compile_lexc_script(comp, script, error_stream):
    return _libhfst_dev.hfst_compile_lexc_script(comp, script, error_stream)
hfst_compile_lexc_script = _libhfst_dev.hfst_compile_lexc_script
...
def hfst_compile_sfst(filename, error_stream, verbose, output_to_console):
    return _libhfst_dev.hfst_compile_sfst(filename, error_stream, verbose, output_to_console)
...
class TwolcCompiler(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["compile"] = lambda x: _libhfst_dev.TwolcCompiler_compile
    if _newclass:
        compile = staticmethod(_libhfst_dev.TwolcCompiler_compile)
    __swig_getmethods__["compile_file"] = lambda x: _libhfst_dev.TwolcCompiler_compile_file
    if _newclass:
        compile_file = staticmethod(_libhfst_dev.TwolcCompiler_compile_file)
...
def TwolcCompiler_compile(inputfile, outputfile, silent, verbose, resolve_left_conflicts, resolve_right_conflicts, type, ostr=None):
    return _libhfst_dev.TwolcCompiler_compile(inputfile, outputfile, silent, verbose, resolve_left_conflicts, resolve_right_conflicts, type, ostr)
TwolcCompiler_compile = _libhfst_dev.TwolcCompiler_compile

def TwolcCompiler_compile_file(inputfile, outputfile, silent, verbose, resolve_left_conflicts, resolve_right_conflicts, type):
    return _libhfst_dev.TwolcCompiler_compile_file(inputfile, outputfile, silent, verbose, resolve_left_conflicts, resolve_right_conflicts, type)
TwolcCompiler_compile_file = _libhfst_dev.TwolcCompiler_compile_file
