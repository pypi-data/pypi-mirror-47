...
from socks5_ipv8.hops.multiproxy import MultiProxyInitiator, MultiProxyForwarder, MultiProxyServer
from ipv8lib.ipv8.configuration import get_default_configuration
from ipv8lib.ipv8_service import IPv8, _COMMUNITIES
...
def proxy(nodes_num):
    ...
    def set_nodes(role, id_with_key):
        ...
        configuration['keys'] = [{
            ...
            'file': u"keys/ec{}_{}_{!r}.pem".format(*((id_with_key) + (str(uuid.uuid4()),)))
        }]
