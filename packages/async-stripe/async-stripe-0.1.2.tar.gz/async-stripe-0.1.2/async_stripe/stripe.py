...
class Stripe(APIWrapper):
    ...
    def get_payment(self, payment_intent):
        return self.post(f"{PAYMENT_URL}/{payment_intent}", headers=stripe_header())

    # https://stripe.com/docs/api/payment_intents/update
    def update_payment(self, payment_intent, **params):
        print("Update with", params)
        return self.post(f"{PAYMENT_URL}/{payment_intent}", params=params, headers=stripe_header())

    # TODO (11 Jun 2019): https://stripe.com/docs/api/payment_intents/confirm
    # TODO (11 Jun 2019): https://stripe.com/docs/api/payment_intents/capture
    # TODO (11 Jun 2019): https://stripe.com/docs/api/payment_intents/cancel
    # TODO (11 Jun 2019): https://stripe.com/docs/api/payment_intents/list

    # Not so usefull for the client, looks like a dev. side tool:
