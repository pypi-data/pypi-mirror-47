...
class CollectionsApi(object):
    ...
    def list(self, workspace, **kwargs):  # noqa: E501
        """List Collections  # noqa: E501

        Retrieve all collections in a workspace.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list(workspace, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_with_http_info(workspace, **kwargs)  # noqa: E501
        else:
            (data) = self.list_with_http_info(workspace, **kwargs)  # noqa: E501
            return data

    def list_with_http_info(self, workspace, **kwargs):  # noqa: E501
        """List Collections  # noqa: E501

        Retrieve all collections in a workspace.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_with_http_info(workspace, async_req=True)
        >>> result = thread.get()
        ...
        if ('workspace' not in params or
                params['workspace'] is None):
            raise ValueError("Missing the required parameter `workspace` when calling `list`")  # noqa: E501
    ...
    def set(self, workspace, collection, state, **kwargs):  # noqa: E501
        """Update state of Collection  # noqa: E501

        Update state of a collection.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set(workspace, collection, state, async=True)
        >>> result = thread.get()

        :param async_req bool
        :param str workspace: name of the workspace (required)
        :param str collection: name of the collection (required)
        :param str state: new state of this collection (required)
        :return: GetCollectionResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.set_with_http_info(workspace, collection, state, **kwargs)  # noqa: E501
        else:
            (data) = self.set_with_http_info(workspace, collection, state, **kwargs)  # noqa: E501
            return data

    def set_with_http_info(self, workspace, collection, state, **kwargs):  # noqa: E501
        """Update state of Collection  # noqa: E501

        Update state of a collection.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.set_with_http_info(workspace, collection, state, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['workspace', 'collection', 'state']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('workspace' not in params or
                params['workspace'] is None):
            raise ValueError("Missing the required parameter `workspace` when calling `set`")  # noqa: E501
        # verify the required parameter 'collection' is set
        if ('collection' not in params or
                params['collection'] is None):
            raise ValueError("Missing the required parameter `collection` when calling `set`")  # noqa: E501
        # verify the required parameter 'state' is set
        if ('state' not in params or
                params['state'] is None):
            raise ValueError("Missing the required parameter `state` when calling `set`")  # noqa: E501
