...
class _Modeler(object):
    ...
    def get_relative_url_and_pointer(self, definition):
    ...
    def get_relative_url_pointer(self, definition):
        ...
        relative_url, pointer = self.get_relative_url_and_pointer(definition)
    ...
    def get_schema_model(self, schema, name=None, relative_url_pointer=None, is_property=False):
        ...
        if relative_url_pointer is None:
            relative_url_pointer = self.get_relative_url_pointer(schema)
    ...
    def get_operation_class_name(self, operation):
        ...
        "in": "form".
        """
        relative_url, pointer = self.get_relative_url_and_pointer(operation)
    ...
    def get_parameter_class_name(self, parameter):
        ...
        """
        relative_url, pointer = self.get_relative_url_and_pointer(parameter)
        return self.get_relative_url_and_pointer_class_name(relative_url, pointer, is_property=True)
    ...
    def get_schema_class_name(self, schema, is_property=False):
        ...
        """
        relative_url, pointer = self.get_relative_url_and_pointer(schema)
