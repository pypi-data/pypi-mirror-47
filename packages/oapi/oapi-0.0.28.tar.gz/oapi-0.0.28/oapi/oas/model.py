...
def _object_before_setitem(self, key, value):
    ...
    if key[:2] == 'x-':
        ...
        try:
            ...
            meta_.properties[property_name] = sob.properties.Property(name=property_name)
...
class Reference(Object):
    ...
    def __init__(
        ...
        # # Delete all other data if a `$ref` is present
        # if _ is not None:
        #     if not isinstance(_, sob.abc.model.Model):
