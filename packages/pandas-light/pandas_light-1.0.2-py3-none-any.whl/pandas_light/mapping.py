...
@pf.register_dataframe_method
def applyvec(df,func,*args):
    """Vectorize and apply a function to each row in DataFrame. 
    
    Args:
        func (func): The function to vectorize and apply.
        args: The names of column to pass as arguments. If omitted, parse from arg name of func.
    """
    if len(args) == 0:
        args = inspect.getfullargspec(func)[0]
    cols = [df[col] for col in args]
    return np.vectorize(func)(*cols)
