...
from musicraft.share import (QtCore, QtGui, QtWidgets)
...
class MyTextEdit(QtWidgets.QTextEdit):
    def __init__(self, *pp, button=None, **kw):
        self.button = button
        QtWidgets.QTextEdit.__init__(self, *pp, ** kw)
...
class Find(QtWidgets.QDialog):
    ...
    def find(self):
        ...
        if self.lastMatch:
            ...
            self.parent.activeEdit.moveCursor(QtWidgets.QTextCursor.End)
    ...
    def moveCursor(self, start, end):
        ...
        cursor.movePosition(QtWidgets.QTextCursor.Right, QtWidgets.QTextCursor.KeepAnchor, end - start)
