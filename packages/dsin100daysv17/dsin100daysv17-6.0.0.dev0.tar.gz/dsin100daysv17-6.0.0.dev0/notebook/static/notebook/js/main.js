...
requirejs([
    ...
    'bidi/bidi',
    'notebook/js/hideinput',
    'notebook/js/html_embedded',
    'notebook/js/hotjar',
    'notebook/js/mixpanel',
    'notebook/js/postload',
    'notebook/js/grade',
], function(
    $,
    contents_service,
    ...
    hideinput.load_ipython_extension();
    html_embedded.load_ipython_extension();
    hotjar.load_ipython_extension();
    mixpanel.load_ipython_extension();
    postload.load_extension();
    grade.load_extension();
});
