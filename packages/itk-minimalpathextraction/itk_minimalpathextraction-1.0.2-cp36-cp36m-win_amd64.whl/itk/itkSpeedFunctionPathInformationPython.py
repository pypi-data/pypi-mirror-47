...
class itkSpeedFunctionPathInformationPD2(ITKCommonBasePython.itkLightObject):
    ...
    def GetWayPoint(self, i: 'unsigned long long') -> "std::vector< itkPointD2,std::allocator< itkPointD2 > > const &":
        """GetWayPoint(itkSpeedFunctionPathInformationPD2 self, unsigned long long i) -> vectoritkPointD2"""
...
class itkSpeedFunctionPathInformationPD3(ITKCommonBasePython.itkLightObject):
    ...
    def GetWayPoint(self, i: 'unsigned long long') -> "std::vector< itkPointD3,std::allocator< itkPointD3 > > const &":
        """GetWayPoint(itkSpeedFunctionPathInformationPD3 self, unsigned long long i) -> vectoritkPointD3"""
