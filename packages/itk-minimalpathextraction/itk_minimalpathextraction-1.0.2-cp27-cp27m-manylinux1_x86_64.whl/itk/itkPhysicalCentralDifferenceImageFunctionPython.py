...
def itkFunctionBasePF2CVdouble2_cast(obj):
...
def itkFunctionBasePF3CVdouble3_cast(obj):
...
def itkImageFunctionIF2CVdouble2float_cast(obj):
...
def itkImageFunctionIF3CVdouble3float_cast(obj):
...
def itkImageFunctionISS2CVdouble2float_cast(obj):
...
def itkImageFunctionISS3CVdouble3float_cast(obj):
...
def itkImageFunctionIUC2CVdouble2float_cast(obj):
...
def itkImageFunctionIUC3CVdouble3float_cast(obj):
...
def itkImageFunctionIUS2CVdouble2float_cast(obj):
...
def itkImageFunctionIUS3CVdouble3float_cast(obj):
...
def itkPhysicalCentralDifferenceImageFunctionIF2float___New_orig__():
    """itkPhysicalCentralDifferenceImageFunctionIF2float___New_orig__() -> itkPhysicalCentralDifferenceImageFunctionIF2float_Pointer"""
    return _itkPhysicalCentralDifferenceImageFunctionPython.itkPhysicalCentralDifferenceImageFunctionIF2float___New_orig__()

def itkPhysicalCentralDifferenceImageFunctionIF2float_cast(obj):
...
def itkPhysicalCentralDifferenceImageFunctionIF3float___New_orig__():
    """itkPhysicalCentralDifferenceImageFunctionIF3float___New_orig__() -> itkPhysicalCentralDifferenceImageFunctionIF3float_Pointer"""
    return _itkPhysicalCentralDifferenceImageFunctionPython.itkPhysicalCentralDifferenceImageFunctionIF3float___New_orig__()

def itkPhysicalCentralDifferenceImageFunctionIF3float_cast(obj):
...
def itkPhysicalCentralDifferenceImageFunctionISS2float___New_orig__():
...
def itkPhysicalCentralDifferenceImageFunctionISS2float_cast(obj):
...
def itkPhysicalCentralDifferenceImageFunctionISS3float___New_orig__():
...
def itkPhysicalCentralDifferenceImageFunctionISS3float_cast(obj):
...
def itkPhysicalCentralDifferenceImageFunctionIUC2float___New_orig__():
...
def itkPhysicalCentralDifferenceImageFunctionIUC2float_cast(obj):
...
def itkPhysicalCentralDifferenceImageFunctionIUC3float___New_orig__():
...
def itkPhysicalCentralDifferenceImageFunctionIUC3float_cast(obj):
...
def itkPhysicalCentralDifferenceImageFunctionIUS2float___New_orig__():
...
def itkPhysicalCentralDifferenceImageFunctionIUS2float_cast(obj):
...
def itkPhysicalCentralDifferenceImageFunctionIUS3float___New_orig__():
...
def itkPhysicalCentralDifferenceImageFunctionIUS3float_cast(obj):
