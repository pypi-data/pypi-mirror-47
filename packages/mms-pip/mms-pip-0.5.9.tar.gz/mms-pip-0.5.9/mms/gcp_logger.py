class Logger(object):
    ...
    def __init__(self, service_name='', run_id='', project_id='', local_run=False, module_id='', version_id='', function_name='', cluster_name='', namespace_name='', container_name='', location='', revision_version='', resource_type='global'):
