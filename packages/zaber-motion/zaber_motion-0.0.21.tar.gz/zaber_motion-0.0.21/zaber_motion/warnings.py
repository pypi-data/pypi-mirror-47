...
class Warnings:
    ...
    def get(
        ...
        Returns:
            Retrieved warnings and faults. Refer to WarningFlags to check particular flag.
        """
    ...
    def clear(
        ...
        Returns:
            Warnings and faults before clearing. Refer to WarningFlags to check particular flag.
        """
        request = main_pb2.DeviceGetWarningsRequest()
        request.interface_id = self._device.connection.interface_id
        request.device = self._device.device_address
