...
def format_structure(struct, dic, defaults=None, missing=False, clean_up=True):
    """
    ...
    dic = ChainMap(dic, dict_cls(defaults) if defaults else dict_cls())
    str_parser = partial(safe_format, dic=dic)
