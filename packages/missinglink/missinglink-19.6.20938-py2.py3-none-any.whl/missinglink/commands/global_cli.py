...
class _VersionChecker(object):
    ...
    def is_staging(package):
        package_keywords = get_keywords(package) or []
    ...
    def _get_latest_version(cls, package=None, throw_exception=False):
        ...
        from missinglink import get_latest_pip_version
        ...
        if is_conda_env():
            ...
            latest_version = get_latest_pip_version(package, staging, throw_exception=throw_exception)
