...
@click.option('--isolated', is_flag=True, default=False, required=False, help='Performs an isolated sync.')
@click.pass_context
...
@click.option('--query', '-q', required=False, help='Query string to filter the relevant data from the data volume.')
