...
def test_from_list_to_signal():
    ...
    signal_1_from_list = Signal_1D(values=data.List_b, verbose=False)
...
def test_from_tuple_to_signal():
    print('[  I  ]  Signal 1D', end='.....')
    signal_1_from_tuple = Signal_1D(values=data.Tuple_b, verbose=False)
...
def test_from_nmArray_to_signal():
    print('[  I  ]  Signal 1D', end='.....')
    signal_1_from_npArray = Signal_1D(values=data.npArray_a, verbose=False)
