...
from microlab.samples import data
from microlab.types import is_2d_signal


def test_from_list_to_signal():
    print('[  I  ]  Signal 2D ', end='.....')
    signal_1_from_list = Signal_2D(values=data.dataset_list, verbose=False)
...
def test_from_tuple_to_signal():
    print('[  I  ]  Signal 2D ', end='.....')
    signal_1_from_tuple = Signal_2D(values=data.dataset_tuple, verbose=False)
...
def test_from_nmArray_to_signal():
    print('[  I  ]  Signal 2D ', end='.....')
    signal_1_from_ndArray = Signal_2D(values=data.dataset_npArray, verbose=False)
