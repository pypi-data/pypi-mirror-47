...
def usage():
    ...
    print(' - - - - - - - - - - - - -')
    print('\n {}Syntax:{} microlab {}action{} target '.format(colors['blue'], colors['default'], colors['green'], colors['default']))
    print('\n {}New Workspace {}'.format(colors['blue'], colors['default']))
    print(' {}workspace_create{} <workspace_name>               create new workspace in current directory'.format(colors['green'], colors['default']))

    print('\n {}New Package {}'.format(colors['blue'], colors['default']))
    print(' {}package_create{} <package_name>                   create new package in current directory'.format(colors['green'], colors['default']))
    ...
    print(' {}workspace_rename{} <new_name>                     change the name of the current workspace'.format(colors['green'], colors['default']))
    print(' {}workspace_reversion{} <new_version>               change the version of the current workspace'.format(colors['green'], colors['default']))
    ...
    print(' {}package_start{} <package_name>                    start the package of the current workspace'.format(colors['green'], colors['default']))

    print('\n {}Actions for Tests{}'.format(colors['blue'], colors['default']))
    print(' {}test_start{} <test_name>                          start the test of the current workspace'.format(colors['green'], colors['default']))
