...
class CDaemon:
    ...
    def __init__(self, save_path, stdin=os.devnull, stdout=sys.stdout, stderr=sys.stderr, home_dir='/sf/log', umask=0x12,
                 verbose=0):
        self.stdin = stdin
        self.stdout = stdout
        self.stderr = stderr
...
class ClientDaemon(CDaemon):
    def __init__(self, name, save_path, stdin=os.devnull, stdout=os.devnull, stderr=os.devnull, home_dir='.', umask=0x12,
                 verbose=1):
