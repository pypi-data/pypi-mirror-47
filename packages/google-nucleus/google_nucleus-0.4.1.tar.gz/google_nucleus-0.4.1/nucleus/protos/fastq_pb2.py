...
FastqRecord = _reflection.GeneratedProtocolMessageType('FastqRecord', (_message.Message,), dict(
...
FastqReaderOptions = _reflection.GeneratedProtocolMessageType('FastqReaderOptions', (_message.Message,), dict(
...
FastqWriterOptions = _reflection.GeneratedProtocolMessageType('FastqWriterOptions', (_message.Message,), dict(
