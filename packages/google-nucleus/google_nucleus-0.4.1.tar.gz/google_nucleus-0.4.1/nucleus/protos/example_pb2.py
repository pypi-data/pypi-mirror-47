...
# source: nucleus/protos/example.proto
...
_EXAMPLE.fields_by_name['features'].message_type = nucleus_dot_protos_dot_feature__pb2._FEATURES
_SEQUENCEEXAMPLE.fields_by_name['context'].message_type = nucleus_dot_protos_dot_feature__pb2._FEATURES
_SEQUENCEEXAMPLE.fields_by_name['feature_lists'].message_type = nucleus_dot_protos_dot_feature__pb2._FEATURELISTS
...
Example = _reflection.GeneratedProtocolMessageType('Example', (_message.Message,), dict(
  DESCRIPTOR = _EXAMPLE,
  __module__ = 'nucleus.protos.example_pb2'
