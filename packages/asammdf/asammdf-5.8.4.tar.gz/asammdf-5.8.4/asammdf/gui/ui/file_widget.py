...
class Ui_file_widget(object):
    def setupUi(self, file_widget):
        ...
        self.gridLayout_8.addWidget(self.can_database_list, 1, 0, 1, 3)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/csv.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.extract_can_csv_btn.setIcon(icon11)
