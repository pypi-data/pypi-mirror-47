...
class Assetic3IntegrationRepresentationsRequestorRepresentation(object):
    ...
    def __init__(self, address=None, types=None, id=None, display_name=None, first_name=None, surname=None, company=None, position=None, phone=None, mobile=None, fax=None, email=None, address_comment=None, external_id=None, status_id=None, status=None, links=None, embedded=None):  # noqa: E501
