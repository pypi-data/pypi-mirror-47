...
from assetic.models.assetic3_integration_representations_file_properties_representation \
     import Assetic3IntegrationRepresentationsFilePropertiesRepresentation
from assetic.models.assetic3_integration_representations_document_representation \
...
class BulkProcesses(object):
    ...
    def _process_upload_row(self, fileNameToUpload, parent_id, groupid=None
        ...
        if not aslink:
            ...
            file_properties = Assetic3IntegrationRepresentationsFilePropertiesRepresentation()
                    ...
                    os.path.exists(documentFilePathToImport):
                        ...
                        try:
                            ...
                            if isDocumentUploadSuccessful:
                                try:
                                    job = Assetic3IntegrationRepresentationsDataExchangeJobRepresentation()
