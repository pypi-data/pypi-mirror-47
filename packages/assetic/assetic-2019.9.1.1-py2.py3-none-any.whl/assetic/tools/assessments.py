...
from ..models.assetic3_integration_representations_assessment_form_assessment_form_page_representation\
    import Assetic3IntegrationRepresentationsAssessmentFormAssessmentFormPageRepresentation
from ..models.assetic3_integration_representations_assessment_form_assessment_form_tab_representation\
    import Assetic3IntegrationRepresentationsAssessmentFormAssessmentFormTabRepresentation
from ..models.assetic3_integration_representations_assessment_form_form_layout_representation\
    import Assetic3IntegrationRepresentationsAssessmentFormFormLayoutRepresentation
from ..models.assetic3_integration_representations_assessment_form_form_layout_pattern_representation\
    import Assetic3IntegrationRepresentationsAssessmentFormFormLayoutPatternRepresentation
from ..models.assetic3_integration_representations_assessment_form_form_widget_representation\
    import Assetic3IntegrationRepresentationsAssessmentFormFormWidgetRepresentation
from ..models.assetic3_integration_representations_assessment_form_form_control_group_representation\
    import Assetic3IntegrationRepresentationsAssessmentFormFormControlGroupRepresentation
from ..models.assetic3_integration_representations_assessment_form_form_control_representation\
    import Assetic3IntegrationRepresentationsAssessmentFormFormControlRepresentation
from ..models.assetic3_integration_representations_assessment_form_form_control_combobox_item_representation\
     import Assetic3IntegrationRepresentationsAssessmentFormFormControlComboboxItemRepresentation
...
class AssessmentTools(object):
    ...
    def create_form(self,form):
        ...
        Assetic3IntegrationRepresentationsAssessmentFormAssessmentFormPageRepresentation
    ...
    def new_form(self,form_name,form_level,label,version=1,can_add_attachment=True,tabs=None,attached_documents=None):
        ...
        form = Assetic3IntegrationRepresentationsAssessmentFormAssessmentFormPageRepresentation()
        form.name = form_name
        if label == None:
            label = form_name
        form.label = label
    ...
    def add_tab_with_widgets_to_form(self,form,tab_label,widgetlabels,pattern_name="Single",visible=True,taborder=None,collapsed=False):
        ...
        Assetic3IntegrationRepresentationsAssessmentFormAssessmentFormTabRepresentation()
        """
    ...
    def add_widget_group_control_to_layout(self,tab,label,containernum,order=None,collapsed=False):
        ...
        :param order: order number in the form.  Optional.
        :param form_layout: instance of Assetic3IntegrationRepresentationsAssessmentFormFormLayoutRepresentation
        :returns: widget control instance
        Assetic3IntegrationRepresentationsAssessmentFormAssessmentFormTabRepresentation()
        """
        ##create the widget
    ...
    def new_tab(self,label,visible=True,order=None,form_layout=None):
        ...
        :param order: order number in the form.  Optional.
        :param form_layout: instance of Assetic3IntegrationRepresentationsAssessmentFormFormLayoutRepresentation
        :returns: tab control instance
        Assetic3IntegrationRepresentationsAssessmentFormAssessmentFormTabRepresentation()
        """
        tab = Assetic3IntegrationRepresentationsAssessmentFormAssessmentFormTabRepresentation()
        tab.label = label
        tab.visible = visible
    ...
    def new_form_layout(self,name,label,widgets=None,layoutpattern=None):
        ...
        :returns: form layout control instance
        Assetic3IntegrationRepresentationsAssessmentFormFormLayoutRepresentation()
        """
        try:
            formlayout = Assetic3IntegrationRepresentationsAssessmentFormFormLayoutRepresentation(label=label)
        except Exception as ex:
    ...
    def new_layout_pattern(self,patternid):
        ...
        Assetic3IntegrationRepresentationsAssessmentFormFormLayoutPatternRepresentation()
        """
        if patternid < 1 or patternid > 25:
            ...
            self.logger.error(msg)
            return None
        layoutpattern = Assetic3IntegrationRepresentationsAssessmentFormFormLayoutPatternRepresentation()
    ...
    def new_form_widget(self,label,containernum=0,order=0,collapsed=False,form_control_group=None):
        ...
        :param form_control_group: optional.
          Assetic3IntegrationRepresentationsAssessmentFormFormControlGroupRepresentation
        :returns: widget instance
          Assetic3IntegrationRepresentationsAssessmentFormFormWidgetRepresentation()
        """
        widget = Assetic3IntegrationRepresentationsAssessmentFormFormWidgetRepresentation()
    ...
    def new_form_control_group(self,label,visible=True,form_controls=None):
        ...
        Assetic3IntegrationRepresentationsAssessmentFormFormControlGroupRepresentation()
        """
        controlgroup = Assetic3IntegrationRepresentationsAssessmentFormFormControlGroupRepresentation()
    ...
    def new_text_control(self,label,name=None,length=200,order=1,hint=None,visible=True,required=False):
        ...
        assetic.Assetic3IntegrationRepresentationsAssessmentFormFormControlRepresentation()
        """
        control = Assetic3IntegrationRepresentationsAssessmentFormFormControlRepresentation()
        if name == None:
    ...
    def new_combobox_item(self,label,value,order=1):
        ...
        :param order: order number in the field.  Optional.  Must be > 0
        :returns: form control instance with required settings for a text control
        assetic.Assetic3IntegrationRepresentationsAssessmentFormFormControlComboboxItemRepresentation()
        """
        item = Assetic3IntegrationRepresentationsAssessmentFormFormControlComboboxItemRepresentation()
        item.label = label
        item.value = value
