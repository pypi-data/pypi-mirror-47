...
from ..models.assetic3_integration_representations_file_properties_representation\
     import Assetic3IntegrationRepresentationsFilePropertiesRepresentation
from ..models.assetic3_integration_representations_document_work_request_representation\
     import Assetic3IntegrationRepresentationsDocumentWorkRequestRepresentation
from ..models.assetic3_integration_representations_document_work_order_representation\
     import Assetic3IntegrationRepresentationsDocumentWorkOrderRepresentation
from ..models.assetic3_integration_representations_document_asset_representation\
     import Assetic3IntegrationRepresentationsDocumentAssetRepresentation
import abc
...
##        folder_rep.asseticid = assetname
        ...
        asset_rep = Assetic3IntegrationRepresentationsComplexAssetRepresentation()
    ...
    def move_document_to_ecms(self,ecms_doc_rep,asset_as_parent = True,delete = True):
        ...
        if doc_rep.ecmsid == None:
            ...
            file_rep = Assetic3IntegrationRepresentationsFilePropertiesRepresentation()
            ...
            update_doc_rep = Assetic3IntegrationRepresentationsDocumentRepresentation()
...
##                      "Document ID={0}".format(docid)
    ...
    def update_document_metadata(self,doc_rep,setnulls=False):
        ...
        Param doc_rep: Assetic3IntegrationRepresentationsDocumentRepresentation
        ...
        Assetic3IntegrationRepresentationsDocumentRepresentation) != True:
    ...
    def get_document_metadata_by_id(self,docid):
        ...
        :return: Assetic3IntegrationRepresentationsDocumentRepresentation
        If error then None
        """
        try:
...
class ECMSDocumentRepresentation(object):
    ...
    :param assetic_doc_representation: Assetic3IntegrationRepresentationsDocumentRepresentation
    ...
    def __init__(self,assetic_doc_representation=None,ecmsid=None,ecmsparent=None,ecmsclassification=None,ecmsdoctype=None,ecmslevel=None,ecmsauthor=None,tags=list()):
        ...
        self.fieldtypes = {
            "assetic_doc_representation": "Assetic3IntegrationRepresentationsDocumentRepresentation",
            "ecmsid":"str",
            "ecmsparent":"str",
            "ecmsdoctype":"str",
    ...
    def assetic_doc_representation(self,assetic_doc_representation):
        ...
        if isinstance(assetic_doc_representation,
        Assetic3IntegrationRepresentationsDocumentRepresentation) != True:
