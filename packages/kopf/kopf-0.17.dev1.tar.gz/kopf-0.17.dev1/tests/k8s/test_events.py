...
def test_type_is_v1_not_v1beta1(req_mock):
    obj = {'apiVersion': 'group/version',
           'kind': 'kind',
           'metadata': {'namespace': 'ns',
                        'name': 'name',
...
def test_api_errors_logged_but_suppressed(req_mock, assert_logs):
...
def test_regular_errors_escalate(req_mock):
    error = Exception('boo!')
    req_mock.post.side_effect = error
...
def test_message_is_cut_to_max_length(req_mock):
    obj = {'apiVersion': 'group/version',
           'kind': 'kind',
           'metadata': {'namespace': 'ns',
                        'name': 'name',
