...
# -*- coding: utf-8 -*-
#
# pywwt documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'pywwt.tex', 'pywwt Documentation',
...
man_pages = [
    (master_doc, 'pywwt', 'pywwt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pywwt', 'pywwt Documentation',
     author, 'pywwt', 'One line description of project.',
     'Miscellaneous'),
]
