...
class RegressionFrame(object):
    ...
    def add_source(self, source_label, source_path, add_as_variable=True):
        new_source = hb.RegressionSource(source_label, source_path, self)
    ...
    def add_variable(self, variable_label, source_label, variable_type=None):
        new_variable = hb.RegressionVariable(variable_label, source_label, self, variable_type)
    ...
    def make_dummies_from_source(self, source_label, values_to_use=None):
...
class RegressionSource(object):
    def __init__(self, label, path, rf):
        self.label = label
        self.path = path
        self.data = None
        self.rf = rf
...
class RegressionVariable(object):
    def __init__(self, label, source_label, rf, variable_type):
        self.label = label
