...
class TestUtils(object):
 ...
 foobarr fourteen'''
    ...
    def test_interpolate_dn(self):
        assert interpolate_dn('cn=%(cn)s,ou=ldap', cn='staff') == 'cn=staff,ou=ldap'
        assert interpolate_dn('ou=ldap', cn='staff') == 'ou=ldap'
        assert interpolate_dn('ou=ldap') == 'ou=ldap'
        assert interpolate_dn('cn=%(cn)s,ou=ldap') == 'ou=ldap'
        assert interpolate_dn('cn=%(cn)s,ou=%(dept)s,ou=ldap', cn='staff') == 'ou=ldap'
