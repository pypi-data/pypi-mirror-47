...
report = Report.create(
    'VoIP IV', position=12.4, description=description,
...
biztable = bizhours.BusinessHoursTable.create('voip4-biztable', base,
...
p = qs.voip4_95PerDayTimeSeriesTable.create('voip4-95perday', biztable,
                                            cols=['avg_bits'])

report.add_widget(
    yui3.TimeSeriesWidget, p,
    'EF - Avg Bits/s Inbound - 95 percentile per day',
    width=12)
