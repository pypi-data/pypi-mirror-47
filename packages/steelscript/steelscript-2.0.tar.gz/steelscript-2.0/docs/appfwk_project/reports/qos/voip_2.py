...
#
description = """
<p> This report demonstrates computing a 95th percentile.
...
report = Report.create(
    'VoIP II', position=12.2, description=description,
...
p.add_column('avg_bits_95', 'Avg Bits/s 95th %ile', units='b/s',
