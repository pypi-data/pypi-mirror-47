...
report = Report.create(title="CIFS Performance From NetShark Data",
                       field_order=['netshark_device',
                                    'netshark_source_name',
                                    'timespec',
                                    'assumed_rtt',
                                    'local_rtt',
                                    'assumed_fte_cost',
...
table = HeroNetSharkTable.create('CIFS_Performance',
                                 include_files=True)
...
# table.add_column('packets', 'Packets',
#                  datatype=Column.DATATYPE_INTEGER, iskey=True)
