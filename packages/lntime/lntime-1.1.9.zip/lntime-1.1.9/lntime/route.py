...
def exttime(ggtime,page,quyu):
    ...
    fast=set([
        ...
        ,"guizhou_anshun","guizhou_bijie","guizhou_guiyang","guizhou_liupanshui","guizhou_qiandong","guizhou_qiannan"
        ,"guizhou_qianxi","guizhou_shenghui","guizhou_tongren"

        ,"hainan_danzhou","hainan_dongfang","hainan_haikou","hainan_hainan","hainan_qionghai","hainan_sansha","hainan_sanya"
