...
def anova(config, y, f, df, csv, path, effects, is_html=True):
    ...
    Returns
    -------
    model : :class:`rpy2.robjects.methods.RS4`
        Python representation of an R instance of class 'S4'.
    df_anova : :class:`pandas.core.frame.DataFrame`
...
def lmer(config, y, f, df, exclude, csv, path, effects, is_html=True):
    ...
    model : :class:`rpy2.robjects.methods.RS4`
        Python representation of an R instance of class 'S4'.
    df_lmer : :class:`pandas.core.frame.DataFrame`
        Pandas dataframe of model output.
    get_lmer : :class:`str`
        R script to run model.
    html : :class:`str
...
def logistic(config, y, f, df, me, exclude, csv, path, is_html=True):
    ...
    model : :class:`rpy2.robjects.methods.RS4`
        Python representation of an R instance of class 'S4'.
    df_logit : :class:`pandas.core.frame.DataFrame`
        Pandas dataframe of model output.
    get_logit : :class:`str`
        R script to run model.
    html : :class:`str
