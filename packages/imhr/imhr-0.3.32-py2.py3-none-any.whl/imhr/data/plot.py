...
class Plot():
	...
	@classmethod
	def bokeh_trial(cls, config, df, stim_bounds, roi_bounds, flt):
	...
	@classmethod
	def bokeh_calibration(cls, config, df, cxy, event, monitorSize=[1920,1080]):
	...
	@classmethod
	def onset_diff_plot(cls, config, df, meta, drop, y, clip=None):
	...
	@classmethod
	def density_plot(cls, config, df, title):
		"""
	...
	@classmethod
	def corr_matrix(cls, config, df, path, title, method, footnote=None):
		"""
	...
	@classmethod
	def single_subject(cls, config, df, path):
	...
	@classmethod
	def boxplot(cls, config, df, path=None, x=None, y=None, title=None, plots=None, cat='analysis'):
		"""
	...
	@classmethod
	def cooks_plot(cls, config, y, model, path, df):
	...
	@classmethod
	def residual_plot(cls, config, y, residuals, path):
	...
	@classmethod
	def qq_plot(cls, config, y, residuals, path):
		"""Create probability plot using seaborn, pandas, and rpy2.
	...
	@classmethod
	def logit_plot(cls, config, df, path, param):
