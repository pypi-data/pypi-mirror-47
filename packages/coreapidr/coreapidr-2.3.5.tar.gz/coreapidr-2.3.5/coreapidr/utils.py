from coreapidr import exceptions
from coreapidr.compat import string_types, text_type, urlparse, _TemporaryFileWrapper
...
def get_installed_codecs():
    packages = [
        ...
        pkg_resources.iter_entry_points(group='coreapidr.codecs')
    ]
    return {
