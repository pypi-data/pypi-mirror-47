from coreapidr import codecs, exceptions, transports
from coreapidr.compat import string_types
from coreapidr.document import Document, Link
from coreapidr.utils import determine_transport, get_installed_codecs
import collections
import itypes
