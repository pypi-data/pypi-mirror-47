...
class Board(BoardBase):
    ...
    def get_vin(self):
        ...
        vin = self._cat_file(self.PATH_VIN, 17)
        return vin
    ...
    def _cat_file(self, filename,  file_len):
        while True:
            try:
    ...
    def _echo_to_file(self, filename, content):
...
class Config(object):
    ...
    def validate(self):
        if self.vin is None:
            raise ConfigValidationError("VIN code is not set.")
