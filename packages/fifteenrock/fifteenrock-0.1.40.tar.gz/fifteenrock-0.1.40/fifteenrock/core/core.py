...
def logs(url: str = None, credentials: Dict[str, str] = None, credentials_file: str = None,
         project: str = None, function: str = None, start_time: str = None, end_time: str = None):
    endpoint = 'logs'
    raw_data = dict(project=project, function=function, start_time=start_time, end_time=end_time)
    endpoint_url = make_endpoint_url(url, endpoint)
    new_headers = make_headers(credentials, credentials_file)
...
def deploy(project: str, function: str, url: str = None, main_file: str = None, dependencies: List = None,
    ...
    try:
        ...
        if deploy_result['type'] == 'success':
            result = poll_if_function_created(deploy_result['function_id'], compute_url, headers)
        else:
