...
class WorkbookResponse(SaaSposeResponse):
    ...
    def get_swagger_types():
        return dict(WorkbookResponse.swagger_types, **SaaSposeResponse.get_swagger_types())
    
    @staticmethod
    def get_attribute_map():
        return dict(WorkbookResponse.attribute_map, **SaaSposeResponse.get_attribute_map())
    ...
    def __init__(self, workbook=None, **kw):
        super(WorkbookResponse, self).__init__(**kw)
