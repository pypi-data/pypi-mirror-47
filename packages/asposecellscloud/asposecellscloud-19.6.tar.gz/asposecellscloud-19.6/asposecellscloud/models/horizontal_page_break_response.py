...
class HorizontalPageBreakResponse(SaaSposeResponse):
    ...
    def get_swagger_types():
        return dict(HorizontalPageBreakResponse.swagger_types, **SaaSposeResponse.get_swagger_types())
    
    @staticmethod
    def get_attribute_map():
        return dict(HorizontalPageBreakResponse.attribute_map, **SaaSposeResponse.get_attribute_map())
    ...
    def __init__(self, horizontal_page_break=None, **kw):
        super(HorizontalPageBreakResponse, self).__init__(**kw)
