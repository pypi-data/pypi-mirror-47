...
class LineResponse(SaaSposeResponse):
    ...
    def get_swagger_types():
        return dict(LineResponse.swagger_types, **SaaSposeResponse.get_swagger_types())
    
    @staticmethod
    def get_attribute_map():
        return dict(LineResponse.attribute_map, **SaaSposeResponse.get_attribute_map())
    ...
    def __init__(self, line=None, **kw):
        super(LineResponse, self).__init__(**kw)
