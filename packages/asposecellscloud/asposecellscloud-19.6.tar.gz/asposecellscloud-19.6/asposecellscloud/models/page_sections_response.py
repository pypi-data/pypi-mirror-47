...
class PageSectionsResponse(SaaSposeResponse):
    """
    ...
    def __init__(self, page_sections=None, **kw):
        ...
        self.container['page_sections'] = None
    ...
    def page_sections(self):
        """
        Gets the page_sections of this PageSectionsResponse.

        :return: The page_sections of this PageSectionsResponse.
        :rtype: list[PageSection]
        """
        return self.container['page_sections']

    @page_sections.setter
    def page_sections(self, page_sections):
        """
        Sets the page_sections of this PageSectionsResponse.

        :param page_sections: The page_sections of this PageSectionsResponse.
        :type: list[PageSection]
        """

        self.container['page_sections'] = page_sections
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PageSectionsResponse):
            return False
