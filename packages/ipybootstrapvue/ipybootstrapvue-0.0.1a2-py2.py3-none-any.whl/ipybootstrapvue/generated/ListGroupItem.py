...
class ListGroupItem(VuetifyWidget):

    _model_name = Unicode('ListGroupItemModel').tag(sync=True)

    action = Bool(None, allow_none=True).tag(sync=True)
