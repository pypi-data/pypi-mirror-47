...
class SamplingTestCase(TestCase):
    ...
    def test_generate_sample_args(self):
        ...
        args = generate_sample_args(size=233, queries={'q': 'tr'},
                                    filter={'f': 'fr'})
        self.assertEqual(
            [(100, {'f': 'fr'}, {'q': 'tr'}),
             (100, {'f': 'fr'}, {'q': 'tr'}),
    ...
    def test_extend_sample(self):
        s1 = [{'DOI': '123', 'title': 'Title 123'},
              {'DOI': '124', 'title': 'Title 124'},
              {'DOI': '123', 'title': 'Title 123'},
              {'DOI': '125', 'title': 'Title 125'}]
        s2 = [{'DOI': '128', 'title': 'Title 128'},
              {'DOI': '124', 'title': 'Title 124'},
              {'DOI': '123', 'title': 'Title 123'},
              {'DOI': '128', 'title': 'Title 128'}]
