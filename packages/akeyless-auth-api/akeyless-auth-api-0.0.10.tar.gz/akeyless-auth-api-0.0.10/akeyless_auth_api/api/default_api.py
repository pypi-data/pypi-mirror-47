...
class DefaultApi(object):
    ...
    def authenticate(self, policy_id, **kwargs):  # noqa: E501
        """Return a temporary access credentials  # noqa: E501

        Client that meet an access policy will be able to get temporary credentials to access the service that created the policy for him. The client must provide the relevant parameters that proves his compliance with the policy. In this case the IP address used for authentication will be taken from the http request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.authenticate(policy_id, async=True)
        >>> result = thread.get()
        ...
        :param int timestamp: A Unix timestamp which was used for the signature (relevant only in case of api key access policy).
        :param str nonce: Random string which was used for the signature (relevant only in case of api key access policy).
        :param str signature: A digital signature generated with the private key that complies with the access policy (relevant only in case of api key access policy).
        :param str access_token: An access token as a signed JSON Web Toke (relevant only in case of azure-az/oauth2 access policy).
        ...
        if kwargs.get('async'):
            return self.authenticate_with_http_info(policy_id, **kwargs)  # noqa: E501
        else:
            (data) = self.authenticate_with_http_info(policy_id, **kwargs)  # noqa: E501
            return data

    def authenticate_with_http_info(self, policy_id, **kwargs):  # noqa: E501
        """Return a temporary access credentials  # noqa: E501

        Client that meet an access policy will be able to get temporary credentials to access the service that created the policy for him. The client must provide the relevant parameters that proves his compliance with the policy. In this case the IP address used for authentication will be taken from the http request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.authenticate_with_http_info(policy_id, async=True)
        >>> result = thread.get()
        ...
        all_params = ['policy_id', 'akeyless_request_id', 'akeyless_client_id', 'timestamp', 'nonce', 'signature', 'access_token', 'client_ip', 'creds_expiry']  # noqa: E501
        ...
        if ('policy_id' not in params or
            ...
            raise ValueError("Missing the required parameter `policy_id` when calling `authenticate`")  # noqa: E501
    ...
    def authenticate_uam(self, policy_id, **kwargs):  # noqa: E501
        """Return a combination of three temporary credentials for accessing Auth, UAM and KFMs instances.  # noqa: E501

        System's user that meet an access policy will be able to get a combination of three temporary credentials signed by Auth for accessing Auth, UAM and KFMs instances. The client must provide the relevant parameters that proves his compliance with the policy. In this case the IP address used for authentication will be taken from the http request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.authenticate_uam(policy_id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.authenticate_uam_with_http_info(policy_id, **kwargs)  # noqa: E501
        else:
            (data) = self.authenticate_uam_with_http_info(policy_id, **kwargs)  # noqa: E501
            return data

    def authenticate_uam_with_http_info(self, policy_id, **kwargs):  # noqa: E501
        """Return a combination of three temporary credentials for accessing Auth, UAM and KFMs instances.  # noqa: E501

        System's user that meet an access policy will be able to get a combination of three temporary credentials signed by Auth for accessing Auth, UAM and KFMs instances. The client must provide the relevant parameters that proves his compliance with the policy. In this case the IP address used for authentication will be taken from the http request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.authenticate_uam_with_http_info(policy_id, async=True)
        >>> result = thread.get()
        ...
        if ('policy_id' not in params or
                params['policy_id'] is None):
            raise ValueError("Missing the required parameter `policy_id` when calling `authenticate_uam`")  # noqa: E501
