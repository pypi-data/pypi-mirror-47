...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-s3-notifications", "0.34.0", __name__, "aws-s3-notifications@0.34.0.jsii.tgz")
...
class LambdaDestination(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-s3-notifications.LambdaDestination"):
    ...
    def bind(self, _scope: aws_cdk.cdk.Construct, bucket: aws_cdk.aws_s3.IBucket) -> aws_cdk.aws_s3.BucketNotificationDestinationConfig:
