...
# -*- coding: utf-8 -*-
#
# Orange3-Textable documentation build configuration file, created by
...
copyright = (
      u'2012-2018 '
    + author
    + u', translation \u00A9 2014-2018 University of Lausanne'
)
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'biolab_doc']
...
htmlhelp_basename = 'Orange3-Textabledoc'
...
man_pages = [
    (master_doc, 'orange3-textable', 'Orange3-Textable Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Orange3-Textable', 'Orange3-Textable Documentation',
     author, 'Orange3-Textable', 'One line description of project.',
     'Miscellaneous'),
]
