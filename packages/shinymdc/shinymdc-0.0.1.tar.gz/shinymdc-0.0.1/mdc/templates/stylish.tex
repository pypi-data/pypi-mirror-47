...
\sectionfont{\raggedright\normalfont\fontspec{futura_medium.ttf}[Path=\string~/.latex/fonts/]\fontsize{15}{0}\selectfont}
\subsectionfont{\raggedright\normalfont\fontspec{futura_book.ttf}[Path=\string~/.latex/fonts/]\fontsize{13}{0}\selectfont}
\subsubsectionfont{\raggedright\normalfont\fontspec{futura_book.ttf}[Path=\string~/.latex/fonts/]\fontsize{9}{0}\selectfont\MakeUppercase}
...
\renewcommand{\captionfont}{\fontspec{futura_light.ttf}[Path=\string~/.latex/fonts/]}
\renewcommand{\captionlabelfont}{\fontspec{futura_medium.ttf}[Path=\string~/.latex/fonts/]}
...
\blfootnote{%
  {%
    \scriptsize\fontspec{futura_light.ttf}[Path=\string~/.latex/fonts/]%
