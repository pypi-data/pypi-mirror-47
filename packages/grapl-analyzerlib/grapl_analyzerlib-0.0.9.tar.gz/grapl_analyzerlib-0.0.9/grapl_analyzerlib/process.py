...
class ProcessQuery(object):
    ...
    def _get_var_block(self, binding_num: int, root: node.NQ, already_converted: Set[node.NQ]) -> str:
    ...
    def _get_var_block_root(self, binding_num: int, root: node.NQ, node_key: str) -> str:
