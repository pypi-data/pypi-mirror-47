...
def reset(device_name):
    """
    Takes in the device name and opens a connection to the device module to reset the device's profile. Once reset, device module connection closed.
    ...
    Used when a device profile needs to be reset or if device needs to be restart
    """
...
def on_file_available(data_type, filename):
    """
    Tells users that a recorded file for a datatype is available under the name filename.
    ...
    Used to tell users of available recording files
    """
...
def on_meta_file_available(session_id, meta_filename):
    """
    Output to user that there is a new meta file with id session_id available called meta_filename
    ...
    Used to tell users of available meta files
    """
