...
def f1(driver, num):
    ...
    contents = body.xpath("//div[@class='per95']/table/tbody/tr[child::td][1]")
    data = []
    for content in contents:
        name = content.xpath('./td/div/a/text()')[0].strip()
        href = content.xpath('./td/div/a/@href')[0].stri()
        xm_code = content.xpath("./td[first()]/text()")[0].strip()
...
if __name__ == '__main__':
    # work(conp=["postgres","since2015","192.168.3.171","zlshenpi","guangdong"])
