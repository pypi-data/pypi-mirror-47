...
class PersonalIdentification(object):
    """
    ...
    def __init__(self, id=None, type=None, issued_by=None):
        """
        PersonalIdentification - a model defined in Swagger
        """
    ...
    def id(self):
        """
        Gets the id of this PersonalIdentification.
        ...
        :return: The id of this PersonalIdentification.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this PersonalIdentification.
        Customer's identification number.  **Important**: Contact your TeleCheck representative to learn whether this field is required or optional. 

        :param id: The id of this PersonalIdentification.
        :type: str
        """
    ...
    def issued_by(self):
        """
        Gets the issued_by of this PersonalIdentification.

        :return: The issued_by of this PersonalIdentification.
    ...
    def issued_by(self, issued_by):
        """
        Sets the issued_by of this PersonalIdentification.

        :param issued_by: The issued_by of this PersonalIdentification.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PersonalIdentification):
            return False
