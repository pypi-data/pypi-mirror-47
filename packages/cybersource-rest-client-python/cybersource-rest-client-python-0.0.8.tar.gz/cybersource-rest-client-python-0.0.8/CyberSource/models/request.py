...
class Request(object):
    ...
    def __init__(self, client_reference_information=None, order_information=None, payment_information=None, consumer_authentication_information=None):
        """
    ...
    def client_reference_information(self):
        """
        Gets the client_reference_information of this Request.

        :return: The client_reference_information of this Request.
    ...
    def client_reference_information(self, client_reference_information):
        """
        Sets the client_reference_information of this Request.

        :param client_reference_information: The client_reference_information of this Request.
    ...
    def order_information(self):
        """
        Gets the order_information of this Request.

        :return: The order_information of this Request.
    ...
    def order_information(self, order_information):
        """
        Sets the order_information of this Request.

        :param order_information: The order_information of this Request.
    ...
    def consumer_authentication_information(self):
        """
        Gets the consumer_authentication_information of this Request.

        :return: The consumer_authentication_information of this Request.
    ...
    def consumer_authentication_information(self, consumer_authentication_information):
        """
        Sets the consumer_authentication_information of this Request.

        :param consumer_authentication_information: The consumer_authentication_information of this Request.
