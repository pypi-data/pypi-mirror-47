...
class EmbeddedInstrumentIdentifier(object):
    """
    ...
    def __init__(self, links=None, object=None, state=None, id=None, card=None, bank_account=None, processing_information=None, metadata=None):
        """
        EmbeddedInstrumentIdentifier - a model defined in Swagger
        """
    ...
    def links(self):
        """
        Gets the links of this EmbeddedInstrumentIdentifier.

        :return: The links of this EmbeddedInstrumentIdentifier.
    ...
    def links(self, links):
        """
        Sets the links of this EmbeddedInstrumentIdentifier.

        :param links: The links of this EmbeddedInstrumentIdentifier.
    ...
    def object(self):
        """
        Gets the object of this EmbeddedInstrumentIdentifier.
        Describes type of token.

        :return: The object of this EmbeddedInstrumentIdentifier.
        :rtype: str
        """
        return self._object
    ...
    def object(self, object):
        """
        Sets the object of this EmbeddedInstrumentIdentifier.
        Describes type of token.

        :param object: The object of this EmbeddedInstrumentIdentifier.
        :type: str
        """
    ...
    def id(self):
        """
        Gets the id of this EmbeddedInstrumentIdentifier.
        The ID of the existing instrument identifier to be linked to the newly created payment instrument.

        :return: The id of this EmbeddedInstrumentIdentifier.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this EmbeddedInstrumentIdentifier.
        The ID of the existing instrument identifier to be linked to the newly created payment instrument.

        :param id: The id of this EmbeddedInstrumentIdentifier.
        :type: str
        """
    ...
    def card(self):
        """
        Gets the card of this EmbeddedInstrumentIdentifier.

        :return: The card of this EmbeddedInstrumentIdentifier.
    ...
    def card(self, card):
        """
        Sets the card of this EmbeddedInstrumentIdentifier.

        :param card: The card of this EmbeddedInstrumentIdentifier.
    ...
    def processing_information(self):
        """
        Gets the processing_information of this EmbeddedInstrumentIdentifier.

        :return: The processing_information of this EmbeddedInstrumentIdentifier.
    ...
    def processing_information(self, processing_information):
        """
        Sets the processing_information of this EmbeddedInstrumentIdentifier.

        :param processing_information: The processing_information of this EmbeddedInstrumentIdentifier.
    ...
    def metadata(self):
        """
        Gets the metadata of this EmbeddedInstrumentIdentifier.

        :return: The metadata of this EmbeddedInstrumentIdentifier.
    ...
    def metadata(self, metadata):
        """
        Sets the metadata of this EmbeddedInstrumentIdentifier.

        :param metadata: The metadata of this EmbeddedInstrumentIdentifier.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, EmbeddedInstrumentIdentifier):
            return False
