...
class Metric:
    ...
    def __init__(self, name, value, extended_properties, schema_version=METRIC_SCHEMA_VERSION_CUR):
        ...
        :type value: float
        :param extended_properties: dictionary of string to python primitive type (int, float, str)
        :type extended_properties: dict
        :param name: schema_version of metric, optional, set to METRIC_SCHEMA_VERSION_CUR if no specific value set
        :type name: str
