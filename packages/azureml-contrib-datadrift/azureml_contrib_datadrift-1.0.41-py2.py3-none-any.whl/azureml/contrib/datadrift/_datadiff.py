...
import json
from ._utils.constants import METRIC_DATASHIFT_MCC_ALL, METRIC_STATISTICAL_DISTANCE_ENERGY, \
    METRIC_STATISTICAL_DISTANCE_WASSERSTEIN, \
    METRIC_DATASHIFT_FEATURE_IMPORTANCE, METRIC_DATASHIFT_MCC_TRAIN, METRIC_DATASHIFT_MCC_TEST, METRIC_TYPE, \
    COLUMN_NAME
...
class MetricType(Enum):
    """Class represents a metric type enum."""
...
class Metric:
    ...
    def __init__(self, name, value, extended_properties):
        ...
        :type value: float
        :param extended_properties: dict
...
class DataDiff:
    ...
    def __init__(self,
        ...
        :param whitelist: A list of columns to be excluded from diff
        calculation
        :type whitelist: numpy.array[str]
    ...
    def get_metrics_list():
        ...
        metrics_list = [
            (METRIC_DATASHIFT_MCC_ALL, MetricType.dataset.name),
            (METRIC_DATASHIFT_MCC_TEST, MetricType.dataset.name),
            (METRIC_DATASHIFT_MCC_TRAIN, MetricType.dataset.name),
            (METRIC_DATASHIFT_FEATURE_IMPORTANCE, MetricType.column.name),
