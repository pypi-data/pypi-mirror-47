...
class RestClientConfiguration(Configuration):
    ...
    def __init__(
        ...
        if not base_url:
            base_url = 'https://master.experiments.azureml-test.net'

        super(RestClientConfiguration, self).__init__(base_url)

        self.add_user_agent('azureml.contrib.datadrift._restclient/{}'.format(VERSION))
...
class RestClient(object):
    ...
    def create(
            self, subscription_id, resource_group_name, workspace_name, dto=None, custom_headers=None, raw=False, **operation_config):
        """Create.
        ...
        :param dto:
        :type dto: ~_restclient.models.DataDriftDto
        ...
        # Construct body
        if dto is not None:
            body_content = self._serialize.body(dto, 'DataDriftDto')
        else:
            body_content = None
    ...
    def update(
            self, subscription_id, resource_group_name, workspace_name, id, dto=None, custom_headers=None, raw=False, **operation_config):
        """Update.
    ...
    def list(
            self, subscription_id, resource_group_name, workspace_name, query=None, continuation_token=None, custom_headers=None, raw=False, **operation_config):
        """List.
    ...
    def get_runs(
            self, subscription_id, resource_group_name, workspace_name, id, continuation_token=None, custom_headers=None, raw=False, **operation_config):
        """GetRuns.
    ...
    def run(
        ...
        :type id: str
        :param dto:
        :type dto: ~_restclient.models.DataDriftRunDto
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        # Construct body
        if dto is not None:
            body_content = self._serialize.body(dto, 'DataDriftRunDto')
        else:
            body_content = None
