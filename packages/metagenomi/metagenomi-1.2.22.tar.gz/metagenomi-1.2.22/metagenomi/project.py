...
class MgProject:
    ...
    # def concat_sequencings(self, sample):
    #     '''
    #     Concatenate all sequencings for a sample
    #     '''
    #
    #     if not isinstance(sample, MgObj):
    #         sample = self.find_object(sample)
    #
    #     for sequence in sample.associated['sequencings']:
    #


        # sequences is a list of objects
