...
class Panel_Output(QWidget):
    def __init__(self, **params):
        ...
        # Boundary (misc)
        self.gr_misc = QGroupBox("Misc Options")
        ...
        self.ck_evenH = QCheckBox("Evenly Distributed (X)")
        self.ck_evenV = QCheckBox("Evenly Distributed (Y)")
    ...
    def initUI(self):
        ...
        self.lo_seg.addWidget(self.gr_misc)
...
class Widget_Seg(Widget_Img):
    ...
    def mouseMoveEvent(self, event):
        ...
        # pan
        if (event.button()==Qt.LeftButton)&(self.task>0):
            if self.is_fit_width:
