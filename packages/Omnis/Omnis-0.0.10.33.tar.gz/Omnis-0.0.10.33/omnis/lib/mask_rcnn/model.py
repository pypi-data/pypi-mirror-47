...
def detection_targets_graph(proposals, gt_class_ids,
...
def build_detection_targets(rpn_rois, gt_class_ids,
                            gt_boxes, gt_masks, config):
...
def data_generator(
    ...
    while True:
        try:
            ...
            # If the image source is not to be augmented pass None as
            # augmentation
