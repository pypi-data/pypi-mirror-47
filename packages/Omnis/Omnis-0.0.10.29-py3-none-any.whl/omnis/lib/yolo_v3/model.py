...
def yolo_boxes_and_scores(feats, anchors, num_classes,
...
def preprocess_true_boxes(true_boxes, input_shape, anchors, num_classes):
    ...
    grid_shapes = [input_shape // {0: 32, 1: 16, 2: 8}[l]
                   for l in range(num_layers)]
    y_true = [np.zeros((m, grid_shapes[l][0], grid_shapes[l][1], len(
        anchor_mask[l]), 5 + num_classes), dtype='float32') for l in range(num_layers)]
