...
class Package:
    ...
    def cache_symbol_at_home(self,path):
        #复制符号表到本地
        root_path = Config().get_config("File-store-path","cache_path")
        sym_path = "symbol/"
        cache_path = root_path + sym_path + path
    ...
    def auto_package(self, project_address=None, branch_name=None, platform=None, net_env=None, project_version=None, project_build=None,emails=None,tag_name=None,package_order=None):
        if branch_name == None:
            branch_name = "Develop"
        if platform == None:
            platform = "pgyer"
...
if __name__ == "__main__":
    ...
    Package().cache_symbol_at_home("test")