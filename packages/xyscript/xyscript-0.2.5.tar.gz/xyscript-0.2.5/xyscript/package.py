...
class Package:
    ...
    def package_to_platform(self,platform=None, project_version=None, project_build=None, emails=None, env=None):
        """
    ...
    def auto_package(self, project_address=None, branch_name=None, platform=None, net_env=None, project_version=None, project_build=None,emails=None,tag_name=None):
        if branch_name == None:
            branch_name = "Develop"
        if platform == None:
            platform = "pgyer"
        ...
        # #打包
        self.package_to_platform(platform, project_version, project_build,emails,env=net_env)
        # 打tag
...
if __name__ == "__main__":
    ...
    # IOSTool().add_content_to_file("AppDelegate.h")
    # Package().add_tag_after_package("tag_02")