...
if __name__ == "__main__":
    pass
    # _folder_is_exist("./dist/")
    # os.system("sudo bash /Users/sunweiwei/Desktop/Saic/xyscript/xyscript/shell/test.sh")
    # os.system("ls")
    # os.system("echo ")
    # os.system("ls | tee -a log.text")
    # os.system("ls")
    # main()
    ...
    # _print_helpdoc()
    # pullsubmodule()
    # print(IOSProjectTool().have_podfile())

    # os.chdir("/Users/sunweiwei/Desktop/Saic/ios-shell-passenger")
    # import subprocess
    ...
    # p = subprocess.Popen('xyscript syn',shell=True,stdout=subprocess.PIPE)  
    # while True:
