...
_PACKAGE_PATH = os.path.dirname(nvector.__file__)
if 'dev' in _VERSION:
    _PKG_URL = "http://github.com/pbrod/nvector/tree/master/src/nvector/{1!s}{2!s}"
else:
    _PKG_URL = "http://github.com/pbrod/nvector/tree/v{0!s}/src/nvector/{1!s}{2!s}"
...
project = u'nvector'
copyright = u'2015-{}, Norwegian Defence Research Establishment (FFI)'.format(CURRENT_YEAR)
...
def _get_fullfile(obj):
    ...
    try:
        ...
        fn = None
    return os.path.relpath(fn, start=_PACKAGE_PATH)
