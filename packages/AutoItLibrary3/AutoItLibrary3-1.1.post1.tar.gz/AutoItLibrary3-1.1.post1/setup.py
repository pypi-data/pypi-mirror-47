...
if __name__ == "__main__":
    ...
    if sys.argv[1].lower() == "install" :
        if os.name == "nt" :
            ...
            #
            if os.path.isfile(os.path.join(get_python_lib(), "AutoItLibrary3/lib/AutoItX3.dll")) :
                print ("Don't think we need to unregister the old one...")

            instDir = os.path.normpath(os.path.join(get_python_lib(), "AutoItLibrary3/lib"))
