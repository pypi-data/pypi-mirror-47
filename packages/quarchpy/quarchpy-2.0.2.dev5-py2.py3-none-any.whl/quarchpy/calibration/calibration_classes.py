...
def populateCalHeader_HdPpm (calHeader, myDevice, calAction):
    ...
    # special case for x6 PPM, append position to enclosure serial
    if ("QTL1995" in calHeader.quarchEnclosureSerial):
        calHeader.quarchEnclosureSerial = calHeader.quarchEnclosureSerial + "-" + myDevice.sendCommand("*POSITION?")
