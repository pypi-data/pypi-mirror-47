...
import loss_landscapes.common.evaluators.torch.sl_evaluators as sl_evaluators
import loss_landscapes.common.evaluators.torch.misc_evaluators as misc_evaluators
...
def main():
    ...
    test_evaluator = misc_evaluators.ClassificationAccuracyEvaluator(x_test, y_test)
    ...
    loss_evaluator = sl_evaluators.LossEvaluator(criterion, x, y)
