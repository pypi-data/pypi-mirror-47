...
class ArtifactsApi(object):
    ...
    def artifacts_create(self, **kwargs):  # noqa: E501
        ...
        :param str upload: An href for an Upload.
    ...
    def artifacts_create_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.artifacts_create_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if ('md5' in local_var_params and
            ...
            raise ApiValueError("Invalid value for parameter `md5` when calling `artifacts_create`, length must be greater than or equal to `1`")  # noqa: E501
        if ('sha1' in local_var_params and
                len(local_var_params['sha1']) < 1):
            raise ApiValueError("Invalid value for parameter `sha1` when calling `artifacts_create`, length must be greater than or equal to `1`")  # noqa: E501
        if ('sha224' in local_var_params and
                len(local_var_params['sha224']) < 1):
            raise ApiValueError("Invalid value for parameter `sha224` when calling `artifacts_create`, length must be greater than or equal to `1`")  # noqa: E501
        if ('sha256' in local_var_params and
                len(local_var_params['sha256']) < 1):
            raise ApiValueError("Invalid value for parameter `sha256` when calling `artifacts_create`, length must be greater than or equal to `1`")  # noqa: E501
        if ('sha384' in local_var_params and
                len(local_var_params['sha384']) < 1):
            raise ApiValueError("Invalid value for parameter `sha384` when calling `artifacts_create`, length must be greater than or equal to `1`")  # noqa: E501
        if ('sha512' in local_var_params and
                len(local_var_params['sha512']) < 1):
            raise ApiValueError("Invalid value for parameter `sha512` when calling `artifacts_create`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def artifacts_delete(self, artifact_href, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.artifacts_delete(artifact_href, async_req=True)
        >>> result = thread.get()
    ...
    def artifacts_delete_with_http_info(self, artifact_href, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.artifacts_delete_with_http_info(artifact_href, async_req=True)
        >>> result = thread.get()
        ...
        if ('artifact_href' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `artifact_href` when calling `artifacts_delete`")  # noqa: E501
    ...
    def artifacts_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.artifacts_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['repository_version', 'md5', 'sha1', 'sha224', 'sha256', 'sha384', 'sha512', 'page', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def artifacts_read(self, artifact_href, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.artifacts_read(artifact_href, async_req=True)
        >>> result = thread.get()
    ...
    def artifacts_read_with_http_info(self, artifact_href, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.artifacts_read_with_http_info(artifact_href, async_req=True)
        >>> result = thread.get()
        ...
        if ('artifact_href' not in local_var_params or
                local_var_params['artifact_href'] is None):
            raise ApiValueError("Missing the required parameter `artifact_href` when calling `artifacts_read`")  # noqa: E501
