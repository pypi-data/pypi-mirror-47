...
class WorkersApi(object):
    ...
    def workers_list(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.workers_list(async_req=True)
        >>> result = thread.get()
    ...
    def workers_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workers_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if 'missing' in local_var_params:
            query_params.append(('missing', local_var_params['missing']))  # noqa: E501
        if 'last_heartbeat' in local_var_params:
    ...
    def workers_read(self, worker_href, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workers_read(worker_href, async_req=True)
        >>> result = thread.get()
    ...
    def workers_read_with_http_info(self, worker_href, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.workers_read_with_http_info(worker_href, async_req=True)
        >>> result = thread.get()
        ...
        if ('worker_href' not in local_var_params or
                local_var_params['worker_href'] is None):
            raise ApiValueError("Missing the required parameter `worker_href` when calling `workers_read`")  # noqa: E501
