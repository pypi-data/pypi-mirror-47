...
class Status(object):
    ...
    def __init__(self, versions=None, online_workers=None, missing_workers=None, database_connection=None, redis_connection=None):  # noqa: E501
