...
class UploadsApi(object):
    ...
    def uploads_create_with_http_info(self, content_range, file, **kwargs):  # noqa: E501
        ...
        if 'content_range' in local_var_params and not re.search(r'^bytes (?P<start>\d+)-(?P<end>\d+)\/(?P<total>\d+)$', local_var_params['content_range']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `content_range` when calling `uploads_create`, must conform to the pattern `/^bytes (?P<start>\d+)-(?P<end>\d+)\/(?P<total>\d+)$/`")  # noqa: E501
        collection_formats = {}
    ...
    def uploads_update_with_http_info(self, upload_href, content_range, file, **kwargs):  # noqa: E501
        ...
        if 'content_range' in local_var_params and not re.search(r'^bytes (?P<start>\d+)-(?P<end>\d+)\/(?P<total>\d+)$', local_var_params['content_range']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `content_range` when calling `uploads_update`, must conform to the pattern `/^bytes (?P<start>\d+)-(?P<end>\d+)\/(?P<total>\d+)$/`")  # noqa: E501
        collection_formats = {}
