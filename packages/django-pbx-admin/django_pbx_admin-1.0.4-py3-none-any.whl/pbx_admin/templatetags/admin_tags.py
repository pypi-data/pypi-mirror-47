...
def fieldset(
    context, fieldset, form=None, formset=None, nested_list=None, sub_object=None
):
...
def render_list_row(
    context, admin, obj, fields_list=None, show_actions=True, outer_tag=True
):
    obj_id = None
    ...
    for field_name in fields_list:
        ...
        fields.append(
            {"is_bool": isinstance(value, bool), "value": value, "tooltip": tooltip}
        )
