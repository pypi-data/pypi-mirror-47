...
#        Q50 =self.time_series.median()
    ...
    def __set_percentiles(self):
        ...
        p= self.time_series.quantile(q, interpolation ='linear')
        self._lazy_Q95 =p[q[0]]
        self._lazy_Q90 =p[q[1]]
        self._lazy_Q75=p[q[2]]
        self._lazy_Q50=p[q[3]]
        self._lazy_Q25=p[q[4]]
