...
class MixIn (
    ...
    def __init__ (self):
        ...
        self.service_root = None # IMP: set from wsgi_apps, services package root module
        self.mount_params = {}
        self.reloadables = {}
    ...
    def reinstead_service_root (self):
        if self.service_root:
            # reinstead package root for path finder
            sys.modules [self.service_root.__name__] = self.service_root    
