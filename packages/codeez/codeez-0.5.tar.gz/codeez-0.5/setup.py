...
setup(
  ...
  description = 'codeez python SDK',   # Give a short description about your library
  ...
  download_url = 'https://github.com/antoinelarmanjat/codeez/archive/0.5.tar.gz',    # I explain this later on
