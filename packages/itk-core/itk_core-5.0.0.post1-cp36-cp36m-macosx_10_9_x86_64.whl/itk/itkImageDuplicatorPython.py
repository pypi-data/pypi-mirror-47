...
class itkImageDuplicatorICVF22(ITKCommonBasePython.itkObject):
    ...
    https://www.itk.org/Wiki/ITK/Examples/SimpleOperations/ImageDuplicator
    Duplicate an image

    C++ includes: itkImageDuplicator.h 
    """
    ...
    def GetOutput(self, *args) -> "itkImageCVF22 *":
        ...
        match that of other ProcessObjects for this source generation object
        by returning a non-const pointer for the generated Object. 
        """
