...
class itkVectorD1(itkFixedArrayPython.itkFixedArrayD1):
    ...
    https://www.itk.org/Wiki/ITK/Examples/SimpleOperations/CreateVector
    Create a vector

    https://www.itk.org/Wiki/ITK/Examples/Math/DotProduct Dot product
    (inner product) of two vectors

    C++ includes: itkVector.h 
    """
    ...
    def Normalize(self) -> "double":
        ...
        Divides the vector
        components by the vector norm (when the norm is not null). The norm
        used is returned. 
        """
