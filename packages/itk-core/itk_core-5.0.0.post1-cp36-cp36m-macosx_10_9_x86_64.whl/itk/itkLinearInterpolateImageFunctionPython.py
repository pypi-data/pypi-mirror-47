...
class itkLinearInterpolateImageFunctionICVF22D(itkInterpolateImageFunctionPython.itkInterpolateImageFunctionICVF22D):
    ...
    See:  VectorLinearInterpolateImageFunction Wiki Examples:  All
    Examples

    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/LinearInterpolat
    eImageFunction Linearly interpolate a position in an image

    C++ includes: itkLinearInterpolateImageFunction.h 
    """
