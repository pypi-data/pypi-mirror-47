...
class itkImageIOBase(ITKCommonBasePython.itkLightProcessObject):
    ...
    def GetFileTypeAsString(self, arg0: 'itkImageIOBase::FileType') -> "std::string":
        ...
        Convenience
        method returns the FileType as a string. This can be used for writing
        output files. 
        """
    ...
    def GetByteOrderAsString(self, arg0: 'itkImageIOBase::ByteOrder') -> "std::string":
        ...
        Convenience
        method returns the ByteOrder as a string. This can be used for writing
        output files. 
        """
    ...
    def GetComponentSize(self) -> "unsigned int":
        ...
        Compute the size
        (in bytes) of the components of a pixel. For example, and RGB pixel of
        unsigned char would have a component size of 1 byte. This method can
        be invoked only after the component type is set. 
        """
    ...
    def CanStreamWrite(self) -> "bool":
        ...
        There are two types of non exclusive streaming: pasteing subregions,
        and iterative 
        """
    ...
    def SupportsDimension(self, dim: 'unsigned long') -> "bool":
        ...
        The different
        types of ImageIO's can support data of varying dimensionality. For
        example, some file formats are strictly 2D while others can support
        2D, 3D, or even n-D. This method returns true/false as to whether the
        ImageIO can support the dimension indicated. 
        """
    ...
    def GenerateStreamableReadRegionFromRequestedRegion(self, requested: 'itkImageIORegion') -> "itkImageIORegion":
        ...
        IORegion, if the the derived class is unable to read the requested
        region. For example if the file has a size of [ 10, 10, 10] but the
    ...
    def GetActualNumberOfSplitsForWriting(self, numberOfRequestedSplits: 'unsigned int', pasteRegion: 'itkImageIORegion', largestPossibleRegion: 'itkImageIORegion') -> "unsigned int":
        ...
        and is not support or does not work with the file, then an excepetion
        should be thrown.
        ...
        respected. If a derived class has more restictive conditions then they
        should be checked 
        """
...
class itkNumericSeriesFileNames(ITKCommonBasePython.itkObject):
    ...
    https://www.itk.org/Wiki/ITK/Examples/Utilities/NumericSeriesFileNames
    ...
    def SetSeriesFormat(self, *args) -> "void":
        ...
        The format string
        used to generate the series. Different subclasses require different
        characteristics of this string. For example, the subclass
