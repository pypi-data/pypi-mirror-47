...
class itkVectorImageCF2(itkImagePython.itkImageBase2):
    ...
    See:  ImportImageContainer Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/IO/ReadVectorImage Read an image
    file with an unknown number of components

    https://www.itk.org/Wiki/ITK/Examples/VectorImages/VectorImage Create
    a vector image

    https://www.itk.org/Wiki/ITK/Examples/VectorImages/NeighborhoodIterato
    r NeighborhoodIterator on a VectorImage
