...
class itkPointD2(itkFixedArrayPython.itkFixedArrayD2):
    ...
    See:   Matrix Wiki Examples:  All Examples
    ...
    def GetVnlVector(self, *args) -> "vnl_vectorD":
        ...
        Get a vnl_vector with
        a copy of the internal memory block. 
        """
    ...
    def SetToMidPoint(self, arg0: 'itkPointD2', arg1: 'itkPointD2') -> "void":
        ...
        Set to median point
        between the two points given as arguments

        This method computes:

        \\[ \\overrightarrow{P}=\\frac{(\\overrightarrow{A}+\\overri
        ghtarrow{B})}{2} \\]

        using the two Points given as arguments, and store the result in the
        Point on which the method is invoked. 
        """
    ...
    def SetToBarycentricCombination(self, *args) -> "void":
        ...
        Set the
        current point to a barycentric combination of an array of N points An
        array of (N-1) values is expected to weight the contribution of the
        first (N-1) points, the weight of the Nth point is computed to ensure
        that the N weights sum 1.

        This method computes:

        \\[ \\overrightarrow{P}= \\sum_{i=1}^{N-1} w_i *
        \\overrightarrow{P}_i + \\left(1- \\sum_{i=1}^{N-1}
        w_i\\right) * \\overrightarrow{P}_N \\] 
        """
