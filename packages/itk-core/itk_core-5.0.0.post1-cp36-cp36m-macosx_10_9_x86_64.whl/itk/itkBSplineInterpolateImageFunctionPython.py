...
class itkBSplineInterpolateImageFunctionIF2DF(itkInterpolateImageFunctionPython.itkInterpolateImageFunctionIF2D):
    ...
    See:   BSplineDecompositionImageFilter Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/Upsampling
    Upsampling an image

    C++ includes: itkBSplineInterpolateImageFunction.h 
    """
    ...
    def Evaluate(self, *args) -> "double":
        ...
        Returns the B-Spline interpolated image intensity at a specified point
        position. No bounds checking is done. The point is assume to lie
    ...
    def EvaluateAtContinuousIndex(self, *args) -> "double":
        ...
        Returns the interpolated image intensity at a specified index
        position. No bounds checking is done. The point is assume to lie
        within the image buffer.
