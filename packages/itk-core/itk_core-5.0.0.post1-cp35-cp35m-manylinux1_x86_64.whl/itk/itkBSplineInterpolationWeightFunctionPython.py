...
class itkBSplineInterpolationWeightFunctionD22(itkFunctionBasePython.itkFunctionBaseCID2AD):
    ...
    C++ includes: itkBSplineInterpolationWeightFunction.h 
    """
    ...
    def Evaluate(self, *args) -> "void":
        ...
        Evaluate the weights at
        specified ContinuousIndex position. The weights are returned in the
        user specified container. This function assume that weights can hold
        (SplineOrder + 1)^(SpaceDimension) elements. For efficiency, no size
        checking is done. On return, startIndex contains the start index of
        the support region over which the weights are defined. 
        """
