...
class itkOptimizerParametersD(itkArrayPython.itkArrayD):
    ...
    C++ includes: itkOptimizerParameters.h 
    """
    ...
    def MoveDataPointer(self, pointer: 'double *') -> "void":
        ...
        Set a new data
        pointer for the parameter data, pointing it to a different memory
        block. The size of the new memory block must equal the current size,
        in elements of TParametersValueType. This call is passed to the
        assigned OptimizerParametersHelper. WARNING:  Memory must be managed
        by caller after this call. 
        """
    ...
    def SetParametersObject(self, object: 'itkLightObject') -> "void":
        ...
        Set an object
        that holds the parameters. Used by the helper of derived classes that
        use an object other than itkArray to hold parameter data. The helper
        class must check that the object is the correct type. The call is
        passed to the assigned OptimizerParametersHelper. 
        """
    ...
    def SetHelper(self, helper: 'itkOptimizerParametersHelperD') -> "void":
        ...
        Assign a helper.
        OptimizerParameters manages the helper once its been assigned. The
        generic helper, OptimizerParametersHelper, is set in constructor.
        Classes that need a specialized helper should allocate one themselves
        and assign it with this method. 
        """
...
class itkOptimizerParametersHelperD(object):
    ...
    C++ includes: itkOptimizerParametersHelper.h 
    """
    ...
    def MoveDataPointer(self, container: 'itkArrayD', pointer: 'double *') -> "void":
        ...
        pointer for the parameter data, pointing it to a different memory
        block. The size of the new memory block must equal the current size,
        in elements of TValue. This call is passed to the assigned
        OptimizerParametersHelper. WARNING:  Memory must be managed by caller
        after this call. container is the OptimizerParameters object to which
        this helper is assigned. Generally this will be called from the
        OptimizerParameters object to which this helper is assigned. 
        """
    ...
    def SetParametersObject(self, arg0: 'itkArrayD', arg1: 'itkLightObject') -> "void":
        ...
        Set an object
        that holds the parameters. Used by derived classes that use an object
        other than itkArray to hold parameter data. The derived class must
        check that the object is the correct type. Generally this will be
        called from the OptimizerParameters object to which this helper is
        assigned. container is the OptimizerParameters object to which this
        helper is assigned. 
        """
