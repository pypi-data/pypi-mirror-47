...
class itkScalarImageToHistogramGeneratorIF2(ITKCommonBasePython.itkObject):
    ...
    C++ includes: itkScalarImageToHistogramGenerator.h 
    """
    ...
    def SetInput(self, arg0: 'itkImageF2') -> "void":
        ...
        for which the histogram is going to be computed 
        """
    ...
    def GetOutput(self) -> "itkHistogramD const *":
        ...
        WARNING:  This output is only valid after the Compute() method has
        been invoked
    ...
    def SetMarginalScale(self, marginalScale: 'double') -> "void":
        ...
        Set marginal scale
        value to be passed to the histogram generator 
        """
    ...
    def SetHistogramMin(self, minimumValue: 'double') -> "void":
        ...
        Set the minimum
        value from which the bins will be computed. WARNING:  This requires to
        set the automatic computation of the histogram minimum/maximum to Off.

        See:   SetAutoHistogramMinimumMaximum 
        """
    ...
    def SetAutoHistogramMinimumMaximum(self, autoOnOff: 'bool') -> "void":
        ...
        WARNING:  If set to Off, the values must be manually specified with
        SetHistogramMin() and SetHistogramMax().

        See:   SetHistogramMin SetHistogramMax 
        """
