...
class itkSimilarity2DTransformD(itkRigid2DTransformPython.itkRigid2DTransformD):
    ...
    This transform applies a homogenous scale and rigid transform in 2D
    ...
    C++ includes: itkSimilarity2DTransform.h 
    """
    ...
    def CloneInverseTo(self, newinverse: 'itkSimilarity2DTransformD_Pointer &') -> "void":
        ...
        This method creates
        and returns a new Similarity2DTransform object which is the inverse of
        self. 
        """
    ...
    def CloneTo(self, clone: 'itkSimilarity2DTransformD_Pointer &') -> "void":
        ...
        returns a new Similarity2DTransform object which has the same
        parameters. 
        """
    ...
    def SetMatrix(self, *args) -> "void":
        ...
        of a Similarity 2D Transform

        This method sets the 2x2 matrix representing a similarity transform.
        The Matrix is expected to be a valid similarity transform within the
        given tolerance.

        WARNING:  This method will throw an exception if the matrix provided
        as argument is not valid.
