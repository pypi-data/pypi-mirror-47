...
class itkSymmetricSecondRankTensorD2(itkFixedArrayPython.itkFixedArrayD3):
    ...
    C++ includes: itkSymmetricSecondRankTensor.h 
    """
    ...
    def SetIdentity(self) -> "void":
        ...
        Set the tensor to an
        identity tensor. This has 1 in its diagonal elements and zero
        elsewhere. 
        """
    ...
    def ComputeEigenAnalysis(self, eigenValues: 'itkFixedArrayD2', eigenVectors: 'itkMatrixD22') -> "void":
        ...
        Return an
        array containing EigenValues, and a matrix containing Eigen vectors.
    ...
    def PreMultiply(self, m: 'itkMatrixD22') -> "itkMatrixD22":
        ...
        Pre-Multiply by a
        Matrix as ResultingMatrix = Matrix * ThisTensor. 
        """
    ...
    def PostMultiply(self, m: 'itkMatrixD22') -> "itkMatrixD22":
        ...
        Post-Multiply by a
        Matrix as ResultingMatrix = ThisTensor * Matrix. 
        """
