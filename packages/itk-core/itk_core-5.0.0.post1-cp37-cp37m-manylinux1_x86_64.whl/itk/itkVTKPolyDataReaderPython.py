...
class itkVTKPolyDataReaderMD2(itkVTKPolyDataReaderMD2_Superclass):
    ...
    C++ includes: itkVTKPolyDataReader.h 
    """
    ...
    def SetFileName(self, *args) -> "void":
        ...
        Set the resolution
        level to be used for generating cells in the Sphere. High values of
        this parameter will produce sphere with more triangles. Set/Get the
