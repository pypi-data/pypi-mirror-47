...
class itkBoundingBoxUL2FMCULQEMPF2(ITKCommonBasePython.itkObject):
    ...
    def GetCorners(self) -> "itkMapContainerULQEMPF2GQEULULBBT const *":
        """GetCorners(itkBoundingBoxUL2FMCULQEMPF2 self) -> itkMapContainerULQEMPF2GQEULULBBT"""
...
class itkBoundingBoxUL3FMCULQEMPF3(ITKCommonBasePython.itkObject):
    ...
    def GetCorners(self) -> "itkMapContainerULQEMPF3GQEULULBBT const *":
        """GetCorners(itkBoundingBoxUL3FMCULQEMPF3 self) -> itkMapContainerULQEMPF3GQEULULBBT"""
