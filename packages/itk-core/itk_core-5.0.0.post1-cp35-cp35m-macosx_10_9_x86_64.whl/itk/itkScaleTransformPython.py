...
class itkScaleTransformD2(itkMatrixOffsetTransformBasePython.itkMatrixOffsetTransformBaseD22):
    ...
    transform, but with a large difference in performace since the affine
    transform will use a matrix multiplication using a diagonal matrix.

    Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/ScaleTransform
    Scale an image
    ...
    def SetScale(self, scale: 'itkFixedArrayD2') -> "void":
        ...
        coordinaates. For example, in 3D, scale[0] corresponds to X, scale[1]
