...
class itkCovariantVectorD2(itkFixedArrayPython.itkFixedArrayD2):
    ...
    https://www.itk.org/Wiki/ITK/Examples/Math/CovariantVector Create a
    covariant vector

    https://www.itk.org/Wiki/ITK/Examples/Math/CovariantVectorNorm Compute
    the norm of a covariant vector

    C++ includes: itkCovariantVector.h 
    """
    ...
    def Normalize(self) -> "double":
        ...
        Divides the covariant
        vector componets by the norm and return the norm 
        """
