...
class itkMultiTransformD22(itkTransformBasePython.itkTransformD22):
    ...
    C++ includes: itkMultiTransform.h 
    """
    ...
    def AddTransform(self, t: 'itkTransformD22') -> "void":
        ...
        Functionality for sub
        transforms Add transforms to the queue, as stack. Most-recently added
        transform is always at back of queue, index N-1. 
        """
    ...
    def RemoveTransform(self) -> "void":
        ...
        Remove transform
        from the back of the queue, index N-1 
        """
    ...
    def GetNthTransform(self, n: 'unsigned long') -> "itkTransformD22_Pointer const":
        """GetNthTransform(itkMultiTransformD22 self, unsigned long n) -> itkTransformD22_Pointer const"""
        return _itkMultiTransformPython.itkMultiTransformD22_GetNthTransform(self, n)


    def GetNthTransformModifiablePointer(self, n: 'unsigned long const') -> "itkTransformD22 *":
        """
        GetNthTransformModifiablePointer(itkMultiTransformD22 self, unsigned long const n) -> itkTransformD22

        Get the Nth transform. WARNING:  No bounds checking is performed. 
        """
        return _itkMultiTransformPython.itkMultiTransformD22_GetNthTransformModifiablePointer(self, n)


    def GetNthTransformConstPointer(self, n: 'unsigned long const') -> "itkTransformD22 const *":
        """GetNthTransformConstPointer(itkMultiTransformD22 self, unsigned long const n) -> itkTransformD22"""
    ...
    def GetNumberOfTransforms(self) -> "unsigned long":
        """
        GetNumberOfTransforms(itkMultiTransformD22 self) -> unsigned long
    ...
    def GetInverse(self, inverse: 'itkMultiTransformD22') -> "bool":
        ...
        the same order as the forward transforms. 
        """
...
class itkMultiTransformD33(itkTransformBasePython.itkTransformD33):
    ...
    def GetNthTransform(self, n: 'unsigned long') -> "itkTransformD33_Pointer const":
        """GetNthTransform(itkMultiTransformD33 self, unsigned long n) -> itkTransformD33_Pointer const"""
        return _itkMultiTransformPython.itkMultiTransformD33_GetNthTransform(self, n)


    def GetNthTransformModifiablePointer(self, n: 'unsigned long const') -> "itkTransformD33 *":
        """
        GetNthTransformModifiablePointer(itkMultiTransformD33 self, unsigned long const n) -> itkTransformD33
    ...
    def GetNthTransformConstPointer(self, n: 'unsigned long const') -> "itkTransformD33 const *":
        """GetNthTransformConstPointer(itkMultiTransformD33 self, unsigned long const n) -> itkTransformD33"""
    ...
    def GetNumberOfTransforms(self) -> "unsigned long":
        """
        GetNumberOfTransforms(itkMultiTransformD33 self) -> unsigned long
