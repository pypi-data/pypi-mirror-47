...
class itkEuler3DTransformD(itkRigid3DTransformPython.itkRigid3DTransformD):
    ...
    C++ includes: itkEuler3DTransform.h 
    """
    ...
    def SetComputeZYX(self, flag: 'bool const') -> "void":
        ...
        The Euler angle
        representation of a rotation is not unique and depends on the order of
        rotations. In general there are 12 options. This class supports two of
        them, ZXY and ZYX. The default is ZXY. These functions set and get the
        value which indicates whether the rotation is ZYX or ZXY. 
        """
