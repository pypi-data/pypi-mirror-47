...
class itkScalarImageToRunLengthMatrixFilterIF2(ITKCommonBasePython.itkProcessObject):
    ...
    and a mask image if provided. Run length matrces are used for image
    texture description.
    ...
    def SetOffsets(self, _arg: 'itkVectorContainerUCO2') -> "void":
        ...
        in the OffsetVector, the rightmost non-zero offset element must be
        positive. For example, in the offset list of a 2D image, (1, 0) means
        the offset along x-axis. (1, 0) has to be set instead of (-1, 0). This
        is required from the iterating order of pixel iterator. 
        """
    ...
    def SetOffset(self, offset: 'itkOffset2') -> "void":
        ...
        rightmost non-zero offset element must be positive. For example, in
        the offset list of a 2D image, (1, 0) means the offset along x-axis.
        (1, 0) has to be set instead of (-1, 0). This is required from the
        iterating order of pixel iterator. 
        """
