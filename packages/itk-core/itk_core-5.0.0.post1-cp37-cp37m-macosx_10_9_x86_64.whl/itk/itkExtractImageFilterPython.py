...
class itkExtractImageFilterICF2ICF2(itkInPlaceImageFilterBPython.itkInPlaceImageFilterICF2ICF2):
    ...
    See:  CropImageFilter Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/ExtractImageFilt
    er Crop an image by specifying the region to keep
