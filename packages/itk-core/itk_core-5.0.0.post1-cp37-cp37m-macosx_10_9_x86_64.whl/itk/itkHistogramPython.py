...
class itkHistogramD(itkSamplePython.itkSampleAD):
    ...
    VariableDimensionHistogram Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/Statistics/Histogram Compute a
    histogram from measurements.
    ...
    def Quantile(self, dimension: 'unsigned int', p: 'double') -> "double":
        ...
        the dimension of the bin, interval = max - min , pp = cumlated
