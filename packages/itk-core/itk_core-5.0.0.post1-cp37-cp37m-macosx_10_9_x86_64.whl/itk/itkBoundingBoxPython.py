...
class itkBoundingBoxUL2DMCULPD2(ITKCommonBasePython.itkObject):
    ...
    https://www.itk.org/Wiki/ITK/Examples/Utilities/BoundingBox Bounding
    box
    ...
    def GetCorners(self) -> "itkMapContainerULPD2 const *":
        """GetCorners(itkBoundingBoxUL2DMCULPD2 self) -> itkMapContainerULPD2"""
    ...
    def GetBounds(self) -> "itkFixedArrayD4 const &":
        ...
        methods in this class invoke ComputeBoundingBox() internally, for
        example GetMinimum(), GetMaximum(), GetCenter(), GetDiagonalLength2().
...
class itkBoundingBoxUL2DVCULPD2(ITKCommonBasePython.itkObject):
    ...
    def GetCorners(self) -> "itkVectorContainerULPD2 const *":
        """GetCorners(itkBoundingBoxUL2DVCULPD2 self) -> itkVectorContainerULPD2"""
...
class itkBoundingBoxUL2FMCULPF2(ITKCommonBasePython.itkObject):
    ...
    def GetCorners(self) -> "itkMapContainerULPF2 const *":
        """GetCorners(itkBoundingBoxUL2FMCULPF2 self) -> itkMapContainerULPF2"""
        return _itkBoundingBoxPython.itkBoundingBoxUL2FMCULPF2_GetCorners(self)
...
itkBoundingBoxUL2FMCULPF2.GetCorners = new_instancemethod(_itkBoundingBoxPython.itkBoundingBoxUL2FMCULPF2_GetCorners, None, itkBoundingBoxUL2FMCULPF2)
...
class itkBoundingBoxUL2FVCULPF2(ITKCommonBasePython.itkObject):
    ...
    def GetCorners(self) -> "itkVectorContainerULPF2 const *":
        """GetCorners(itkBoundingBoxUL2FVCULPF2 self) -> itkVectorContainerULPF2"""
        return _itkBoundingBoxPython.itkBoundingBoxUL2FVCULPF2_GetCorners(self)
...
itkBoundingBoxUL2FVCULPF2.GetCorners = new_instancemethod(_itkBoundingBoxPython.itkBoundingBoxUL2FVCULPF2_GetCorners, None, itkBoundingBoxUL2FVCULPF2)
...
class itkBoundingBoxUL3DMCULPD3(ITKCommonBasePython.itkObject):
    ...
    def GetCorners(self) -> "itkMapContainerULPD3 const *":
        """GetCorners(itkBoundingBoxUL3DMCULPD3 self) -> itkMapContainerULPD3"""
...
class itkBoundingBoxUL3DVCULPD3(ITKCommonBasePython.itkObject):
    ...
    def GetCorners(self) -> "itkVectorContainerULPD3 const *":
        """GetCorners(itkBoundingBoxUL3DVCULPD3 self) -> itkVectorContainerULPD3"""
...
class itkBoundingBoxUL3FMCULPF3(ITKCommonBasePython.itkObject):
    ...
    def GetCorners(self) -> "itkMapContainerULPF3 const *":
        """GetCorners(itkBoundingBoxUL3FMCULPF3 self) -> itkMapContainerULPF3"""
        return _itkBoundingBoxPython.itkBoundingBoxUL3FMCULPF3_GetCorners(self)
...
itkBoundingBoxUL3FMCULPF3.GetCorners = new_instancemethod(_itkBoundingBoxPython.itkBoundingBoxUL3FMCULPF3_GetCorners, None, itkBoundingBoxUL3FMCULPF3)
...
class itkBoundingBoxUL3FVCULPF3(ITKCommonBasePython.itkObject):
    ...
    def GetCorners(self) -> "itkVectorContainerULPF3 const *":
        """GetCorners(itkBoundingBoxUL3FVCULPF3 self) -> itkVectorContainerULPF3"""
        return _itkBoundingBoxPython.itkBoundingBoxUL3FVCULPF3_GetCorners(self)
...
itkBoundingBoxUL3FVCULPF3.GetCorners = new_instancemethod(_itkBoundingBoxPython.itkBoundingBoxUL3FVCULPF3_GetCorners, None, itkBoundingBoxUL3FVCULPF3)
