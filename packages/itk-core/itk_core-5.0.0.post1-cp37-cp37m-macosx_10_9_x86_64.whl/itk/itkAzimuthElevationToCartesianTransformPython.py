...
class itkAzimuthElevationToCartesianTransformD2(itkAffineTransformPython.itkAffineTransformD2):
    ...
    coordinates to cartesian coordinates are as follows: z =
    std::sqrt((r^2*(cos(azimuth))^2)/(1 + (cos(azimuth))^2 *
    (tan(elevation))^2); x = z * std::tan(azimuth) y = z *
    std::tan(elevation)

    The reversed transforms are: azimuth = arctan(x/y) elevation =
    arctan(y/z) r = std::sqrt(x^2 + y^2 + z^2)
    ...
    Todo Derive this class from a yet undefined TransformBase class.
    Currently, this class derives from AffineTransform, although it is not
    an affine transform.
    ...
    https://www.itk.org/Wiki/ITK/Examples/Utilities/AzimuthElevationToCart
    esianTransform Cartesian to AzimuthElevation and vice-versa

    C++ includes: itkAzimuthElevationToCartesianTransform.h 
    """
    ...
    def TransformAzElToCartesian(self, point: 'itkPointD2') -> "itkPointD2":
        ...
        Perform
        conversion from Azimuth Elevation coordinates to Cartesian
        Coordinates. 
        """
    ...
    def TransformCartesianToAzEl(self, point: 'itkPointD2') -> "itkPointD2":
        ...
        Perform
        conversion from Cartesian Coordinates to Azimuth Elevation
        coordinates. 
        """
    ...
    def SetMaxAzimuth(self, _arg: 'long const') -> "void":
        ...
        Set the maximum
        azimuth. The maximum azimuth and elevation can be set so that the
        resulting cartesian space is symmetric about the z axis. Therefore,
        the line defined by azimuth/2,elevation/2 = z-axis. 
        """
    ...
    def SetMaxElevation(self, _arg: 'long const') -> "void":
        ...
        Set the maximum
        elevation The maximum azimuth and elevation can be set so that the
        resulting cartesian space is symmetric about the z axis. Therefore,
        the line defined by azimuth/2,elevation/2 = z-axis. 
        """
    ...
    def SetRadiusSampleSize(self, _arg: 'double const') -> "void":
        ...
        Set the number
        of cartesian units between each unit along the R . 
        """
    ...
    def SetAzimuthAngularSeparation(self, _arg: 'double const') -> "void":
        ...
        Set the
        number of degrees between each azimuth unit. 
        """
    ...
    def SetElevationAngularSeparation(self, _arg: 'double const') -> "void":
        ...
        Set
        the number of degrees between each elevation unit. 
        """
