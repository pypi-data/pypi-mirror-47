...
long_description = ('Pika is a pure-Python implementation of the AMQP 0-9-1 '
                    ...
                    'with other AMQP 0-9-1 brokers. This package has added '
                    'support for Greenlet friendly pika adapter.')

setup(name='gevent_pika',
      version='0.2',
      description='Pika Python AMQP Client Library With Gevent Adapter Support',
