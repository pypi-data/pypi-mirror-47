...
class VaultSecret:
    ...
    def setkeyfromstring(self, key, value):
        """Sets `key` to the given string `value`."""
        self.data[key] = b64encode(value)

    def flush(self, codebase):
        self.repository.vault.persist(codebase)
