...
class Argument:
    ...
    def parsestring(value):
        """Parse a string with values."""
        return str.join(' ', value) if value else None

    def __init__(self, *args, **kwargs):
        self.args = args
        self.kwargs = kwargs
        self.kwargs.update(self.defaults or {})
...
class PartOf(Argument):
    default = {
        'help': "specifies the app.kubernetes.io/part-of label."
    }
...
class DisplayName(Argument):
    defaults = {
        'help': "specifies a human-readable name.",
        'nargs': '+'
    }
