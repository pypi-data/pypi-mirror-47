...
class QSystem(object):
    ...
    def __init__(self, nqbits, seed=42, state="vector", init=0):
        _qsystem.QSystem_swiginit(self, _qsystem.new_QSystem(nqbits, seed, state, init))
    ...
    def r(self, axis, angle, qbit, count=1):
        return _qsystem.QSystem_r(self, axis, angle, qbit, count)
    ...
    def apply(self, gate, qbit, count=1, inver=False):
        return _qsystem.QSystem_apply(self, gate, qbit, count, inver)
    ...
    def add_ancillas(self, nqbits, init=0):
        return _qsystem.QSystem_add_ancillas(self, nqbits, init)
...
class Gate(object):
    ...
    @staticmethod
    def make_gate(matrix):
        return _qsystem.Gate_make_gate(matrix)

    @staticmethod
    def make_mgate(size, row, col, value):
        return _qsystem.Gate_make_mgate(size, row, col, value)

    @staticmethod
    def make_cgate(gates, control):
        return _qsystem.Gate_make_cgate(gates, control)

    @staticmethod
    def make_fgate(*args):
        return _qsystem.Gate_make_fgate(*args)
...
def Gate_make_gate(matrix):
    return _qsystem.Gate_make_gate(matrix)

def Gate_make_mgate(size, row, col, value):
    return _qsystem.Gate_make_mgate(size, row, col, value)

def Gate_make_cgate(gates, control):
    return _qsystem.Gate_make_cgate(gates, control)

def Gate_make_fgate(*args):
    return _qsystem.Gate_make_fgate(*args)
