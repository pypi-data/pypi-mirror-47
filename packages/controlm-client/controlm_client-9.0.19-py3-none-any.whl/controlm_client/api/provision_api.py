...
class ProvisionApi(object):
    ...
    def get_all_upgrade_activities_status_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['ctm', 'agent', 'from_version', 'to_version', 'activity', 'status', 'activity_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def transfer_and_install_product(self, upgrade_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.transfer_and_install_product_with_http_info(upgrade_request, **kwargs)  # noqa: E501
            return data
    ...
    def transfer_and_install_product_with_http_info(self, upgrade_request, **kwargs):  # noqa: E501
        ...
        if ('upgrade_request' not in params or
                params['upgrade_request'] is None):
            raise ValueError("Missing the required parameter `upgrade_request` when calling `transfer_and_install_product`")  # noqa: E501
    ...
    def uninstall_product(self, rollback_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.uninstall_product_with_http_info(rollback_request, **kwargs)  # noqa: E501
            return data
    ...
    def uninstall_product_with_http_info(self, rollback_request, **kwargs):  # noqa: E501
        ...
        if ('rollback_request' not in params or
                params['rollback_request'] is None):
            raise ValueError("Missing the required parameter `rollback_request` when calling `uninstall_product`")  # noqa: E501
