...
def create(engine, timeflow_bookmark_create_parameters):
    ...
    :type timeflow_bookmark_create_parameters:
        :py:class:`v1_3_2.web.vo.TimeflowBookmarkCreateParameters`
    :rtype: ``TEXT_TYPE``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_2.web.objects.TimeflowBookmark.TimeflowBookma
        rk` object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_2.web.vo.TimeflowBookmark`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine, database=None):
    ...
    :rtype: ``list`` of :py:class:`v1_3_2.web.vo.TimeflowBookmark`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/timeflow/bookmark"
