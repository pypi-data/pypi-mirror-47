...
class OracleProvisionParameters(ProvisionParameters):
    """
    *(extends* :py:class:`v1_3_2.web.vo.ProvisionParameters` *)* The parameters
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_3_2.web.vo.OracleDBConfig`
        """
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_3_2.web.vo.OracleDatabaseContainer`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_3_2.web.vo.OracleVirtualSource`
        """
