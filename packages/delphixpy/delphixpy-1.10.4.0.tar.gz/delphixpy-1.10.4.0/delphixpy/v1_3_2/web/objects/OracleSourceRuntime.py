...
class OracleSourceRuntime(SourceRuntime):
    """
    *(extends* :py:class:`v1_3_2.web.vo.SourceRuntime` *)* Runtime (non-
    ...
    def database_stats(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_3_2.web.vo.OracleDatabaseStatsSection`
        """
    ...
    def active_instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_3_2.web.vo.OracleActiveInstance`
        """
