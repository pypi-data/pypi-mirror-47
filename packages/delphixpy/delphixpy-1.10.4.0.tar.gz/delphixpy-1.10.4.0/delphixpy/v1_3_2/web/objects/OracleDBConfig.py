...
class OracleDBConfig(SourceConfig):
    """
    *(extends* :py:class:`v1_3_2.web.vo.SourceConfig` *)* The source config
    ...
    def non_sys_credentials(self):
        ...
        :rtype: :py:class:`v1_3_2.web.vo.Credential`
        """
    ...
    def services(self):
        ...
        :rtype: ``list`` of :py:class:`v1_3_2.web.vo.OracleService`
        """
