...
def create(engine, dvc_application_template_create_parameters):
    ...
    :type dvc_application_template_create_parameters:
        :py:class:`v1_3_2.web.vo.DVCApplicationTemplateCreateParameters`
    :rtype: ``TEXT_TYPE``
    """
...
def get(engine, ref):
    ...
    :type ref: ``str``
    :rtype: :py:class:`v1_3_2.web.vo.DVCApplicationTemplate`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_3_2.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_3_2.web.vo.DVCApplicationTemplate`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/dvc/template"
    response = engine.get(url)
...
def update(engine, ref, dvc_application_template=None):
    ...
    :type dvc_application_template:
        :py:class:`v1_3_2.web.vo.DVCApplicationTemplate`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/dvc/template/%s" % ref
