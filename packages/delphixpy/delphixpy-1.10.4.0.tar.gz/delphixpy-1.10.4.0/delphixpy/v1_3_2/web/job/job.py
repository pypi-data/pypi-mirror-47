...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.v1_3_2.web.objects.Job.Job`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_2.web.vo.Job`
    """
...
def get_all(engine, to_date=None, page_offset=None, job_state=None, target=None, page_size=None, add_events=None, from_date=None):
    ...
    :rtype: ``list`` of :py:class:`v1_3_2.web.vo.Job`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def update(engine, ref, job=None):
    ...
    :type job: :py:class:`v1_3_2.web.vo.Job`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/job/%s" % ref
