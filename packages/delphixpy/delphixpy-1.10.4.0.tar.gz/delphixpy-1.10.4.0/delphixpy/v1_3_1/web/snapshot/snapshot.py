...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_1.web.objects.TimeflowSnapshot.TimeflowSnapsh
        ot` object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_1.web.vo.TimeflowSnapshot`
    """
...
def get_all(engine, to_date=None, page_size=None, database=None, timeflow=None, from_date=None, traverse_timeflows=None):
    ...
    :rtype: ``list`` of :py:class:`v1_3_1.web.vo.TimeflowSnapshot`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def update(engine, ref, timeflow_snapshot=None):
    ...
    :type timeflow_snapshot: :py:class:`v1_3_1.web.vo.TimeflowSnapshot`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/snapshot/%s" % ref
...
def space(engine, snapshot_space_parameters):
    ...
    :type snapshot_space_parameters:
        :py:class:`v1_3_1.web.vo.SnapshotSpaceParameters`
    :rtype: :py:class:`v1_3_1.web.vo.SnapshotSpaceResult`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
