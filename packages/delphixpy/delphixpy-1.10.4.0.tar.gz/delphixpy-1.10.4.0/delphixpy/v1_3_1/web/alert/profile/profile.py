...
def create(engine, alert_profile=None):
    ...
    :type alert_profile: :py:class:`v1_3_1.web.vo.AlertProfile`
    :rtype: ``TEXT_TYPE``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_1.web.objects.AlertProfile.AlertProfile`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_1.web.vo.AlertProfile`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_3_1.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_3_1.web.vo.AlertProfile`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/alert/profile"
    response = engine.get(url)
