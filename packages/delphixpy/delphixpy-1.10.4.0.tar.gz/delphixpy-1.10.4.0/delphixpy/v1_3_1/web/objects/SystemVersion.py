...
class SystemVersion(NamedUserObject):
    """
    *(extends* :py:class:`v1_3_1.web.vo.NamedUserObject` *)* Describes a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._reboot_needed[0] is not None and obj._reboot_needed[0] is not obj.__undef__:
            assert isinstance(obj._reboot_needed[0], bool), ("Expected one of [u'boolean'], but got %s of type %s" % (obj._reboot_needed[0], type(obj._reboot_needed[0])))
