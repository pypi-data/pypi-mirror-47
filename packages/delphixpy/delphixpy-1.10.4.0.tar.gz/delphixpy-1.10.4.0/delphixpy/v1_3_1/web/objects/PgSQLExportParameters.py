...
class PgSQLExportParameters(DbExportParameters):
    """
    *(extends* :py:class:`v1_3_1.web.vo.DbExportParameters` *)* The parameters
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_3_1.web.vo.PgSQLDBClusterConfig`
        """
    ...
    def ident_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_3_1.web.vo.PgSQLIdentEntry`
        """
    ...
    def hba_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_3_1.web.vo.PgSQLHBAEntry`
        """
    ...
    def filesystem_layout(self):
        ...
        :rtype: :py:class:`v1_3_1.web.vo.TimeflowFilesystemLayout`
        """
