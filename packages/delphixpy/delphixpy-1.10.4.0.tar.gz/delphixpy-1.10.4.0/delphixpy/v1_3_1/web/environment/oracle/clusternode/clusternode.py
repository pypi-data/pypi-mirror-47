...
def create(engine, oracle_cluster_node_create_parameters):
    ...
    :type oracle_cluster_node_create_parameters:
        :py:class:`v1_3_1.web.vo.OracleClusterNodeCreateParameters`
    :rtype: ``TEXT_TYPE``
    """
...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_3_1.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_3_1.web.objects.OracleCl
        usterNode.OracleClusterNode` object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_1.web.vo.OracleClusterNode`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine, cluster=None):
    ...
    :rtype: ``list`` of :py:class:`v1_3_1.web.vo.OracleClusterNode`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/environment/oracle/clusternode"
...
def update(engine, ref, oracle_cluster_node=None):
    ...
    :type oracle_cluster_node: :py:class:`v1_3_1.web.vo.OracleClusterNode`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/environment/oracle/clusternode/%s" % ref
