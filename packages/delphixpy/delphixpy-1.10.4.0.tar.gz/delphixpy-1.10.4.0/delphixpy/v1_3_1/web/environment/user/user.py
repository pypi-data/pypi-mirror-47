...
def create(engine, environment_user=None):
    ...
    :type environment_user: :py:class:`v1_3_1.web.vo.EnvironmentUser`
    :rtype: ``TEXT_TYPE``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_1.web.objects.EnvironmentUser.EnvironmentUser
        ` object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_1.web.vo.EnvironmentUser`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine, environment=None):
    ...
    :rtype: ``list`` of :py:class:`v1_3_1.web.vo.EnvironmentUser`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/environment/user"
