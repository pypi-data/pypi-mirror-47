...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_1.web.objects.DVCDataSource.DVCDataSource`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_1.web.vo.DVCDataSource`
    """
...
def get_all(engine, application=None, container=None):
    ...
    :rtype: ``list`` of :py:class:`v1_3_1.web.vo.DVCDataSource`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def update(engine, ref, dvc_data_source=None):
    ...
    :type dvc_data_source: :py:class:`v1_3_1.web.vo.DVCDataSource`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/dvc/datasource/%s" % ref
...
def data_timestamps(engine, dvc_source_data_timestamp_parameters):
    ...
    :type dvc_source_data_timestamp_parameters:
        :py:class:`v1_3_1.web.vo.DVCSourceDataTimestampParameters`
    :rtype: ``list`` of :py:class:`v1_3_1.web.vo.DVCSourceDataTimestamp`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
