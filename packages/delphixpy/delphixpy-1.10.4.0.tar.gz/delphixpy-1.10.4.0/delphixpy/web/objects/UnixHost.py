...
class UnixHost(Host):
    ...
    *(extends* :py:class:`delphixpy.web.vo.Host` *)* The representation of a
    ...
    def is_dirty(self):
        return any([self._toolkit_path[1], self._ssh_verification_strategy[1], self._oracle_jdbc_keystore_password[1]])
    ...
    def __eq__(self, other):
        ...
        return super(UnixHost, self).__eq__(other) and \
               ...
               self.oracle_jdbc_keystore_password == other.oracle_jdbc_keystore_password
