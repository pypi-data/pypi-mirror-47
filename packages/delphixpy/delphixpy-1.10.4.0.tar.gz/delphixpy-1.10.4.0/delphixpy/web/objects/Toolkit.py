...
class Toolkit(NamedUserObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* An installed
    ...
    def is_dirty(self):
        return any([self._discovery_definition[1], self._pretty_name[1], self._name[1], self._language[1], self._root_squash_enabled[1], self._build_api[1], self._virtual_source_definition[1], self._messages[1], self._host_types[1], self._version[1], self._entry_point[1], self._upgrade_definition[1], self._default_locale[1], self._linked_source_definition[1], self._snapshot_schema[1], self._source_code[1], self._resources[1]])
