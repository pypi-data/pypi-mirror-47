    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Objects that map
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._container_type[0] is not None and obj._container_type[0] is not obj.__undef__:
            ...
            assert obj._container_type[0] in [u'APPDATA_CONTAINER', u'ASE_DB_CONTAINER', u'ORACLE_DB_CONTAINER', u'MSSQL_DB_CONTAINER', u'VMWARE_CONTAINER'], "Expected enum [u'APPDATA_CONTAINER', u'ASE_DB_CONTAINER', u'ORACLE_DB_CONTAINER', u'MSSQL_DB_CONTAINER', u'VMWARE_CONTAINER'] but got %s" % obj._container_type[0]
