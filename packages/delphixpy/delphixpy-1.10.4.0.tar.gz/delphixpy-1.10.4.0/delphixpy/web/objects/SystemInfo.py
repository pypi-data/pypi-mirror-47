...
class SystemInfo(PublicSystemInfo):
    ...
    *(extends* :py:class:`delphixpy.web.vo.PublicSystemInfo` *)* Retrieve
    ...
    def is_dirty(self):
        return any([self._memory_reservation[1], self._up_time[1], self._hostname[1], self._uuid[1], self._storage_total[1], self._ssh_public_key[1], self._installation_time[1], self._memory_size[1], self._platform[1], self._storage_used[1], self._cpu_reservation[1], self._hotfixes[1], self._processors[1]])
