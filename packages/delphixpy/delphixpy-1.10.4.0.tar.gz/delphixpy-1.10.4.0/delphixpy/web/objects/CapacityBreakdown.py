...
class CapacityBreakdown(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Storage stats
    ...
    def is_dirty(self):
        return any([self._manual_space[1], self._unvirtualized_space[1], self._policy_space[1], self._active_space[1], self._log_space[1], self._unowned_snapshot_space[1], self._timeflow_unvirtualized_space[1], self._sync_space[1], self._descendant_space[1], self._ingested_size[1], self._fallback_ingested_size_timestamp[1], self._actual_space[1]])
