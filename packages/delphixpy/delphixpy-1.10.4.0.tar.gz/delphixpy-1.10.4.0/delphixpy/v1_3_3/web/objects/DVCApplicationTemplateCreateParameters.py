...
class DVCApplicationTemplateCreateParameters(DVCApplicationCreateParameters):
    """
    *(extends* :py:class:`v1_3_3.web.vo.DVCApplicationCreateParameters` *)* The
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(DVCApplicationTemplateCreateParameters, self).to_dict(dirty, belongs_to_parent)
