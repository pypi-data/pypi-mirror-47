...
class DVCApplicationCreateParameters(TypedObject):
    """
    *(extends* :py:class:`v1_3_3.web.vo.TypedObject` *)* The parameters used to
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(DVCApplicationCreateParameters, self).to_dict(dirty, belongs_to_parent)
    ...
    def data_sources(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_3_3.web.vo.DVCDataSourceCreateParameters`
        """
