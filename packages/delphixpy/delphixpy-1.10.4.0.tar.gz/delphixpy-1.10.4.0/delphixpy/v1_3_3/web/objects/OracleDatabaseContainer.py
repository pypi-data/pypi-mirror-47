...
class OracleDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_3_3.web.vo.DatabaseContainer` *)* Data container
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_3_3.web.vo.OracleSourcingPolicy`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_3_3.web.vo.OracleDBContainerRuntime`
        """
