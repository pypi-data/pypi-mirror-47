...
class DatapointSet(TypedObject):
    """
    *(extends* :py:class:`v1_3_3.web.vo.TypedObject` *)* A set of datapoints
    ...
    def datapoint_streams(self):
        ...
        :rtype: ``list`` of :py:class:`v1_3_3.web.vo.DatapointStream`
        """
    ...
    def collection_events(self):
        ...
        :rtype: ``list`` of :py:class:`v1_3_3.web.vo.StatisticSliceEvent`
        """
