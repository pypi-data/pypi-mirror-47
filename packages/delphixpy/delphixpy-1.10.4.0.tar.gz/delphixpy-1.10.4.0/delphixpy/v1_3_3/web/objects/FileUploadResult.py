...
class FileUploadResult(TypedObject):
    """
    *(extends* :py:class:`v1_3_3.web.vo.TypedObject` *)* Result of a file
    upload request.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._post_url[0] is not None and obj._post_url[0] is not obj.__undef__:
            assert isinstance(obj._post_url[0], TEXT_TYPE), ("Expected one of [u'string'], but got %s of type %s" % (obj._post_url[0], type(obj._post_url[0])))
