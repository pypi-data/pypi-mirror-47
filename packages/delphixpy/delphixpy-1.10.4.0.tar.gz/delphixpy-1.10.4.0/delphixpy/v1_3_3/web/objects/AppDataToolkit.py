...
class AppDataToolkit(NamedUserObject):
    """
    *(extends* :py:class:`v1_3_3.web.vo.NamedUserObject` *)* An installed
    AppData toolkit.
    """
    ...
    def stop(self):
        ...
        :rtype: ``list`` of :py:class:`v1_3_3.web.vo.Operation`
        """
        return self._stop[0]
    ...
    def provision_parameters(self):
        ...
        :rtype: ``list`` of :py:class:`v1_3_3.web.vo.AppDataParameter`
        """
