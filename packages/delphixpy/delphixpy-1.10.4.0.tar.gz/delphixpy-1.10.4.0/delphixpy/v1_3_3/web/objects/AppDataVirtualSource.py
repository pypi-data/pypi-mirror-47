...
class AppDataVirtualSource(AppDataSource):
    """
    *(extends* :py:class:`v1_3_3.web.vo.AppDataSource` *)* A virtual AppData
    source
    """
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_3_3.web.vo.VirtualSourceOperations`
        """
    ...
    def additional_mount_points(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_3_3.web.vo.AppDataAdditionalMountPoint`
        """
    ...
    def parameters(self):
        ...
        :rtype: ``list`` of :py:class:`v1_3_3.web.vo.DynamicParameterValue`
        """
