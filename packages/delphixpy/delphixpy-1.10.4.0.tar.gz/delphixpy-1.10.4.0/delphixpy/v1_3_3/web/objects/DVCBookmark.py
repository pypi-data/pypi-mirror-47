...
class DVCBookmark(NamedUserObject):
    """
    *(extends* :py:class:`v1_3_3.web.vo.NamedUserObject` *)* A named entity
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(DVCBookmark, self).to_dict(dirty, belongs_to_parent)
    ...
    def tags(self):
        ...
        :rtype: ``list`` of :py:class:`v1_3_3.web.vo.DVCBookmarkTag`
        """
        return self._tags[0]
