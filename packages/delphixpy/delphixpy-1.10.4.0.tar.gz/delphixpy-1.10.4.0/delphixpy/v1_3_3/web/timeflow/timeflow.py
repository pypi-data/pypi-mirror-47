...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_3.web.objects.Timeflow.Timeflow` object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_3.web.vo.Timeflow`
    """
...
def get_all(engine, database=None):
    ...
    :rtype: ``list`` of :py:class:`v1_3_3.web.vo.Timeflow`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def repair(engine, ref, timeflow_repair_parameters=None):
    ...
    :type timeflow_repair_parameters:
        :py:class:`v1_3_3.web.vo.TimeflowRepairParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def timeflow_ranges(engine, ref, timeflow_range_parameters=None):
    ...
    :type timeflow_range_parameters:
        :py:class:`v1_3_3.web.vo.TimeflowRangeParameters`
    :rtype: ``list`` of :py:class:`v1_3_3.web.vo.TimeflowRange`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
