...
def create(engine, oracle_listener=None):
    ...
    :type oracle_listener: :py:class:`v1_3_3.web.vo.OracleListener`
    :rtype: ``TEXT_TYPE``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_3.web.objects.OracleListener.OracleListener`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_3.web.vo.OracleListener`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine, environment=None, type=None):
    ...
    :type type: ``TEXT_TYPE``
    :rtype: ``list`` of :py:class:`v1_3_3.web.vo.OracleListener`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/environment/oracle/listener"
