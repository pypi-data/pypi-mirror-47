...
def create(engine, dvc_bookmark_create_parameters):
    ...
    :type dvc_bookmark_create_parameters:
        :py:class:`v1_3_3.web.vo.DVCBookmarkCreateParameters`
    :rtype: ``TEXT_TYPE``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_3.web.objects.DVCBookmark.DVCBookmark` object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_3.web.vo.DVCBookmark`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine, container=None, template=None):
    ...
    :rtype: ``list`` of :py:class:`v1_3_3.web.vo.DVCBookmark`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/dvc/bookmark"
...
def update(engine, ref, dvc_bookmark=None):
    ...
    :type dvc_bookmark: :py:class:`v1_3_3.web.vo.DVCBookmark`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/dvc/bookmark/%s" % ref
