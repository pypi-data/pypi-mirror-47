...
def create(engine, dvc_branch=None):
    ...
    :type dvc_branch: :py:class:`v1_3_3.web.vo.DVCBranch`
    :rtype: ``TEXT_TYPE``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_3.web.objects.DVCBranch.DVCBranch` object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_3.web.vo.DVCBranch`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine, application=None, parent_bookmark=None):
    ...
    :rtype: ``list`` of :py:class:`v1_3_3.web.vo.DVCBranch`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/dvc/branch"
...
def update(engine, ref, dvc_branch=None):
    """
    Update the specified DVCBranch object.
