...
def create(engine, replication_spec=None):
    ...
    :type replication_spec: :py:class:`v1_3_0.web.vo.ReplicationSpec`
    :rtype: ``TEXT_TYPE``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_0.web.objects.ReplicationSpec.ReplicationSpec
        ` object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_0.web.vo.ReplicationSpec`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_3_0.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_3_0.web.vo.ReplicationSpec`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/replication/spec"
    response = engine.get(url)
