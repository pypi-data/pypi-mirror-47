...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_0.web.objects.AuditEvent.AuditEvent` object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_0.web.vo.AuditEvent`
    """
...
def get_all(engine, to_date=None, page_offset=None, from_date=None, page_size=None):
    ...
    :type page_size: ``int``
    :rtype: ``list`` of :py:class:`v1_3_0.web.vo.AuditEvent`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
