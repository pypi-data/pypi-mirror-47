...
def create(engine, source_repository=None):
    ...
    :type source_repository: :py:class:`v1_3_0.web.vo.SourceRepository`
    :rtype: ``TEXT_TYPE``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_0.web.objects.SourceRepository.SourceReposito
        ry` object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_0.web.vo.SourceRepository`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def compatible_repositories(engine, compatible_repositories_parameters):
    ...
    :type compatible_repositories_parameters:
        :py:class:`v1_3_0.web.vo.CompatibleRepositoriesParameters`
    :rtype: :py:class:`v1_3_0.web.vo.CompatibleRepositoriesResult`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
