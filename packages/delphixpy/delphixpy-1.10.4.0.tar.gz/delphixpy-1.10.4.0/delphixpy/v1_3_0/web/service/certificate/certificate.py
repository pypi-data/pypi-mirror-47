...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_3_0.web.objects.X509Certificate.X509Certificate
        ` object
    :type ref: ``str``
    :rtype: :py:class:`v1_3_0.web.vo.X509Certificate`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_3_0.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_3_0.web.vo.X509Certificate`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def fetch(engine, certificate_fetch_parameters=None):
    ...
    :type certificate_fetch_parameters:
        :py:class:`v1_3_0.web.vo.CertificateFetchParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
