...
class ServiceBase(object):
    ...
    def handle_task(self, task):
        ...
        self.task = task
        self.task_hash = hashlib.md5((str(task.sid + task.sha256).encode('utf-8'))).hexdigest()
    ...
    def working_directory(self):
        al_temp_dir = os.path.join(tempfile.gettempdir(), self.service_name().lower(), 'completed', self.task_hash)
