...
class MockAssemblylineAlService(ModuleType):
    def __init__(self):
        ...
        import alv3_service.common.base
        self.base = alv3_service.common.base
...
class MockAssemblylineAlCommon(ModuleType):
    def __init__(self):
        ...
        import alv3_service.common.result
        self.result = alv3_service.common.result
        self.result.__name__ = 'assemblyline.al.common.result'

        import alv3_service.common.mock_forge
        self.forge = alv3_service.common.mock_forge
...
class MockAssemblylineCommon(ModuleType):
    def __init__(self):
        ...
        from alv3_service.common import mock_forge
...
class MockAssemblyline2AlCommon(ModuleType):
    def __init__(self):
        ...
        from alv3_service.common import heuristics
