...
from isi_sdk_8_2_0.configuration import Configuration
import isi_sdk_8_2_0.models
from isi_sdk_8_2_0 import rest
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'Swagger-Codegen/0.2.6/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(isi_sdk_8_2_0.models, klass)
