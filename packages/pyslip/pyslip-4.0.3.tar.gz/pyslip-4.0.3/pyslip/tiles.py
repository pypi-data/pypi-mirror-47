"""
A base Tiles object for pySlip local tiles.

All tile sources should inherit from this base class.
For example, see gmt_local.py (local tiles) and open_street_map.py
(internet tiles).
"""
...
class Cache(pycacheback.pyCacheBack):
    ...
    TileDiskFormat = wx.BITMAP_TYPE_PNG
    ...
    def _put_to_back(self, key, image):
        ...
        image.SaveFile(tile_path, Cache.TileDiskFormat)
