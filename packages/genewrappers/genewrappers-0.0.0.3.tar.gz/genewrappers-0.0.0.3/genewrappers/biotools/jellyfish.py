#!/usr/bin/env python3
from genewrappers.biotools import accessoryfunctions
import os
...
def count(forward_in, reverse_in='NA', kmer_size=31, count_file='mer_counts.jf', hash_size='100M', options='',
    ...
    :param reverse_in: Reverse input reads. Found automatically if in same folder as forward and _R1/_R2
    ...
    if os.path.isfile(forward_in.replace('_R1', '_R2')) and reverse_in == 'NA' \
            and forward_in.replace('_R1', '_R2') != forward_in:
