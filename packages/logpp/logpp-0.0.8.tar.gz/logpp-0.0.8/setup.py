...
setup(
  ...
  url='http://logpp.readthedocs.io/en/latest/index.html',  # Use the URL to the github repo.
  download_url='https://github.com/patdaburu/logpp/archive/{version}.tar.gz'.format(version=version),
  keywords=[
