...
_SCALAPBOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='primitive_wrappers', full_name='scalapb.ScalaPbOptions.primitive_wrappers', index=5,
