...
def post_solve(instance, outdir):
    ...
    """
    save_generic_results(instance, outdir)
    save_total_cost_value(instance, outdir)

def save_generic_results(instance, outdir):
    for var in instance.component_objects(Var):
        save_var_tab_file(instance, var.name, outdir)

def save_var_tab_file(instance, var_name, outdir):
    output_file = os.path.join(outdir, '{}.tab'.format(var_name))
