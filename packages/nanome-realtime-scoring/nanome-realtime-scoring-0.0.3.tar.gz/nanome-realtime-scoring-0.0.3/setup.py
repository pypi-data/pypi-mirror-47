...
setup(
	...
	url = 'https://github.com/nanome-ai/plugin-realtime-scoring',
	platforms="any",
	keywords = ['virtual-reality', 'chemistry', 'python', 'api', 'plugin'],
	install_requires=['nanome'],
	entry_points={"console_scripts": ["nanome-realtime-scoring = nanome_realtime_scoring.RealtimeScoring:main"]},
	classifiers=[
