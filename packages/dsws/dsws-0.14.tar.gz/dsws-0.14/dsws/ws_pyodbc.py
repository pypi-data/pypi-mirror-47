"""
Workspace connection for pyodbc

ws_iopro is a dsws conn type library that follows PEP-249.
It contains a single class, Pyodbc.
Pyodbc uses a connection string to connect or kwargs to generate a connectino string. 
"""
...
class Pyodbc:
    ...
    def __init__(self,kwargs,command=None):
        ...
        As convention for DSWS, the following class methods are
        provided:
        ...
        Configuring an pyodbc class is typically done through dsws.duct, but can also be
        evaluated as:
        ```python
