...
#
def upload_jsons_DEPRECATED(api_instance, dataset, json_iter, processes=4):
...
def upload_jsons(api_instance, dataset, json_iter, processes=4):
    try:
        api_response = api_instance.post_bulk_insert_json({"dataset":dataset,"documents":list(json_iter)})
        return [api_response.result]
    except ApiException as e:
...
class NucleusApi(object):
    ...
    def post_available_sec_filings(self, payload, **kwargs):  # noqa: E501
        ...
        Get information about the available sec filings. If no input is passed, returns the list of all available tickers. If tickers are passed, returns the list of available document types for these tickers. If documt types are also passed, returns the list of available secions for the selected tickers/filing types  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def post_bulk_insert_json(self, payload, **kwargs):  # noqa: E501
        ...
        Add many document to a dataset, in JSON form. Bulk insertion is much faster than making one api call for each document.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
