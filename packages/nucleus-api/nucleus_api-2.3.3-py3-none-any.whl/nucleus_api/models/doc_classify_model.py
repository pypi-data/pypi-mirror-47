...
class DocClassifyModel(object):
    ...
    def __init__(self, dataset=None, query=None, fixed_topics=None, metadata_selection=None, custom_stop_words=None, time_period=None, period_start=None, period_end=None, excluded_docs=None, syntax_variables=False, validation_phase=False, threshold=None, remove_redundancies=True):  # noqa: E501
    ...
    @property
    def threshold(self):
        """Gets the threshold of this DocClassifyModel.  # noqa: E501

        Threshold value for a document exposure to the contrastic topic, above which the document is assigned to class 1 specified through metadata_selection  # noqa: E501

        :return: The threshold of this DocClassifyModel.  # noqa: E501
        :rtype: float
        """
    ...
    def threshold(self, threshold):
        """Sets the threshold of this DocClassifyModel.

        Threshold value for a document exposure to the contrastic topic, above which the document is assigned to class 1 specified through metadata_selection  # noqa: E501

        :param threshold: The threshold of this DocClassifyModel.  # noqa: E501
        :type: float
        """
