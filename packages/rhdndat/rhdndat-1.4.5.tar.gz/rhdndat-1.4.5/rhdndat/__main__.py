        ...
        for rom in files:
            ...
            try:
                ...
                if not metadata_exists and patch:
                    ...
                    continue
                #we didn't find the title so either the user gave no valid dat, or
                #dat didn't have this rom, or it was modified was modified
                if metadata_exists and (patch or not rom_title):
