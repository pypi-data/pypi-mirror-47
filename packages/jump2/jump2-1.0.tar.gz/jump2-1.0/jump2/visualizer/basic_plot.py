...
class BasicPlot(object):
    ...
    def save_figure(self, name='bandstructure.png', dpi=200):
        """ save the band structure figure 
       
        args:
            name:: string, file name of the band structure, 
            default is 'bandstructure.png';

            dpi:: integer, the identify number, default is 200;
        """
        self.plot.savefig(name, dpi=dpi)
        self.plot.clf()
