...
"""
This module defines the classes relating to tasks functions for calling
the ab initio programs.
"""
...
__modules__ = ['vasp', 'guassian', 'gulp', 'lammps', 'pwscf']
...
class Factory(object):
    ...
    def factory(self, value):
        """
        import the corresponding functional module by using input 
        keyowrds: 
            vasp
            pwscf
            abinit
        ...
        if value not in __modules__:
            raise error.MODError("""invalid modules, avilable: 
                              vasp (pwscf other under develop)""")

        elif value == 'vasp':

            from vasp.setvasp import SetVasp
            ...
            from pwdscf import SetPWscf

            func = SetPWscf()

        elif value == 'abinit':

            from abinit import Setabinit
