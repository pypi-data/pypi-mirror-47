...
class FieldSubject(BaseEducation):
    name = models.CharField(max_length=50, verbose_name=_('Title'))
    parent_obj = models.ForeignKey('self', null=True, blank=True, verbose_name=_('Parent Field Subject'))
...
class CityInstitute(BaseEducation):
    ...
    Institute = models.ForeignKey(Institute, null=True, verbose_name=_('Institude'))
...
class Education(BaseEducation):
    ...
    degree_obj = models.ForeignKey(Degree, null=True, verbose_name=_('Degree'))
    institute_obj = models.ForeignKey(Institute, null=True, verbose_name=_('Institute'))
    field_subject_obj = models.ForeignKey(FieldSubject, null=True, verbose_name=_('Field Subject'))
