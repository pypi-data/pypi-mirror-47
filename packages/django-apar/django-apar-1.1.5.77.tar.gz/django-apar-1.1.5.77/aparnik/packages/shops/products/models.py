...
class Product(BaseModel):
    ...
    slider_segment_obj = models.ForeignKey(SliderSegment, null=True, blank=True, related_name='products_sliders', verbose_name=_('Slider Segment'))
...
class ProductProperty(models.Model):
    ...
    icon = models.ForeignKey(FileField, verbose_name=_('Icon'))
...
class ProductPropertyMembership(models.Model):
    ...
    property = models.ForeignKey(ProductProperty, verbose_name=_('Property'))
