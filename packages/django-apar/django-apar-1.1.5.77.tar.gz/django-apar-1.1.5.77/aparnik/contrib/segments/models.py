...
class SegmentSort(models.Model):
    model_obj = models.ForeignKey(BaseModel, related_name='segment_sort_model', verbose_name=_('Model'))
    segment_obj = models.ForeignKey(BaseSegment, related_name='segment_sort_segment', verbose_name=_('Segment'))
...
class PageSort(models.Model):
    page_obj = models.ForeignKey(Page, related_name='page_sort_page', verbose_name=_('Page'))
    segment_obj = models.ForeignKey(BaseSegment, related_name='page_sort_segment', verbose_name=_('Segment'))
    sort = models.IntegerField(default=0, verbose_name=_('Sort'))
