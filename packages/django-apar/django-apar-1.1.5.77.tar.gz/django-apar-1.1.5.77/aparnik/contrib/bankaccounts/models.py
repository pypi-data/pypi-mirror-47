...
class BankAccount(BaseModel):
    ...
    user_obj = models.ForeignKey(User, related_name='bankaccounts', verbose_name=_('User'))
    bank_name_obj = models.ForeignKey(BankName, related_name='bankaccounts_name', verbose_name=_('Bank Name'))
