...
class FieldList(models.Model):
    ...
    def __unicode__(self):
        return unicode(self.model + '.' + self.name)
...
class Management(models.Model):
    ...
    parent_obj = models.ForeignKey('self', null=True, verbose_name=_('Parent'))
...
class ManagementRoles(models.Model):
    ...
    management_obj = models.ForeignKey(Management, verbose_name=_('Management group'))
