...
class Counter(models.Model):
    ...
    user_obj = models.ForeignKey(User, blank=True, null=True, verbose_name=_('User'))
    model_obj = models.ForeignKey(BaseModel, verbose_name=_('Base Model'))
