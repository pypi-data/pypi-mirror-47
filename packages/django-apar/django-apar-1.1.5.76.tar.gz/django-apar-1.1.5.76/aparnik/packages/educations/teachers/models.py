...
class Teacher(BaseModel):
    ...
    slider_segment_obj = models.ForeignKey(SliderSegment, null=True, blank=True, verbose_name=_('Slider Semgent'))
...
class Dossier(BaseModel):
    teacher_obj = models.ForeignKey(Teacher, verbose_name=_('teacher'))
    ...
    def __unicode__(self):
        return unicode(self.teacher_obj)
