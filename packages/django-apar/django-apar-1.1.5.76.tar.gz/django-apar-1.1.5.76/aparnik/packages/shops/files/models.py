...
class FileManager(ProductManager):
    ...
    def active(self):
        return super(FileManager, self).active().filter(file_obj__is_lock=False, publish_date__lte=now())
...
class File(Product):
    ...
    file_obj = models.ForeignKey(FileField, related_name='shop_file_obj', verbose_name=_('File'))
    banner = models.ForeignKey(FileField, related_name='shop_file_banner', null=True, blank=True,
                               verbose_name=_('Banner Image'))
    cover = models.ForeignKey(FileField,  null=True, blank=True, related_name='shop_file_cover', verbose_name=_('Cover Image'))
