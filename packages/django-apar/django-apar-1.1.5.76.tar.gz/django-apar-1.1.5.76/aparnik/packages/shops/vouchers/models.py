    ...
    def change_order(self, order):
        ...
        for item in order.items.all():
            try:
                ...
                if not order.is_success or item.aparnik_bon_return == 0:
                    break
...
class Voucher(BaseModel):
    user_obj = models.ForeignKey(User, related_name='voucher_user', verbose_name=_('User'))
    ...
    order_item_obj = models.OneToOneField('orders.OrderItem', related_name='voucher_order_item', verbose_name=_('Order Item'))
    ...
    def __unicode__(self):
        return unicode(self.order_item_obj)
...
class VoucherOrderItem(models.Model):
    voucher_obj = models.ForeignKey(Voucher, related_name='voucher_model', verbose_name=_('Voucher'))
    item_obj = models.ForeignKey('orders.OrderItem', related_name='voucher_item_spent', verbose_name=_('Item Spent'))
    ...
    def __unicode__(self):
        return unicode(self.voucher_obj)
