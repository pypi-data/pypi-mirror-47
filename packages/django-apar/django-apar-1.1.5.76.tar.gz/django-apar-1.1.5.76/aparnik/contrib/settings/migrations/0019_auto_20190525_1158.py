# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2019-05-25 11:58
...
def add_keys(apps, schema_editor):
    ...
    try:
        ...
        Setting.objects.create(
            title='منتشر شدن پیام ها به صورت پیش فرض',
            key=key,
            value='False',
            value_type='b',
            is_show=False,
    ...
    try:
        ...
        Setting.objects.create(
            title='تعداد گوشی های مجاز هر کاربر',
            key=key,
            value='1',
            value_type='i',
            is_show=False,
    ...
    try:
        ...
        Setting.objects.create(
            title='فعال بودن محدودیت دستگاه',
            key=key,
            value='False',
            value_type='b',
            is_show=False,
    ...
    try:
        ...
        Setting.objects.create(
            title='تعداد دسترسی های داده شده توسط این کاربر برای یک کالای خاص',
            key=key,
            value='1',
            value_type='i',
            is_show=False,
    ...
    try:
        ...
        Setting.objects.create(
            title='تعداد دسترسی های داده شده توسط این کاربر برای همه کالاها',
            key=key,
            value='10',
            value_type='i',
            is_show=False,
