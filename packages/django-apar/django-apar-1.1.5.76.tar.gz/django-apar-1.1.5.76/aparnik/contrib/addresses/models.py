...
class UserAddress(BaseModel):
    ...
    user_obj = models.ForeignKey(User, related_name='addresses', verbose_name=_('User'))
    city_obj = models.ForeignKey('province.City', related_name='addresses', verbose_name=_('City'))
    # location = models.
