...
class Configuration(object):
    ...
    def read_from_file(cls, flags_path):
        ...
        logger.info("--- Using global.properties at %s" % abs_flags_path)
        try:
            ...
            for attr in globalattrs:
                ...
                if hasattr(cls, attr):
                    ...
                    logger.info("Found global.properties variable %s=%s and type %s" % (str(attr), str(value), str(type(cur_value))))
