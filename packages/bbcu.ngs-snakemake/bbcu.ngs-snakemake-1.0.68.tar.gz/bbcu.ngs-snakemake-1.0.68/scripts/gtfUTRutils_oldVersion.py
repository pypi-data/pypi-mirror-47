...
def parseArgs():
    ...
    parser.add_argument('--w5', help='The window in bp by which to extend the 3" UTR exon towards the 5" direction on the mRNA. This will generally depend on the fragment size (3*fragment-size is a good number)',required=True)
