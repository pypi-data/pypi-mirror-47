...
Attachment autorig(const Skeleton &given, const Mesh &m)
{
    int i;
    ...
    vector<Vector3> embedding = refineEmbedding(distanceField, medialCenters, discreteEmbedding, given);

    //attachment
    VisTester<TreeType> *tester = new VisTester<TreeType>(distanceField);
    Attachment attachment(newMesh, given, embedding, tester);
