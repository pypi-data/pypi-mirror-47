...
<html>
    ...
    <script>
        requirejs.config({
            ...
            waitSeconds: 3000,
            map: {
                '*': { //TODO: Load version specified in _model_module_version of jupyter-vuetify models.
                     'jupyter-vuetify': 'https://unpkg.com/jupyter-vuetify@0.0.1-alpha.1/dist/nodeps.js',
                },
            },
        });
