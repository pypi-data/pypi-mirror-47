...
class AtomPubRepository(object):
    ...
    def createDocumentFromSource(self,
        ...
        # build the Atom entry
        xmlDoc = getEntryXmlDoc(self, None, properties, sourceId=sourceId)
...
def getEntryXmlDoc(repo=None, objectTypeId=None, properties=None, contentFile=None,
                   contentType=None, contentEncoding=None, sourceId=None):
    ...
    if sourceId:
        sourceElement = entryXmlDoc.createElementNS(CMIS_NS, 'cmis:sourceId')
        sourceElement.setAttribute('propertyDefinitionId', sourceId)
        objectElement.appendChild(sourceElement)
