...
\thispagestyle{empty} % this suppresses page numbers
...
\hline
$SWAP(1,0)^{\nbar(3)n(2)}$
where $\scriptstyle SWAP=diag(1,\sigma_X, 1)$ &
{\tt SWAP  1  0  IF  3F  2T}&{\tt 0---@---<--->}
\\
\hline
$\scriptstyle diag(1, U2, 1)(1, 0)^{\nbar(3)n(2)}$&
{\tt SWAY 1 0 BY 5.0 30.0 IF  3F  2T}&
{\tt 0---@---<<->>}
\\
where
$\scriptstyle U2= e^{i\frac{\pi}{180}
[5 + 30\sigx]}$&&
\\
\hline
$(e^{
