...
from zlhawq.core import add_partition_t_gg,drop_partition_t_gg,update_t_gg,est_cdc_t_gg
...
def out_t_gg_ftb(quyu,dir,conp,tb='t_gg'):
    ...
    sql="""select guid,gg_name,fabu_time,href,ggtype,jytype,diqu,quyu,info,page from %s.%s
        """%(s2,tb)
    print(sql)
