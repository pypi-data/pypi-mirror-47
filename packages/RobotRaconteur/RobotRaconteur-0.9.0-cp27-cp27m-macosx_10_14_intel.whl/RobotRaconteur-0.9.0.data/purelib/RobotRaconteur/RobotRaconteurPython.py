...
MessageEntryType_StringTableOp = _RobotRaconteurPython.MessageEntryType_StringTableOp
MessageEntryType_StringTableOpRet = _RobotRaconteurPython.MessageEntryType_StringTableOpRet
...
MessageFlags_PROTOCOL_VERSION_MINOR = cvar.MessageFlags_PROTOCOL_VERSION_MINOR
MessageFlags_SUBSTREAM_ID = cvar.MessageFlags_SUBSTREAM_ID
MessageFlags_SUBSTREAM_SEQUENCE_NUMBER = cvar.MessageFlags_SUBSTREAM_SEQUENCE_NUMBER
MessageFlags_FRAGMENT = cvar.MessageFlags_FRAGMENT
MessageFlags_UNRELIABLE = cvar.MessageFlags_UNRELIABLE
MessageFlags_UNRELIABLE_EXPIRATION = cvar.MessageFlags_UNRELIABLE_EXPIRATION
...
MessageFlags_MESSAGE_ID = cvar.MessageFlags_MESSAGE_ID
MessageFlags_STRING_TABLE = cvar.MessageFlags_STRING_TABLE
MessageFlags_MULTIPLE_ENTRIES = cvar.MessageFlags_MULTIPLE_ENTRIES
MessageFlags_TRANSPORT_SPECIFIC = cvar.MessageFlags_TRANSPORT_SPECIFIC
...
MessageEntryFlags_TIMESPEC = cvar.MessageEntryFlags_TIMESPEC
...
MessageElementFlags_SEQUENCE_NUMBER = cvar.MessageElementFlags_SEQUENCE_NUMBER
MessageElementFlags_REQUEST_ACK = cvar.MessageElementFlags_REQUEST_ACK
...
TransportCapabilityCode_MESSAGE3_BASIC_PAGE = cvar.TransportCapabilityCode_MESSAGE3_BASIC_PAGE
TransportCapabilityCode_MESSAGE3_BASIC_ENABLE = cvar.TransportCapabilityCode_MESSAGE3_BASIC_ENABLE
TransportCapabilityCode_MESSAGE3_BASIC_CONNECTCOMBINED = cvar.TransportCapabilityCode_MESSAGE3_BASIC_CONNECTCOMBINED
TransportCapabilityCode_MESSAGE3_STRINGTABLE_PAGE = cvar.TransportCapabilityCode_MESSAGE3_STRINGTABLE_PAGE
TransportCapabilityCode_MESSAGE3_STRINGTABLE_ENABLE = cvar.TransportCapabilityCode_MESSAGE3_STRINGTABLE_ENABLE
TransportCapabilityCode_MESSAGE3_STRINGTABLE_MESSAGE_LOCAL = cvar.TransportCapabilityCode_MESSAGE3_STRINGTABLE_MESSAGE_LOCAL
TransportCapabilityCode_MESSAGE3_STRINGTABLE_DYNAMIC_TABLE = cvar.TransportCapabilityCode_MESSAGE3_STRINGTABLE_DYNAMIC_TABLE
TransportCapabilityCode_MESSAGE3_STRINGTABLE_STANDARD_TABLE = cvar.TransportCapabilityCode_MESSAGE3_STRINGTABLE_STANDARD_TABLE
...
class RRBaseArray(MessageElementData):
    ...
    def RRType(self):
        return _RobotRaconteurPython.RRBaseArray_RRType(self)
...
class MessageFragmentHeader(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    FragmentMessageNumber = property(_RobotRaconteurPython.MessageFragmentHeader_FragmentMessageNumber_get, _RobotRaconteurPython.MessageFragmentHeader_FragmentMessageNumber_set)
    FragmentMessageSize = property(_RobotRaconteurPython.MessageFragmentHeader_FragmentMessageSize_get, _RobotRaconteurPython.MessageFragmentHeader_FragmentMessageSize_set)
    FragmentOffset = property(_RobotRaconteurPython.MessageFragmentHeader_FragmentOffset_get, _RobotRaconteurPython.MessageFragmentHeader_FragmentOffset_set)

    def __init__(self):
        _RobotRaconteurPython.MessageFragmentHeader_swiginit(self, _RobotRaconteurPython.new_MessageFragmentHeader())
    __swig_destroy__ = _RobotRaconteurPython.delete_MessageFragmentHeader

# Register MessageFragmentHeader in _RobotRaconteurPython:
_RobotRaconteurPython.MessageFragmentHeader_swigregister(MessageFragmentHeader)
...
class MessageHeader(RRValue):
    ...
    SubstreamID = property(_RobotRaconteurPython.MessageHeader_SubstreamID_get, _RobotRaconteurPython.MessageHeader_SubstreamID_set)
    FragmentHeader = property(_RobotRaconteurPython.MessageHeader_FragmentHeader_get, _RobotRaconteurPython.MessageHeader_FragmentHeader_set)
...
class MessageEntry(RRValue):
    ...
    EntryStreamID = property(_RobotRaconteurPython.MessageEntry_EntryStreamID_get, _RobotRaconteurPython.MessageEntry_EntryStreamID_set)
    ...
    EntryTimeSpec = property(_RobotRaconteurPython.MessageEntry_EntryTimeSpec_get, _RobotRaconteurPython.MessageEntry_EntryTimeSpec_set)
...
class MessageElement(RRValue):
    ...
    SequenceNumber = property(_RobotRaconteurPython.MessageElement_SequenceNumber_get, _RobotRaconteurPython.MessageElement_SequenceNumber_set)
...
class MessageElementStructure(MessageElementData):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    Type = property(_RobotRaconteurPython.MessageElementStructure_Type_get, _RobotRaconteurPython.MessageElementStructure_Type_set)
    Elements = property(_RobotRaconteurPython.MessageElementStructure_Elements_get, _RobotRaconteurPython.MessageElementStructure_Elements_set)

    def __init__(self, type_, elements_):
        _RobotRaconteurPython.MessageElementStructure_swiginit(self, _RobotRaconteurPython.new_MessageElementStructure(type_, elements_))

    def GetTypeString(self):
        return _RobotRaconteurPython.MessageElementStructure_GetTypeString(self)

    def GetTypeID(self):
        return _RobotRaconteurPython.MessageElementStructure_GetTypeID(self)
    __swig_destroy__ = _RobotRaconteurPython.delete_MessageElementStructure

# Register MessageElementStructure in _RobotRaconteurPython:
_RobotRaconteurPython.MessageElementStructure_swigregister(MessageElementStructure)

class MessageElementMultiDimArray(MessageElementData):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    Elements = property(_RobotRaconteurPython.MessageElementMultiDimArray_Elements_get, _RobotRaconteurPython.MessageElementMultiDimArray_Elements_set)

    def __init__(self, e):
        _RobotRaconteurPython.MessageElementMultiDimArray_swiginit(self, _RobotRaconteurPython.new_MessageElementMultiDimArray(e))

    def GetTypeString(self):
        return _RobotRaconteurPython.MessageElementMultiDimArray_GetTypeString(self)

    def GetTypeID(self):
        return _RobotRaconteurPython.MessageElementMultiDimArray_GetTypeID(self)
    __swig_destroy__ = _RobotRaconteurPython.delete_MessageElementMultiDimArray

# Register MessageElementMultiDimArray in _RobotRaconteurPython:
_RobotRaconteurPython.MessageElementMultiDimArray_swigregister(MessageElementMultiDimArray)

class MessageElementList(MessageElementData):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    Elements = property(_RobotRaconteurPython.MessageElementList_Elements_get, _RobotRaconteurPython.MessageElementList_Elements_set)

    def __init__(self, e):
        _RobotRaconteurPython.MessageElementList_swiginit(self, _RobotRaconteurPython.new_MessageElementList(e))

    def GetTypeString(self):
        return _RobotRaconteurPython.MessageElementList_GetTypeString(self)

    def GetTypeID(self):
        return _RobotRaconteurPython.MessageElementList_GetTypeID(self)
    __swig_destroy__ = _RobotRaconteurPython.delete_MessageElementList

# Register MessageElementList in _RobotRaconteurPython:
_RobotRaconteurPython.MessageElementList_swigregister(MessageElementList)

class MessageElementPod(MessageElementData):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    Elements = property(_RobotRaconteurPython.MessageElementPod_Elements_get, _RobotRaconteurPython.MessageElementPod_Elements_set)

    def __init__(self, elements_):
        _RobotRaconteurPython.MessageElementPod_swiginit(self, _RobotRaconteurPython.new_MessageElementPod(elements_))

    def GetTypeString(self):
        return _RobotRaconteurPython.MessageElementPod_GetTypeString(self)

    def GetTypeID(self):
        return _RobotRaconteurPython.MessageElementPod_GetTypeID(self)
    __swig_destroy__ = _RobotRaconteurPython.delete_MessageElementPod

# Register MessageElementPod in _RobotRaconteurPython:
_RobotRaconteurPython.MessageElementPod_swigregister(MessageElementPod)

class MessageElementPodArray(MessageElementData):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    Type = property(_RobotRaconteurPython.MessageElementPodArray_Type_get, _RobotRaconteurPython.MessageElementPodArray_Type_set)
    Elements = property(_RobotRaconteurPython.MessageElementPodArray_Elements_get, _RobotRaconteurPython.MessageElementPodArray_Elements_set)

    def __init__(self, type_, elements_):
        _RobotRaconteurPython.MessageElementPodArray_swiginit(self, _RobotRaconteurPython.new_MessageElementPodArray(type_, elements_))

    def GetTypeString(self):
        return _RobotRaconteurPython.MessageElementPodArray_GetTypeString(self)

    def GetTypeID(self):
        return _RobotRaconteurPython.MessageElementPodArray_GetTypeID(self)
    __swig_destroy__ = _RobotRaconteurPython.delete_MessageElementPodArray

# Register MessageElementPodArray in _RobotRaconteurPython:
_RobotRaconteurPython.MessageElementPodArray_swigregister(MessageElementPodArray)

class MessageElementPodMultiDimArray(MessageElementData):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    Type = property(_RobotRaconteurPython.MessageElementPodMultiDimArray_Type_get, _RobotRaconteurPython.MessageElementPodMultiDimArray_Type_set)
    Elements = property(_RobotRaconteurPython.MessageElementPodMultiDimArray_Elements_get, _RobotRaconteurPython.MessageElementPodMultiDimArray_Elements_set)

    def __init__(self, type_, elements_):
        _RobotRaconteurPython.MessageElementPodMultiDimArray_swiginit(self, _RobotRaconteurPython.new_MessageElementPodMultiDimArray(type_, elements_))

    def GetTypeString(self):
        return _RobotRaconteurPython.MessageElementPodMultiDimArray_GetTypeString(self)

    def GetTypeID(self):
        return _RobotRaconteurPython.MessageElementPodMultiDimArray_GetTypeID(self)
    __swig_destroy__ = _RobotRaconteurPython.delete_MessageElementPodMultiDimArray

# Register MessageElementPodMultiDimArray in _RobotRaconteurPython:
_RobotRaconteurPython.MessageElementPodMultiDimArray_swigregister(MessageElementPodMultiDimArray)

class MessageElementNamedArray(MessageElementData):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    Type = property(_RobotRaconteurPython.MessageElementNamedArray_Type_get, _RobotRaconteurPython.MessageElementNamedArray_Type_set)
    Elements = property(_RobotRaconteurPython.MessageElementNamedArray_Elements_get, _RobotRaconteurPython.MessageElementNamedArray_Elements_set)

    def __init__(self, type_, elements_):
        _RobotRaconteurPython.MessageElementNamedArray_swiginit(self, _RobotRaconteurPython.new_MessageElementNamedArray(type_, elements_))

    def GetTypeString(self):
        return _RobotRaconteurPython.MessageElementNamedArray_GetTypeString(self)

    def GetTypeID(self):
        return _RobotRaconteurPython.MessageElementNamedArray_GetTypeID(self)
    __swig_destroy__ = _RobotRaconteurPython.delete_MessageElementNamedArray

# Register MessageElementNamedArray in _RobotRaconteurPython:
_RobotRaconteurPython.MessageElementNamedArray_swigregister(MessageElementNamedArray)

class MessageElementNamedMultiDimArray(MessageElementData):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    Type = property(_RobotRaconteurPython.MessageElementNamedMultiDimArray_Type_get, _RobotRaconteurPython.MessageElementNamedMultiDimArray_Type_set)
    Elements = property(_RobotRaconteurPython.MessageElementNamedMultiDimArray_Elements_get, _RobotRaconteurPython.MessageElementNamedMultiDimArray_Elements_set)

    def __init__(self, type_, elements_):
        _RobotRaconteurPython.MessageElementNamedMultiDimArray_swiginit(self, _RobotRaconteurPython.new_MessageElementNamedMultiDimArray(type_, elements_))

    def GetTypeString(self):
        return _RobotRaconteurPython.MessageElementNamedMultiDimArray_GetTypeString(self)

    def GetTypeID(self):
        return _RobotRaconteurPython.MessageElementNamedMultiDimArray_GetTypeID(self)
    __swig_destroy__ = _RobotRaconteurPython.delete_MessageElementNamedMultiDimArray

# Register MessageElementNamedMultiDimArray in _RobotRaconteurPython:
_RobotRaconteurPython.MessageElementNamedMultiDimArray_swigregister(MessageElementNamedMultiDimArray)

class MessageElementMap_int32_t(MessageElementData):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    Elements = property(_RobotRaconteurPython.MessageElementMap_int32_t_Elements_get, _RobotRaconteurPython.MessageElementMap_int32_t_Elements_set)

    def __init__(self, e):
        _RobotRaconteurPython.MessageElementMap_int32_t_swiginit(self, _RobotRaconteurPython.new_MessageElementMap_int32_t(e))

    def GetTypeString(self):
        return _RobotRaconteurPython.MessageElementMap_int32_t_GetTypeString(self)

    def GetTypeID(self):
        return _RobotRaconteurPython.MessageElementMap_int32_t_GetTypeID(self)
    __swig_destroy__ = _RobotRaconteurPython.delete_MessageElementMap_int32_t

# Register MessageElementMap_int32_t in _RobotRaconteurPython:
_RobotRaconteurPython.MessageElementMap_int32_t_swigregister(MessageElementMap_int32_t)

class MessageElementMap_string(MessageElementData):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    Elements = property(_RobotRaconteurPython.MessageElementMap_string_Elements_get, _RobotRaconteurPython.MessageElementMap_string_Elements_set)

    def __init__(self, e):
        _RobotRaconteurPython.MessageElementMap_string_swiginit(self, _RobotRaconteurPython.new_MessageElementMap_string(e))

    def GetTypeString(self):
        return _RobotRaconteurPython.MessageElementMap_string_GetTypeString(self)

    def GetTypeID(self):
        return _RobotRaconteurPython.MessageElementMap_string_GetTypeID(self)
    __swig_destroy__ = _RobotRaconteurPython.delete_MessageElementMap_string

# Register MessageElementMap_string in _RobotRaconteurPython:
_RobotRaconteurPython.MessageElementMap_string_swigregister(MessageElementMap_string)
...
class MessageElementDataUtil(object):
    ...
    @staticmethod
    def ToMessageElementStructure(m):
        return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementStructure(m)

    @staticmethod
    def ToMessageElementMap_int32_t(m):
        return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementMap_int32_t(m)

    @staticmethod
    def ToMessageElementMap_string(m):
        return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementMap_string(m)

    @staticmethod
    def ToMessageElementList(m):
        return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementList(m)

    @staticmethod
    def ToMessageElementMultiDimArray(m):
        return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementMultiDimArray(m)

    @staticmethod
    def ToMessageElementPod(m):
        return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementPod(m)

    @staticmethod
    def ToMessageElementPodArray(m):
        return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementPodArray(m)

    @staticmethod
    def ToMessageElementPodMultiDimArray(m):
        return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementPodMultiDimArray(m)

    @staticmethod
    def ToMessageElementNamedArray(m):
        return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementNamedArray(m)

    @staticmethod
    def ToMessageElementNamedMultiDimArray(m):
        return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementNamedMultiDimArray(m)
...
def MessageElementDataUtil_ToMessageElementStructure(m):
    return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementStructure(m)

def MessageElementDataUtil_ToMessageElementMap_int32_t(m):
    return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementMap_int32_t(m)

def MessageElementDataUtil_ToMessageElementMap_string(m):
    return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementMap_string(m)

def MessageElementDataUtil_ToMessageElementList(m):
    return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementList(m)

def MessageElementDataUtil_ToMessageElementMultiDimArray(m):
    return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementMultiDimArray(m)

def MessageElementDataUtil_ToMessageElementPod(m):
    return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementPod(m)

def MessageElementDataUtil_ToMessageElementPodArray(m):
    return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementPodArray(m)

def MessageElementDataUtil_ToMessageElementPodMultiDimArray(m):
    return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementPodMultiDimArray(m)

def MessageElementDataUtil_ToMessageElementNamedArray(m):
    return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementNamedArray(m)

def MessageElementDataUtil_ToMessageElementNamedMultiDimArray(m):
    return _RobotRaconteurPython.MessageElementDataUtil_ToMessageElementNamedMultiDimArray(m)
...
class AsyncRequestDirector(object):
    ...
    def handler(self, ret, error_code, errorname, errormessage):
        return _RobotRaconteurPython.AsyncRequestDirector_handler(self, ret, error_code, errorname, errormessage)
...
class AsyncVoidReturnDirector(object):
    ...
    def handler(self, error_code, errorname, errormessage):
        return _RobotRaconteurPython.AsyncVoidReturnDirector_handler(self, error_code, errorname, errormessage)
...
class AsyncStringReturnDirector(object):
    ...
    def handler(self, ret, error_code, errorname, errormessage):
        return _RobotRaconteurPython.AsyncStringReturnDirector_handler(self, ret, error_code, errorname, errormessage)
...
class AsyncUInt32ReturnDirector(object):
    ...
    def handler(self, ret, error_code, errorname, errormessage):
        return _RobotRaconteurPython.AsyncUInt32ReturnDirector_handler(self, ret, error_code, errorname, errormessage)
...
class RobotRaconteurVersion(object):
    ...
    def FromString(self, v):
        return _RobotRaconteurPython.RobotRaconteurVersion_FromString(self, v)
...
class ServiceDefinition(object):
    ...
    def FromString(self, s):
        return _RobotRaconteurPython.ServiceDefinition_FromString(self, s)
...
class ServiceEntryDefinition(object):
    ...
    def FromString(self, *args):
        return _RobotRaconteurPython.ServiceEntryDefinition_FromString(self, *args)
...
class PropertyDefinition(MemberDefinition):
    ...
    def FromString(self, s):
        return _RobotRaconteurPython.PropertyDefinition_FromString(self, s)
...
class FunctionDefinition(MemberDefinition):
    ...
    def FromString(self, s):
        return _RobotRaconteurPython.FunctionDefinition_FromString(self, s)
...
class EventDefinition(MemberDefinition):
    ...
    def FromString(self, s):
        return _RobotRaconteurPython.EventDefinition_FromString(self, s)
...
class ObjRefDefinition(MemberDefinition):
    ...
    def FromString(self, s):
        return _RobotRaconteurPython.ObjRefDefinition_FromString(self, s)
...
class PipeDefinition(MemberDefinition):
    ...
    def FromString(self, s):
        return _RobotRaconteurPython.PipeDefinition_FromString(self, s)
...
class CallbackDefinition(MemberDefinition):
    ...
    def FromString(self, s):
        return _RobotRaconteurPython.CallbackDefinition_FromString(self, s)
...
class WireDefinition(MemberDefinition):
    ...
    def FromString(self, s):
        return _RobotRaconteurPython.WireDefinition_FromString(self, s)
...
class MemoryDefinition(MemberDefinition):
    ...
    def FromString(self, s):
        return _RobotRaconteurPython.MemoryDefinition_FromString(self, s)
...
class TypeDefinition(object):
    ...
    def FromString(self, s):
        return _RobotRaconteurPython.TypeDefinition_FromString(self, s)
...
class UsingDefinition(object):
    ...
    def FromString(self, s):
        return _RobotRaconteurPython.UsingDefinition_FromString(self, s)
...
class ConstantDefinition(object):
    ...
    def FromString(self, s):
        return _RobotRaconteurPython.ConstantDefinition_FromString(self, s)
...
class EnumDefinition(object):
    ...
    def FromString(self, *args):
        return _RobotRaconteurPython.EnumDefinition_FromString(self, *args)
...
class TcpTransport(Transport):
    ...
    def _GetDisableMessage3(self):
        return _RobotRaconteurPython.TcpTransport__GetDisableMessage3(self)

    def _SetDisableMessage3(self, d):
        return _RobotRaconteurPython.TcpTransport__SetDisableMessage3(self, d)
...
class LocalTransport(Transport):
    ...
    def _GetDisableMessage3(self):
        return _RobotRaconteurPython.LocalTransport__GetDisableMessage3(self)

    def _SetDisableMessage3(self, d):
        return _RobotRaconteurPython.LocalTransport__SetDisableMessage3(self, d)
...
class HardwareTransport(Transport):
    ...
    def _GetDisableMessage3(self):
        return _RobotRaconteurPython.HardwareTransport__GetDisableMessage3(self)

    def _SetDisableMessage3(self, d):
        return _RobotRaconteurPython.HardwareTransport__SetDisableMessage3(self, d)
...
class AsyncTimerEventReturnDirector(object):
    ...
    def handler(self, ret, error_code, errorname, errormessage):
        return _RobotRaconteurPython.AsyncTimerEventReturnDirector_handler(self, ret, error_code, errorname, errormessage)
...
class AsyncPipeEndpointReturnDirector(object):
    ...
    def handler(self, ep, error_code, errorname, errormessage):
        return _RobotRaconteurPython.AsyncPipeEndpointReturnDirector_handler(self, ep, error_code, errorname, errormessage)
...
class WrappedPipeEndpoint(object):
    ...
    def TryReceivePacketWait(self, packet, timeout=-1, peek=False):
        return _RobotRaconteurPython.WrappedPipeEndpoint_TryReceivePacketWait(self, packet, timeout, peek)
...
class WrappedPipeBroadcaster(object):
    ...
    def GetMaximumBacklog(self):
        return _RobotRaconteurPython.WrappedPipeBroadcaster_GetMaximumBacklog(self)

    def SetMaximumBacklog(self, maximum_backlog):
        return _RobotRaconteurPython.WrappedPipeBroadcaster_SetMaximumBacklog(self, maximum_backlog)
...
class AsyncWireConnectionReturnDirector(object):
    ...
    def handler(self, ep, error_code, errorname, errormessage):
        return _RobotRaconteurPython.AsyncWireConnectionReturnDirector_handler(self, ep, error_code, errorname, errormessage)
...
class AsyncWirePeekReturnDirector(object):
    ...
    def handler(self, value, ts, error_code, errorname, errormessage):
        return _RobotRaconteurPython.AsyncWirePeekReturnDirector_handler(self, value, ts, error_code, errorname, errormessage)
...
class WrappedWireConnection(object):
    ...
    def TryGetInValue(self, value, ts):
        return _RobotRaconteurPython.WrappedWireConnection_TryGetInValue(self, value, ts)

    def TryGetOutValue(self, value, ts):
        return _RobotRaconteurPython.WrappedWireConnection_TryGetOutValue(self, value, ts)
...
class AsyncGeneratorClientReturnDirector(object):
    ...
    def handler(self, ret, error_code, errorname, errormessage):
        return _RobotRaconteurPython.AsyncGeneratorClientReturnDirector_handler(self, ret, error_code, errorname, errormessage)

    def __init__(self):
        _RobotRaconteurPython.AsyncGeneratorClientReturnDirector_swiginit(self, _RobotRaconteurPython.new_AsyncGeneratorClientReturnDirector())
...
class AsyncStubReturnDirector(object):
    ...
    def handler(self, stub, error_code, errorname, errormessage):
        return _RobotRaconteurPython.AsyncStubReturnDirector_handler(self, stub, error_code, errorname, errormessage)
...
class WrappedServiceStub(RRObject):
    ...
    def RRType(self):
        return _RobotRaconteurPython.WrappedServiceStub_RRType(self)
...
class WrappedRRObject(RRObject):
    ...
    def RRType(self):
        return _RobotRaconteurPython.WrappedRRObject_RRType(self)
...
class WrappedServiceSubscription(object):
    ...
    def SubscribeWire(self, membername):
        return _RobotRaconteurPython.WrappedServiceSubscription_SubscribeWire(self, membername)

    def SubscribePipe(self, membername, max_recv_packets=-1):
        return _RobotRaconteurPython.WrappedServiceSubscription_SubscribePipe(self, membername, max_recv_packets)
...
RobotRaconteurNodeSetupFlags_DISABLE_MESSAGE3 = _RobotRaconteurPython.RobotRaconteurNodeSetupFlags_DISABLE_MESSAGE3
...
RobotRaconteurNodeSetupFlags_SERVER_DEFAULT_PORT_SHARER = _RobotRaconteurPython.RobotRaconteurNodeSetupFlags_SERVER_DEFAULT_PORT_SHARER
...
RobotRaconteurNodeSetupFlags_SECURE_SERVER_DEFAULT_PORT_SHARER = _RobotRaconteurPython.RobotRaconteurNodeSetupFlags_SECURE_SERVER_DEFAULT_PORT_SHARER
class WrappedRobotRaconteurNodeSetup(object):
    ...
    def __init__(self, node, node_name, tcp_port, flags):
        _RobotRaconteurPython.WrappedRobotRaconteurNodeSetup_swiginit(self, _RobotRaconteurPython.new_WrappedRobotRaconteurNodeSetup(node, node_name, tcp_port, flags))
