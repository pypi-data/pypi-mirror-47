...
class ServiceDefinitionException(RobotRaconteurException):
    def __init__(self,message=""):
        super(ServiceDefinitionException,self).__init__(RobotRaconteurPython.MessageErrorType_ServiceDefinitionError, "RobotRaconteur.SystemDefinitionError",message)
