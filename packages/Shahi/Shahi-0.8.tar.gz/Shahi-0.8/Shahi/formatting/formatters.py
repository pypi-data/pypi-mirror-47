...
class ShahiDateFormatter(BaseFormatter):
    """
    Responsible to parse and formatting of a :py:class:`Shahi.ShahiDate` instance.
...
class ShahiDatetimeFormatter(ShahiDateFormatter):
    """
    Responsible to parse and formatting of a :py:class:`Shahi.ShahiDatetime` instance.
    ...
    def __init__(self, format_string, directive_db=None):
        ...
        super(ShahiDatetimeFormatter, self).__init__(format_string, directive_db=directive_db)
