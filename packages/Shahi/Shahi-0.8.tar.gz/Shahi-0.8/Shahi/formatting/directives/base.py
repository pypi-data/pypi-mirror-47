# -*- coding: utf-8 -*-
from Shahi.compat import get_unicode
__author__ = 'shah'
...
class CompositeDateDirective(Directive):
    ...
    def _create_formatter(self):
        from Shahi.formatting import ShahiDateFormatter
        return ShahiDateFormatter(self.format_string)
    ...
    def sub_formatter(self):
        ...
        :rtype: :py:class:`Shahi.ShahiDateFormatter`
        """
...
class CompositeDatetimeDirective(CompositeDateDirective):
    ...
    def _create_formatter(self):
        from Shahi.formatting import ShahiDatetimeFormatter
        return ShahiDatetimeFormatter(self.format_string)
