import numpy as np
from imgic import resize
from imgic import blur
from imgic import color_trans
from imgic import crop
from imgic import dropout
from imgic import flip 
from imgic import combine 
...
class Img:
    ...
    def dropout(self, a = 0.5) -> 'Img':
        ...
        :return: Img class instance
        """
        self.image = dropout.dropout(self.image, a)
        self.shape = self.image.shape
        return self
