...
class BGraph(object):
    ...
    def __len__(self):
        return _libcolgraph.BGraph___len__(self)
...
class CGraph(object):
    ...
    def __len__(self):
        return _libcolgraph.CGraph___len__(self)
...
class ColoringGraph(CGraph):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    colors = property(_libcolgraph.ColoringGraph_colors_get, _libcolgraph.ColoringGraph_colors_set)
...
class ColoringVertex(Vertex):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    colors = property(_libcolgraph.ColoringVertex_colors_get, _libcolgraph.ColoringVertex_colors_set)
