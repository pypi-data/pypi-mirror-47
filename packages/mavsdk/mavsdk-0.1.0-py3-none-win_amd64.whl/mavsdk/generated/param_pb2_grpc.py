...
class ParamServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetIntParam = channel.unary_unary(
        '/dronecode_sdk.rpc.param.ParamService/GetIntParam',
    ...
    self.SetIntParam = channel.unary_unary(
        '/dronecode_sdk.rpc.param.ParamService/SetIntParam',
    ...
    self.GetFloatParam = channel.unary_unary(
        '/dronecode_sdk.rpc.param.ParamService/GetFloatParam',
    ...
    self.SetFloatParam = channel.unary_unary(
        '/dronecode_sdk.rpc.param.ParamService/SetFloatParam',
...
def add_ParamServiceServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'dronecode_sdk.rpc.param.ParamService', rpc_method_handlers)
