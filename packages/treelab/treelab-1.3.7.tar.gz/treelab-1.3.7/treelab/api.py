...
class Table(_TreelabObject):
    ...
    def data_frame(self, view_id: str = ''):
        ...
        if view_id:
            ...
            view = _TreelabCheck(self.get_views())['view']
...
class Cell(_TreelabObject):
    ...
    def get_value(self):
        if self._value:
            ...
            if self.view.data().cells:
                data = self.view.data().cells.get((self.row.id, self.column.id))
    ...
    @property
    def data(self):
        return self.view.data().cells.get((self.row.id, self.column.id))
