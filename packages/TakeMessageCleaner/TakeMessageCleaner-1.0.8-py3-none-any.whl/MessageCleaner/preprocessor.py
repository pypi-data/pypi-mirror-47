...
class PreProcessor:
    ...
    def __set_pt_dictionary(self):
        ...
        self.__pt_dict = self.__read_dictionary(os.path.join(my_path, '/dictionaries/portuguese_errors.json'))
        self.__pt_dict.update(self.__read_dictionary(os.path.join(my_path, '/dictionaries/abbreviations.json')))
