...
class itkFrequencyFunctionF2PD2(itkSpatialFunctionPython.itkSpatialFunctionF2PD2):
    ...
    def RadPerSecToHertz(self, w_rad_per_sec: 'float const &') -> "float":
    ...
    def cast(obj: 'itkLightObject') -> "itkFrequencyFunctionF2PD2 *":
...
def itkFrequencyFunctionF2PD2_cast(obj: 'itkLightObject') -> "itkFrequencyFunctionF2PD2 *":
...
class itkFrequencyFunctionF3PD3(itkSpatialFunctionPython.itkSpatialFunctionF3PD3):
    ...
    def cast(obj: 'itkLightObject') -> "itkFrequencyFunctionF3PD3 *":
...
def itkFrequencyFunctionF3PD3_cast(obj: 'itkLightObject') -> "itkFrequencyFunctionF3PD3 *":
