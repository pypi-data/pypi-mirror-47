...
class itkImageCD2(itkImagePython.itkImageBase2):
    ...
    def GetPixelContainer(self, *args) -> "itk::ImportImageContainer< unsigned long long,std::complex< double > > const *":
        """
        GetPixelContainer(itkImageCD2 self) -> itk::ImportImageContainer< unsigned long long,std::complex< double > >
        GetPixelContainer(itkImageCD2 self) -> itk::ImportImageContainer< unsigned long long,std::complex< double > > const *
        """
        return _itkPhaseCorrelationOperatorPython.itkImageCD2_GetPixelContainer(self, *args)


    def SetPixelContainer(self, container: 'itk::ImportImageContainer< unsigned long long,std::complex< double > > *') -> "void":
        """SetPixelContainer(itkImageCD2 self, itk::ImportImageContainer< unsigned long long,std::complex< double > > * container)"""
...
class itkImageCD3(itkImagePython.itkImageBase3):
    ...
    def GetPixelContainer(self, *args) -> "itk::ImportImageContainer< unsigned long long,std::complex< double > > const *":
        """
        GetPixelContainer(itkImageCD3 self) -> itk::ImportImageContainer< unsigned long long,std::complex< double > >
        GetPixelContainer(itkImageCD3 self) -> itk::ImportImageContainer< unsigned long long,std::complex< double > > const *
        """
        return _itkPhaseCorrelationOperatorPython.itkImageCD3_GetPixelContainer(self, *args)


    def SetPixelContainer(self, container: 'itk::ImportImageContainer< unsigned long long,std::complex< double > > *') -> "void":
        """SetPixelContainer(itkImageCD3 self, itk::ImportImageContainer< unsigned long long,std::complex< double > > * container)"""
...
class itkImageSourceICD2(ITKCommonBasePython.itkProcessObject):
    ...
    def MakeOutput(self, *args) -> "itkDataObject_Pointer":
        """
        MakeOutput(itkImageSourceICD2 self, unsigned long long idx) -> itkDataObject_Pointer
...
class itkImageSourceICD3(ITKCommonBasePython.itkProcessObject):
    ...
    def MakeOutput(self, *args) -> "itkDataObject_Pointer":
        """
        MakeOutput(itkImageSourceICD3 self, unsigned long long idx) -> itkDataObject_Pointer
