...
class TestPreprocessMethods(unittest.TestCase):
    ...
    def _test_single_doc_dump_and_load(self, doc):
        ...
        for src, tgt in zip(doc.sentences, d.sentences):
            ...
            for src_phrase, tgt_phrase in zip(src.phrases, tgt.phrases):
                self.assertEqual(src_phrase.start, tgt_phrase.start)
                self.assertEqual(src_phrase.end, tgt_phrase.end)
                self.assertEqual(src_phrase.tag, tgt_phrase.tag)
