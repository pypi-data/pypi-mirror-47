...
setup(
    ...
    description="Install All tinc",
    install_requires=REQUIREMENTS,
    license="MIT license",
    long_description=README + '\n\n' + HISTORY,
    include_package_data=True,
    keywords='pyarchops_tinc',
    packages=['pyarchops_tinc'],
    setup_requires=SETUP_REQUIREMENTS,
    test_suite='tests',
    tests_require=TEST_REQUIREMENTS,
    url='https://github.com/pyarchops/tinc',
    version=find_version('pyarchops_tinc', '__init__.py'),
    zip_safe=False,
)
