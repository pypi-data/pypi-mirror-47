...
"<p>Example: var1=1 var2=\"hello world\"</p>"))
        ...
        self.groupBox_2.setTitle(_translate("DebuggerGeneralPage", "Background Colours"))
        self.backgroundChangedButton.setToolTip(_translate("DebuggerGeneralPage", "Select the background colour for changed items."))
        ...
        self.backgroundNewButton.setToolTip(_translate("DebuggerGeneralPage", "Select the background colour for elements which are loaded for the first time."))
