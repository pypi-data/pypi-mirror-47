...
function GetOciSubcommands_network() {
    $ociSubcommands = @{
        ...
        'network nat-gateway' = 'create delete get list update'
        'network private-ip' = 'delete get list update'
        'network public-ip' = 'create delete get list update'
        'network remote-peering-connection' = 'connect create delete get list update'
        ...
        'network service-gateway' = 'attach create delete detach get list update'
        'network subnet' = 'create delete get list update'
        'network vcn' = 'create delete get list update'
        'network virtual-circuit' = 'create delete get list update'
...
function GetOciCommandsToLongParams_network() {
    $ociCommandsToLongParams = @{
        'network cpe create' = 'compartment-id defined-tags display-name freeform-tags from-json help ip-address'
        ...
        'network cpe update' = 'cpe-id defined-tags display-name force freeform-tags from-json help if-match'
        'network cross-connect create' = 'compartment-id cross-connect-group-id customer-reference-name display-name far-cross-connect-or-cross-connect-group-id from-json help location-name max-wait-seconds near-cross-connect-or-cross-connect-group-id port-speed-shape-name wait-for-state wait-interval-seconds'
        ...
        'network cross-connect update' = 'cross-connect-id customer-reference-name display-name from-json help if-match is-active max-wait-seconds wait-for-state wait-interval-seconds'
        'network cross-connect-group create' = 'compartment-id customer-reference-name display-name from-json help max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'network cross-connect-group update' = 'cross-connect-group-id customer-reference-name display-name from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'network ip-sec-tunnel update' = 'bgp-session-config display-name force from-json help if-match ipsc-id max-wait-seconds routing tunnel-id wait-for-state wait-interval-seconds'
        ...
        'network remote-peering-connection create' = 'compartment-id display-name drg-id from-json help max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'network remote-peering-connection update' = 'display-name from-json help if-match max-wait-seconds remote-peering-connection-id wait-for-state wait-interval-seconds'
        ...
        'network service-gateway create' = 'compartment-id defined-tags display-name freeform-tags from-json help max-wait-seconds services vcn-id wait-for-state wait-interval-seconds'
        ...
        'network service-gateway update' = 'block-traffic defined-tags display-name force freeform-tags from-json help if-match max-wait-seconds service-gateway-id services wait-for-state wait-interval-seconds'
        ...
        'network virtual-circuit create' = 'bandwidth-shape-name compartment-id cross-connect-mappings customer-bgp-asn display-name from-json gateway-id help max-wait-seconds provider-name provider-service-id provider-service-key-name provider-service-name public-prefixes region type wait-for-state wait-interval-seconds'
        ...
        'network virtual-circuit update' = 'bandwidth-shape-name cross-connect-mappings customer-bgp-asn display-name force from-json gateway-id help if-match max-wait-seconds provider-service-key-name provider-state reference-comment virtual-circuit-id wait-for-state wait-interval-seconds'
        ...
        'network vnic update' = 'defined-tags display-name force freeform-tags from-json help hostname-label if-match max-wait-seconds skip-source-dest-check vnic-id wait-for-state wait-interval-seconds'
    }
