...
function GetOciSubcommands_iam() {
    $ociSubcommands = @{
        ...
        'iam tag-default' = 'create delete get list update'
        'iam tag-namespace' = 'change-compartment create get list reactivate retire update'
...
function GetOciCommandsToLongParams_iam() {
    $ociCommandsToLongParams = @{
        ...
        'iam tag-default create' = 'compartment-id from-json help max-wait-seconds tag-definition-id value wait-for-state wait-interval-seconds'
        ...
        'iam tag-default update' = 'from-json help if-match max-wait-seconds tag-default-id value wait-for-state wait-interval-seconds'
