...
function GetOciSubcommands_compute() {
    $ociSubcommands = @{
        'compute' = 'boot-volume-attachment console-history device image instance instance-console-connection pic shape vnic-attachment volume-attachment'
        ...
        'compute volume-attachment' = 'attach attach-paravirtualized-volume detach get list'
    }
...
function GetOciCommandsToLongParams_compute() {
    $ociCommandsToLongParams = @{
        ...
        'compute instance attach-vnic' = 'assign-public-ip defined-tags freeform-tags from-json help hostname-label instance-id nic-index private-ip skip-source-dest-check subnet-id vnic-display-name wait'
        ...
        'compute instance launch' = 'agent-config assign-public-ip availability-domain boot-volume-size-in-gbs compartment-id defined-tags display-name extended-metadata fault-domain freeform-tags from-json help hostname-label image-id ipxe-script-file is-pv-encryption-in-transit-enabled max-wait-seconds metadata private-ip shape skip-source-dest-check source-boot-volume-id source-details ssh-authorized-keys-file subnet-id user-data-file vnic-display-name wait-for-state wait-interval-seconds'
