...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-database create' = 'admin-password compartment-id cpu-core-count data-storage-size-in-tbs db-name db-workload defined-tags display-name freeform-tags from-json help license-model max-wait-seconds wait-for-state wait-interval-seconds'
        'db autonomous-database create-from-clone' = 'admin-password clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-workload defined-tags display-name freeform-tags from-json help license-model max-wait-seconds source-id wait-for-state wait-interval-seconds'
        ...
        'db autonomous-database update' = 'admin-password autonomous-database-id cpu-core-count data-storage-size-in-tbs defined-tags display-name force freeform-tags from-json help if-match license-model max-wait-seconds wait-for-state wait-interval-seconds whitelisted-ips'
