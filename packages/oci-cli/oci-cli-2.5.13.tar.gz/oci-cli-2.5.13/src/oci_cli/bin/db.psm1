...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        'db' = 'autonomous-data-warehouse autonomous-data-warehouse-backup autonomous-database autonomous-database-backup backup data-guard-association database external-backup-job node patch patch-history system system-shape version'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-database create' = 'admin-password compartment-id cpu-core-count data-storage-size-in-tbs db-name db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled license-model max-wait-seconds wait-for-state wait-interval-seconds'
        'db autonomous-database create-from-clone' = 'admin-password clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled license-model max-wait-seconds source-id wait-for-state wait-interval-seconds'
        ...
        'db autonomous-database list' = 'all compartment-id db-workload display-name from-json help lifecycle-state limit page page-size sort-by sort-order'
        'db autonomous-database restore' = 'autonomous-database-id from-json help if-match max-wait-seconds timestamp wait-for-state wait-interval-seconds'
        ...
        'db autonomous-database update' = 'admin-password autonomous-database-id cpu-core-count data-storage-size-in-tbs defined-tags display-name force freeform-tags from-json help if-match is-auto-scaling-enabled license-model max-wait-seconds wait-for-state wait-interval-seconds whitelisted-ips'
