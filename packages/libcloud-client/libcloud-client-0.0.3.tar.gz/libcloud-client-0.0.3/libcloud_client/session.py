...
from libcloud_client import config
...
class Session(object):
    """
    This is a custom LibCloud session used to
    ...
    def __init__(self, aws_access_key_id='accesskey', aws_secret_access_key='secretkey',
                 ...
                 botocore_session=None, profile_name=None, libcloud_host=None):
        self.env = 'local'
        self.aws_access_key_id = aws_access_key_id
        self.aws_secret_access_key = aws_secret_access_key
        self.aws_session_token = aws_session_token
        self.region_name = region_name
        self._service_endpoint_mapping = config.get_service_endpoints(libcloud_host)
