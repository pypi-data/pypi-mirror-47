...
def For_Each(ctx, vec, f, begin =0, end =-1):
	native.n_for_each(ctx.m_cptr, vec.m_cptr, f.m_cptr, begin, end)
...
def Replace_If(ctx, vec, pred, new_value, begin =0, end =-1):
	native.n_replace_if(ctx.m_cptr, vec.m_cptr, pred.m_cptr, new_value.m_cptr, begin, end)
...
def Replace_Copy_If(ctx, vec_in, vec_out, pred, new_value, begin_in =0, end_in =-1, begin_out=0):
	native.n_replace_copy_if(ctx.m_cptr, vec_in.m_cptr, vec_out.m_cptr, pred.m_cptr, new_value.m_cptr, begin_in, end_in, begin_out)

def Adjacent_Difference(ctx, vec_in, vec_out, binary_op=None, begin_in = 0, end_in = -1, begin_out = 0):
	cptr_binary_op = None
	if binary_op!=None:
		cptr_binary_op = binary_op.m_cptr
	native.n_adjacent_difference(ctx.m_cptr, vec_in.m_cptr, vec_out.m_cptr, cptr_binary_op, begin_in, end_in, begin_out)
...
def Tabulate(ctx, vec, op, begin =0, end =-1):
	native.n_tabulate(ctx.m_cptr, vec.m_cptr, op.m_cptr, begin, end)

def Transform(ctx, vec_in, vec_out, op, begin_in = 0, end_in = -1, begin_out = 0):
	native.n_transform(ctx.m_cptr, vec_in.m_cptr, vec_out.m_cptr, op.m_cptr, begin_in, end_in, begin_out)

def Transform_Binary(ctx, vec_in1, vec_in2, vec_out, op, begin_in1 = 0, end_in1 = -1, begin_in2 = 0, begin_out = 0):
	native.n_transform_binary(ctx.m_cptr, vec_in1.m_cptr, vec_in2.m_cptr, vec_out.m_cptr, op.m_cptr, begin_in1, end_in1, begin_in2, begin_out)

def Transform_If(ctx, vec_in, vec_out, op, pred, begin_in = 0, end_in = -1, begin_out = 0):
	native.n_transform_if(ctx.m_cptr, vec_in.m_cptr, vec_out.m_cptr, op.m_cptr, pred.m_cptr, begin_in, end_in, begin_out)

def Transform_If_Stencil(ctx, vec_in, vec_stencil, vec_out, op, pred, begin_in = 0, end_in = -1, begin_stencil=0, begin_out = 0):
	native.n_transform_if_stencil(ctx.m_cptr, vec_in.m_cptr, vec_stencil.m_cptr, vec_out.m_cptr, op.m_cptr, pred.m_cptr, begin_in, end_in, begin_stencil, begin_out)
...
def Transform_Binary_If_Stencil(ctx, vec_in1, vec_in2, vec_stencil, vec_out, op, pred, begin_in1 = 0, end_in1 = -1, begin_in2 = 0, begin_stencil=0, begin_out = 0):
	native.n_transform_binary_if_stencil(ctx.m_cptr, vec_in1.m_cptr, vec_in2.m_cptr, vec_stencil.m_cptr, vec_out.m_cptr, op.m_cptr, pred.m_cptr, begin_in1, end_in1, begin_in2, begin_stencil, begin_out)
