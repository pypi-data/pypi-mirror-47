...
class SNPselect (object):
    ...
    """
    This class allow to select SNPs based on their qulaity and depth. It can handle data from mpileup or gatk vcf files
    """
                ...
                if eachUnit == content[0]:
                    ...
                    if quality >= self.QUAL:
                        ...
                        if origin == 'samtools':
                            ...
                            if nbREADalt >= nbREADref and depth >= self.DEPTH:
                                count_DEPTH += 1
                                if nbREADref == 0:
                                    ratio = 1.0
                                    extracted_data.append([coordiantes, REF, ALT, depth, nbREADref, nbREADalt, float(
