...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    model_uid = 'german-credit-risk-tutorial-BiasQA'
    scoring_records = 12
    feedback_records = 18
    data_df = pd.read_csv(
    ...
    def test_09_score_and_log_payload(self):
        ...
        scoring_payload = {'requestInputTable': [{'name': 'credit_risk_scoring.csv', 'requestInputRow': [{'input': [
    ...
    def test_10_stats_on_payload_logging_table(self):
        ...
        self.assertTrue('$N-Risk' in str(payload_table_content))
    ...
    def test_13_send_feedback_data(self):
        ...
        dict_record = {'LoanAmount': '1889', 'ExistingSavings': '100_to_500', 'OwnsProperty': 'savings_insurance', 'Risk': 'Risk',
         'OthersOnLoan': 'none', 'Telephone': 'none', 'CurrentResidenceDuration': '3', 'Age': '32',
         'InstallmentPlans': 'none', 'EmploymentDuration': 'less_1', 'ExistingCreditsCount': '1', 'Sex': 'female',
         'LoanPurpose': 'other', 'CheckingStatus': '0_to_200', 'CreditHistory': 'credits_paid_to_date',
         'Housing': 'own', 'Job': 'skilled', 'LoanDuration': '31', 'InstallmentPercent': '3', 'Dependents': '1',
         'ForeignWorker': 'yes'}
    ...
    def test_26_setup_fairness_monitoring(self):
        ...
        TestAIOpenScaleClient.subscription.fairness_monitoring.enable(
            ...
            deployment_uid="german_credit_risk_tutorial_BiasQA",
