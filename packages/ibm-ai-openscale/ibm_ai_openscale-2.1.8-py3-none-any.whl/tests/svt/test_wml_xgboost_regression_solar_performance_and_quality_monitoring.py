...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_05_prepare_deployment(self):
        ...
        deployment_name = "AIOS Xgboost Solar Deployment"
        ...
        published_model_details = self.wml_client.repository.store_model(model=final_gb, meta_props=model_meta_props)
