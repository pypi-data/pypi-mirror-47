...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_04_get_assets(self):
        if "ICP" in get_env():
            TestAIOpenScaleClient.source_uid = '085460ef94636166aea5800e9ea26168'
        else:
    ...
    def test_05_subscribe_azure_asset(self):
        subscription = TestAIOpenScaleClient.ai_client.data_mart.subscriptions.add(
            AzureMachineLearningAsset(
                ...
                feature_columns=['CheckingStatus', 'LoanDuration', 'CreditHistory', 'LoanPurpose', 'LoanAmount', 'ExistingSavings', 'EmploymentDuration', 'InstallmentPercent',
                                 'Sex', 'OthersOnLoan', 'CurrentResidenceDuration', 'OwnsProperty', 'Age', 'InstallmentPlans', 'Housing', 'ExistingCreditsCount',
                                 'Job', 'Dependents', 'Telephone', 'ForeignWorker'],
                categorical_columns=['CheckingStatus', 'CreditHistory', 'LoanPurpose', 'ExistingSavings', 'EmploymentDuration',
    ...
    def test_24_get_explainability_details(self):
        skip_on_sanity_run()
    ...
    def test_32_get_performance_metrics(self):
    ...
    def test_33_disable_payload_logging_and_performance_monitoring(self):
