      ...
      `;const e=Object(s.b)(this.cloudStatus.alexa_entities),t=this._getEntityFilterFunc(this.cloudStatus.alexa_entities),i=this._isInitialExposed||new Set,n=void 0===this._isInitialExposed;let o=0;const a=[],c=[];return this._entities.forEach(s=>{const d=this.hass.states[s.entity_id],l=this._entityConfigs[s.entity_id]||{},p=e?w(l):t(s.entity_id);p&&(o++,n&&i.add(s.entity_id)),(i.has(s.entity_id)?a:c).push(r.e`
        <ha-card>
          <div class="card-content">
            ...
            >
              ${s.interfaces.filter(e=>!k.includes(e)).map(e=>e.replace("Alexa.","").replace("Controller","")).join(", ")}
            </state-info>
            <paper-toggle-button
