/*! For license information please see chunk.f1d0fe0067424130889c.js.LICENSE */
(window.webpackJsonp=window.webpackJsonp||[]).push([[8],{109:function(e,r,t){"use strict";t.d(r,"a",function(){return a});t(5);const a={properties:{value:{type:Number,value:0,notify:!0,reflectToAttribute:!0},min:{type:Number,value:0,notify:!0},max:{type:Number,value:100,notify:!0},step:{type:Number,value:1,notify:!0},ratio:{type:Number,value:0,readOnly:!0,notify:!0}},observers:["_update(value, min, max, step)"],_calcRatio:function(e){return(this._clampValue(e)-this.min)/(this.max-this.min)},_clampValue:function(e){return Math.min(this.max,Math.max(this.min,this._calcStep(e)))},_calcStep:function(e){if(e=parseFloat(e),!this.step)return e;var r=Math.round((e-this.min)/this.step);return this.step<1?r/(1/this.step)+this.min:r*this.step+this.min},_validateValue:function(){var e=this._clampValue(this.value);return this.value=this.oldValue=isNaN(e)?this.oldValue:e,this.value!==e},_update:function(){this._validateValue(),this._setRatio(100*this._calcRatio(this.value))}}},145:function(e,r,t){"use strict";t(5),t(44);var a=t(119),i=t(57),n=t(6),o=t(4),s=t(62);const l=o.a`<style>
  :host {
...
//# sourceMappingURL=chunk.f1d0fe0067424130889c.js.map