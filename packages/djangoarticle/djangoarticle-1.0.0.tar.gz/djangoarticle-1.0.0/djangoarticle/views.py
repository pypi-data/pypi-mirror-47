...
class ArticleListDashboard(LoginRequiredMixin, ListView):
    ...
    template_name = 'djangoadmin/article_list_dashboard.html'
...
class CategoryListDashboard(LoginRequiredMixin, ListView):
    ...
    template_name = 'djangoadmin/category_list_dashboard.html'
...
class ArticleListView(ListView):
    model = ArticleModelScheme
    template_name = 'djangoarticle/article_list_view.html'
    context_object_name = 'article_filter'

    def get_queryset(self):
        return ArticleModelScheme.objects.filter_publish()
...
class CategoryDetailView(ListView):
    model = ArticleModelScheme
    template_name = 'djangoarticle/category_detail_view.html'
...
class ArticleDetailView(DetailView):
    model = ArticleModelScheme
    template_name = 'djangoarticle/article_detail_view.html'
...
class CategoryCreateView(LoginRequiredMixin, SuccessMessageMixin, CreateView):
    ...
    template_name = 'djangoadmin/category_create_view_form.html'
...
class CategoryDeleteView(LoginRequiredMixin, DeleteView):
    ...
    template_name = 'djangoadmin/category_delete_view_form.html'
    success_url = reverse_lazy('djangoarticle:category_list_dashboard')
    slug_url_kwarg = 'category_slug'
...
class ArticleCreateView(LoginRequiredMixin, SuccessMessageMixin, CreateView):
    ...
    template_name = 'djangoadmin/article_create_view_form.html'
...
class ArticleDeleteView(LoginRequiredMixin, DeleteView):
    model = ArticleModelScheme
    context_object_name = 'article_detail'
    template_name = 'djangoadmin/article_delete_view_form.html'
    success_url = reverse_lazy('djangoarticle:article_list_dashboard')
    slug_url_kwarg = 'article_slug'
