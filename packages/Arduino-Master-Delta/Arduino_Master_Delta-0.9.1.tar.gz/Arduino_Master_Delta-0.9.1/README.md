# Arduino_Master_Delta Version 0.9.1
___
...
#### >>> Bug in filter function that prevented the use of farFrom, closeTo, maxDeviation and minDeviation parameters together **_rectified_**.
___
___
# Intro:
