zhulong_diqu_dict = {
        ...
        'neimenggu': ['baotou', 'bayannaoer', 'chifeng', 'eeduosi', 'huhehaote', 'hulunbeier', 'manzhouli', 'neimenggu',
                      'tongliao', 'wuhai', 'wulanchabu', 'xilinguolemeng', 'xinganmeng'],
        ...
        'chongqing': ['yongchuan'], 'shanxi': ['chenzhou', 'shanxi', 'weinan', 'xian', 'xianyang', 'yanan'],
        'xinjiang': ['beitun', 'kezhou', 'wulumuqi', 'xinjiang', 'akesu'],
        'ningxia': ['guyuan', 'ningxia', 'yinchuan'],
        'jiangxi': ['dexing', 'fengcheng', 'fuzhou', 'ganzhou', 'gaoan', 'jian', 'jiangxi', 'jingdezhen', 'jinggangshan',
        ...
        'henan': ['anyang', 'dengfeng', 'gongyi', 'hebi', 'jiaozhuo', 'jiyuan', 'jiyuan1', 'kaifeng', 'linzhou', 'luohe',
                  ...
                  'zhengzhou', 'zhoukou', 'zhumadian'], 'shanxi1': ['shanxi'], 'xizang': ['lasa', 'rikaze', 'xizang'],
        ...
        'hunan': ['changde', 'changsha', 'chenzhou', 'hengyang', 'huaihua', 'liling', 'liuyang', 'loudi', 'shaoyang',
        ...
        'gansu': ["baiyin", "dingxi", "gansu", "gansu2", "jiayuguan", "jiuquan", "lanzhou", "longnan", "pingliang", "qingyang", "tianshui", "wuwei",
                  "zhangye", ]

    }

# q, m = 0, 0
# for i in zhulong_diqu_dict:
#     m += 1
#     for k in zhulong_diqu_dict[i]:
#         print(k)
#         q += 1
# print(q, m)
