...
# url='http://117.78.26.203:8080/jyxx/001001/secondpage.html?title=&categornum=001001'
# driver.get(url)

def f1(driver,num):
    locator=(By.XPATH,"//ul[@id='resultList']/li[1]//a")
    ...
    if num != cnum:
        val=driver.find_element_by_xpath("//ul[@id='resultList']/li[1]//a").get_attribute('onclick')
        ...
        locator=(By.XPATH,"//ul[@id='resultList']/li[1]//a[not(contains(@onclick,'%s'))]"%val)
    ...
    div=soup.find("ul",id="resultList")
    lis=div.find_all("li")
...
if __name__=="__main__":
    work(conp=["postgres","since2015",'192.168.3.171',"gansu","zhangye"],headless=False,num=1)