...
import json
from zhulong.util.etl import gg_meta,gg_html,est_meta,est_html,est_tbs
...
["qsy_zhaobiao_gg","http://www.gzjyfw.gov.cn/gcms/queryContent.jspx?title=&businessCatalog=GQZB&businessType=JYGG&inDates=800&ext=&origin=ALL",["name","href","ggstart_time","info"],f1,f2],


]

def work(conp,**args):
    est_meta(conp,data=data,diqu="贵州省省会",**args)
