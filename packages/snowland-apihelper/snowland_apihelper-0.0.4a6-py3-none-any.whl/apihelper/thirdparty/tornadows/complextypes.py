...
from apihelper.thirdparty import tornadows
...
def xsd2dict(xsd, namespace='xsd'):
    ...
    types = ['xsd:integer', 'xsd:decimal', 'xsd:double', 'xsd:float', 'xsd:duration', 'xsd:date', 'xsd:time',
             'xsd:dateTime', 'xsd:string', 'xsd:boolean']
    dct = {}
