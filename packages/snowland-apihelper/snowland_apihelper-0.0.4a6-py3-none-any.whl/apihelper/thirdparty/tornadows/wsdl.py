...
class Wsdl:
    ...
    def createWsdl(self):
        ...
        for wsdl_data in self._methods:
            ...
            elif isinstance(self._elementInput, list) or inspect.isclass(self._elementInput) and issubclass(
                    self._elementInput, xmltypes.PrimitiveType):
                typeInput = self._elementNameInput + method
            ...
            if inspect.isclass(self._elementOutput) and issubclass(self._elementOutput, complextypes.ComplexType):
                ...
                types += '<%s:element name="%s" type="tns:%s"/>' % (
                namespace, typeOutput, self._elementOutput.getName())
            ...
            elif isinstance(self._elementOutput, list) or inspect.isclass(self._elementOutput) and issubclass(
                    self._elementOutput, xmltypes.PrimitiveType):
                typeOutput = self._elementNameOutput + method
