...
class QueryDataGeneratorFactory(object):
    def __init__(self, processes, use_threads, cache_folder, cache_limit, data_callback, volume_id, batch_size, seed, drop_last):
    ...
    def create(self, query, shuffle):
        gen = QueryDataGenerator(self, query, shuffle)
...
class QueryDataGenerator(_QueryDataGenerator):
    ...
    def __getstate__(self):
        ...
        del_inner_state_prop('__data_callback')
