...
class Networks(Base):
	...
	def Bgpv4RouteRange(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.bgpv4routerange.bgpv4routerange.Bgpv4RouteRange)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.bgpv4routerange.bgpv4routerange import Bgpv4RouteRange
	...
	def Bgpv6RouteRange(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.bgpv6routerange.bgpv6routerange.Bgpv6RouteRange)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.bgpv6routerange.bgpv6routerange import Bgpv6RouteRange
	...
	def Ospfv2RouteRange(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv2routerange.ospfv2routerange.Ospfv2RouteRange)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv2routerange.ospfv2routerange import Ospfv2RouteRange
	...
	def Ospfv2SummaryRange(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv2summaryrange.ospfv2summaryrange.Ospfv2SummaryRange)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv2summaryrange.ospfv2summaryrange import Ospfv2SummaryRange
	...
	def Ospfv2ExternalRange(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.ospfv2externalrange.Ospfv2ExternalRange)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv2externalrange.ospfv2externalrange import Ospfv2ExternalRange
	...
	def Ospfv2NssaRange(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv2nssarange.ospfv2nssarange.Ospfv2NssaRange)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv2nssarange.ospfv2nssarange import Ospfv2NssaRange
	...
	def Ospfv3RouteRange(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv3routerange.ospfv3routerange.Ospfv3RouteRange)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv3routerange.ospfv3routerange import Ospfv3RouteRange
	...
	def Ospfv3InterAreaPrefixRange(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv3interareaprefixrange.ospfv3interareaprefixrange.Ospfv3InterAreaPrefixRange)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv3interareaprefixrange.ospfv3interareaprefixrange import Ospfv3InterAreaPrefixRange
	...
	def Ospfv3IntraAreaPrefixRange(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv3intraareaprefixrange.ospfv3intraareaprefixrange.Ospfv3IntraAreaPrefixRange)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv3intraareaprefixrange.ospfv3intraareaprefixrange import Ospfv3IntraAreaPrefixRange
	...
	def Ospfv3AsExternalPrefixRange(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv3asexternalprefixrange.ospfv3asexternalprefixrange.Ospfv3AsExternalPrefixRange)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.ospfv3asexternalprefixrange.ospfv3asexternalprefixrange import Ospfv3AsExternalPrefixRange
	...
	def IsisRouteRange(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.isisrouterange.isisrouterange.IsisRouteRange)
		"""
		from openhltest_client.openhltest.sessions.config.devicegroups.simulatednetworks.networks.isisrouterange.isisrouterange import IsisRouteRange
	...
	def read(self, Name=None):
		"""Get `networks` resource(s). Returns all resources from the server if `Name` is not specified
