...
class SourceAddressList(Base):
	...
	def Address(self):
		...
		Returns:
			obj(openhltest_client.openhltest.sessions.config.porttraffic.frames.igmpv3query.sourceaddresslist.address.address.Address)
		"""
		from openhltest_client.openhltest.sessions.config.porttraffic.frames.igmpv3query.sourceaddresslist.address.address import Address
