...
Arguments:
  ...
  -ou OU      Boolean importe les utilisateurs
  -og OG      Boolean importe les groupes
  -ob OB      Boolean importe les bureaux
  -oc OC      Boolean importe les circuits
  -ot OT      Boolean importe les types et sous-types
  -om OM      Boolean importe les metadatas
  -oq OQ      Boolean importe les calques
  -oa OA      Boolean importe les advanced
