...
### Ajouts
- Modification de la fonction `ldapsearch`: la requête qui liste les utilisateurs est lancée sans caractère d'échappement.

## [0.9.9] - 2019-05-06

### Ajouts
- Modification de la fonction `count-files` qui prend en compte les parapheur multitenant.
