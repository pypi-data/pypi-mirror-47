...
setuptools.setup(
    name="cuishuang",                                     # 包的分发名称，使用字母、数字、_、-
    version="0.0.1",                                        # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="fliter",                                       # 作者名字
    author_email="i@dashen.tech",                      # 作者邮箱
    description="我的第一个python包",                            # 包的简介描述
    ...
    url="http://www.dashen.tech",                              # 项目开源地址，我这里写的是同性交友官网，大家可以写自己真实的开源网址
