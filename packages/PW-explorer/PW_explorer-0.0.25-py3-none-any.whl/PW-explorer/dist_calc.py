...
def sym_diff_dist(pw_id_1, pw_id_2, relations, dfs, pws, rls_to_use: list=None):
    ...
    for rl_id in rls_to_use:
        redundant_cols = PWEQuery.redundant_column(expected_pws=len(pws), dfs=dfs, rl_name=rl_id,
        ...
        x1 = PWEQuery.difference_both_ways(dfs=dfs, rl_name=rl_id, pw_id_1=pw_id_1, pw_id_2=pw_id_2,
...
def euler_overlap_diff_dist(pw_id_1, pw_id_2, rl_id, col_name, dfs, pws, relations):
    ...
    x1 = PWEQuery.freq(total_num_pws=len(pws), dfs=dfs, rl_name=rl_id, col_names=[col_name], values=['"><"'],
                       pws_to_consider=[pw_id_1], do_print=False)[1][0]
    x2 = PWEQuery.freq(total_num_pws=len(pws), dfs=dfs, rl_name=rl_id, col_names=[col_name], values=['"><"'],
