...
class KeywordTree:
    """
    A naïve text classifier of decision-tree-like structure, based on
    ...
    def query(self, q, tokenizer=None):
        """
        Performs a query.
        ...
        Returns:
            - List of values from nodes that were matched.
        """
        if tokenizer is None:
            tokenizer = self.tokenizer
        return self.root.query(tokenizer(q))
...
class KeywordTreeNode:
    ...
    def query(self, tokens):
        ...
        Returns:
            Array of values from leaf nodes that were selected.
        """
