...
def execute(**kwargs):
    ...
    EXP_DEFS  =\
    {
      ...
      'BASE_ITER_ADV_EFERA5':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False},
      'BASE_ITER_ADV_EFERA5_CCERA5':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False},
      'BASE_ITER_ADV_EFERAI':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False},

        'BASE_ITER_SHR_ADV_EFERAI':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False},
        'BASE_ITER_SHR_ADV_EFERA5_B03':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False,'beta':0.3,'sw_shearwe': True},
        'BASE_ITER_SHR_ADV_EFERA5':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False,'sw_shearwe': True},
        'BASE_ITER_SHR_ADV_EFERA5_CCERA5':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False,'sw_shearwe': True},

        'BASE_ITER_SHR_ADV':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False,'sw_shearwe': True},
        'BASE_ITER_SHR_ADV_B03':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False,'beta':0.3,'sw_shearwe': True},
        'BASE_ITER_SHR':{'sw_ac' : [],'sw_ap': True,'sw_lit': False,'sw_shearwe': True},

        'BASE_ITER_ADV_EFERA5_B05':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False,'beta':0.5},
        'BASE_ITER_ADV_EFERA5_B09':{'sw_ac' : ['adv',],'sw_ap': True,'sw_lit': False,'beta':0.9},
    ...
    for iexpname,expid in enumerate(experiments):
        ...
        elif '_EFERAI' in expname:
            globaldata.sources = {**globaldata.sources,**{
                    "ERAINT:sshf" : '/user/data/gent/gvo000/gvo00090/EXT/data/ERA-INTERIM/by_var_nc/sshf_3hourly/sshf_*_3hourly.nc',
                    "ERAINT:slhf" : '/user/data/gent/gvo000/gvo00090/EXT/data/ERA-INTERIM/by_var_nc/slhf_3hourly/slhf_*_3hourly.nc',
                    }}

        if '_CCERA5' in expname:
            globaldata.sources.pop('ERAINT:cc',None)
            globaldata.sources = {**globaldata.sources,**{
                    "ERA5:cc" : '/user/data/gent/gvo000/gvo00090/EXT/data/ERA5/by_var_nc/tcc_1hourly/tcc_*_1hourly.nc:tcc',
                    }}

        globaldata.sources = {**globaldata.sources,**{
             "ERA5:t2m_daymax" : '/data/gent/vo/000/gvo00090/D2D/data/ERA5/by_var_nc/t2m_1hourly_for_t2m_daymax.nc:t2m',
             "ERA5:midsummermonth" : '/data/gent/vo/000/gvo00090/D2D/data/ERA5/by_var_nc/t2m_1hourly_idx_for_t2m_daymax_mean3month_is_max.nc:t2m',
             # "ERA5:t2m_afternoon" : '/data/gent/vo/000/gvo00090/EXT/data/ERA5/by_var_nc/t2m_1hourly/t2m_*.nc:t2m',
             "ERA5:blpt_afternoon" : '/data/gent/vo/000/gvo00090/EXT/data/ERA5/by_var_nc/blpt_1hourly/blpt_*.nc:t',
             "ERA5:blq_afternoon" : '/data/gent/vo/000/gvo00090/EXT/data/ERA5/by_var_nc/blq_1hourly/blq_*.nc:q',
             "ERA5:blh_afternoon" : '/data/gent/vo/000/gvo00090/EXT/data/ERA5/by_var_nc/blh_1hourly/blh_*.nc:blh',
             # "ERA5:t2m" : '/data/gent/vo/000/gvo00090/EXT/data/ERA5/by_var_nc/t2m_1hourly/t2m_*.nc:t2m',
             "ERA5:blpt" : '/data/gent/vo/000/gvo00090/EXT/data/ERA5/by_var_nc/blpt_1hourly/blpt_*.nc:t',
             "ERA5:blq" : '/data/gent/vo/000/gvo00090/EXT/data/ERA5/by_var_nc/blq_1hourly/blq_1hourly_*.nc:q',
             "ERA5:blh" : '/data/gent/vo/000/gvo00090/EXT/data/ERA5/by_var_nc/blh_1hourly/blh_1hourly_*.nc:blh',
             "ERA5:blptb" : '/scratch/gent/vo/000/gvo00090/D2D/data/ERA5/by_var_nc/blptb_1hourly/blptb_*.nc:blptb',
             "ERA5:blptw" : '/scratch/gent/vo/000/gvo00090/D2D/data/ERA5/by_var_nc/blptw_1hourly/blptw_*.nc:blptw',
             "ERA5:rh100" : '/scratch/gent/vo/000/gvo00090/D2D/data/ERA5/by_var_nc/rh100_1hourly/rh100_*.nc:rh100',
             "ERA5:HI" : '/scratch/gent/vo/000/gvo00090/D2D/data/ERA5/by_var_nc/HI_1hourly/HI_*.nc:HI',
             "ERA5:blptb_afternoon" : '/scratch/gent/vo/000/gvo00090/D2D/data/ERA5/by_var_nc/blptb_1hourly/blptb_*.nc:blptb',
             "ERA5:blptw_afternoon" : '/scratch/gent/vo/000/gvo00090/D2D/data/ERA5/by_var_nc/blptw_1hourly/blptw_*.nc:blptw',
             "ERA5:rh100_afternoon" : '/scratch/gent/vo/000/gvo00090/D2D/data/ERA5/by_var_nc/rh100_1hourly/rh100_*.nc:rh100',
             "ERA5:HI_afternoon" : '/scratch/gent/vo/000/gvo00090/D2D/data/ERA5/by_var_nc/HI_1hourly/HI_*.nc:HI',
                 }}
        ...
        for istation,current_station in run_stations.iterrows():
            if (int(args.split_by) * int(run_station_chunk)) >= (len(records_morning_station)):
                ...
                for (STNID,chunk,index),record_morning in records_morning_station_chunk.iterrows():
                        ...
                        c4gli_morning.update(source='from_profile_pair', pars={'runtime':runtime})
                
                        c4gli_morning.get_global_input(globaldata,only_keys=['midsummermonth'])


                        datetime_daylight_backup = c4gli_morning.pars.datetime_daylight
                        
                        ldatetime_daylight = c4gli_morning.pars.ldatetime_daylight 
                        datetime_daylight = c4gli_morning.pars.datetime_daylight 
                        ldatetime_6 = pytz.utc.localize(dt.datetime.strptime(ldatetime_daylight.strftime("%Y%m%d"),"%Y%m%d"))+dt.timedelta(hours=6)
                        datetime_6 = ldatetime_6 + (datetime_daylight - ldatetime_daylight)
                        c4gli_morning.pars.datetime_daylight = datetime_6
                        c4gli_morning.get_global_input(globaldata,only_keys=['t2m_daymax'])


                        c4gli_morning.pars.datetime_daylight = datetime_daylight_backup 
                        c4gli_morning.get_global_input(globaldata,only_keys=['blpt','blq','blh','blptb','blptw','HI','rh100'])
                        
                        c4gli_morning.pars.datetime_daylight = datetime_daylight_backup + dt.timedelta(seconds=runtime)
                        c4gli_morning.get_global_input(globaldata,only_keys=['blpt_afternoon','blq_afternoon','blh_afternoon','blptb_afternoon','blptw_afternoon','HI_afternoon','rh100_afternoon'])
                        c4gli_morning.pars.datetime_daylight = datetime_daylight_backup
                        ...
                        if '_EF' in expname:
                            c4gli_morning.get_global_input(globaldata,only_keys=['sshf','slhf'])
                            c4gli_morning.update(source=expname,pars={'EF':c4gli_morning.pars.slhf/(c4gli_morning.pars.sshf+c4gli_morning.pars.slhf)})

                        if '_CC' in expname:
                            c4gli_morning.get_global_input(globaldata,only_keys=['cc',])
