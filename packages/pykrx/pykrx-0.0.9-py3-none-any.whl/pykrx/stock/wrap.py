from pykrx.stock.market import MKD20011
from pykrx.stock.market import MKD30040, MKD30009_0
from pykrx.stock.market import MKD80037
...
class KrxMarket:
    ...
    def get_market_price_change(self, fromdate, todate):
        ...
        df.columns = ['종목명', '티커', '시작일기준가', '종료일종가', '대비',
                      '등락률', '거래량', '거래대금']
        df = df.set_index('티커')
