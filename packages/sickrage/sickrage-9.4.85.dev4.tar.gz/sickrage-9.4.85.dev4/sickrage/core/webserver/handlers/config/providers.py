        ...
        for providerID, provider_obj in sickrage.app.search_providers.all().items():
            try:
                provider_settings = {
                    ...
                    'enable_daily': checkbox_to_value(self.get_body_argument(providerID + '_enable_daily', 0)),
                    'enable_backlog': checkbox_to_value(self.get_body_argument(providerID + '_enable_backlog', 0)),
