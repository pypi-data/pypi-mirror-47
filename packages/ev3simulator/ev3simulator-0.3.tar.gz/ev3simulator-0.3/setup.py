...
setup(
  ...
  description = 'The easiest way to check your program whithout uploading it to ev3. Simplifies debugging and coding.',   # Give a short description about your library
  ...
  download_url = 'https://github.com/haningrisha/ev3simulator/archive/v0.3.tar.gz',    # I explain this later on
