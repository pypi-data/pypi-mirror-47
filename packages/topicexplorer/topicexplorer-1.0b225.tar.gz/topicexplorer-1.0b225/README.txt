...
|AppVeyor Windows build| |GitHub license| |PyPI|
...
1. Go to the `Anaconda website <http://continuum.io/downloads>`__ and
   choose the Python 3.6 Distribution. (Windows users: during
...
2. Install the `Anaconda Python 3.6
...
.. |AppVeyor Windows build| image:: https://ci.appveyor.com/api/projects/status/ynfvy3y832cquixq/branch/master?svg=true
   :target: https://ci.appveyor.com/project/JaimieMurdock/topic-explorer/branch/master
