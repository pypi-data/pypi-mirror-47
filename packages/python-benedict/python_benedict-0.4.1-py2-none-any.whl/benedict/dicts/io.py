...
class IODict(dict):
    ...
    #     return io_util.encode_base64(self, filepath)

    def to_json(self):
        return io_util.encode_json(self)

    # def to_query_string(self, filepath=None):
    #     return io_util.encode_query_string(self, filepath)

    # def to_xml(self, filepath=None):
    #     return io_util.encode_xml(self, filepath)

    # def to_yaml(self, filepath=None):
    #     return io_util.encode_yaml(self, filepath)
