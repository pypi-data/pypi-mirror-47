...
class itkComplexToComplexFFTImageFilterICF2(itkImageToImageFilterBPython.itkImageToImageFilterICF2ICF2):
    ...
    def SetTransformDirection(self, _arg: 'itkComplexToComplexFFTImageFilterICF2::TransformDirectionType const') -> "void":
        ...
        Set/Get the
        direction in which the transform will be applied. By selecting
        FORWARD, this filter will perform a direct, i.e. forward, Fourier
        Transform, By selecting INVERSE, this filter will perform an inverse,
        i.e. backward, Fourier Transform, 
        """
