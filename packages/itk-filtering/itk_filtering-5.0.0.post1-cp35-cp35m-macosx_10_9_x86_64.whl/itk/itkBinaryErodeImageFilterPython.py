...
class itkBinaryErodeImageFilterIF2IF2SE2(itkBinaryDilateImageFilterPython.itkBinaryDilateImageFilterIF2IF2SE2_Superclass):
    ...
    BinaryErodeImageFilter is a binary erosion morphologic operation. This
    ...
    BinaryMorphologyImageFilter Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/Morphology/BinaryErodeImageFilte
    r Erode a binary image
    ...
    def SetErodeValue(self, value: 'float const &') -> "void":
        ...
        PixelType. This is an alias to the ForegroundValue in the superclass.
