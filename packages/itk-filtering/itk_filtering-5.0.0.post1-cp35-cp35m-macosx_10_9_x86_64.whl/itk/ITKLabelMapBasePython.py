...
class itkImageToImageFilterIF2LM2(itkImageSourceLM2):
    ...
    https://www.itk.org/Wiki/ITK/Examples/Developer/ImageFilter Filter an
    image

    https://www.itk.org/Wiki/ITK/Examples/Developer/ImageFilterMultipleInp
    uts Write a filter with multiple inputs of the same type.

    https://www.itk.org/Wiki/ITK/Examples/Developer/ImageFilterMultipleInp
    utsDifferentType Write a filter with multiple inputs of different
    types.

    https://www.itk.org/Wiki/ITK/Examples/Developer/ImageFilterMultipleOut
    puts Write a filter with multiple outputs of the same type.

    https://www.itk.org/Wiki/ITK/Examples/Developer/OilPaintingImageFilter
    Multi-threaded oil painting image filter

    https://www.itk.org/Wiki/ITK/Examples/Developer/ImageFilterMultipleOut
    putsDifferentType Write a filter with multiple outputs of different
    types.
...
class itkLabelMap2(itkImagePython.itkImageBase2):
    ...
    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/ManuallyRemoving
    Labels Remove labels from a LabelMap
    ...
    def AddLabelObject(self, labelObject: 'itkStatisticsLabelObjectUL2') -> "void":
        ...
        Add a label object
        to the image. If a label object already has the label, it is overiden.
    ...
    def GetNumberOfLabelObjects(self) -> "unsigned long":
        ...
        Return the
        numbner of label objects in the image 
        """
    ...
    def Optimize(self) -> "void":
        ...
        Optimize the line
        representation of all the lable objects referenced in the LabelMap 
        """
