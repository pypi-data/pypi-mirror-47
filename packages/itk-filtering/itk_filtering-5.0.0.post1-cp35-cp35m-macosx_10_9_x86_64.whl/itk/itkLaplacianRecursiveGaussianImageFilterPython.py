...
class itkLaplacianRecursiveGaussianImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    https://www.itk.org/Wiki/ITK/Examples/EdgesAndGradients/LaplacianRecur
    siveGaussianImageFilter Compute the Laplacian of Gaussian (LoG) of an
    image

    C++ includes: itkLaplacianRecursiveGaussianImageFilter.h 
    """
