...
class itkDerivativeImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    See:  NeighborhoodIterator Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/EdgesAndGradients/DerivativeImag
    eFilter Compute the derivative of an image in a particular direction

    C++ includes: itkDerivativeImageFilter.h 
    """
    ...
    def SetOrder(self, _arg: 'unsigned int const') -> "void":
        ...
        The output pixel type must
        be signed. Standard get/set macros for filter parameters. 
        """
    ...
    def GenerateInputRequestedRegion(self) -> "void":
        ...
        DerivativeImageFilter needs a larger input requested region than the
        output requested region (larger in the direction of the derivative).
        As such, DerivativeImageFilter needs to provide an implementation for
