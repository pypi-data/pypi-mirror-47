...
class itkVnlForwardFFTImageFilterIF2ICF2(itkForwardFFTImageFilterPython.itkForwardFFTImageFilterIF2ICF2):
    ...
    See:   ForwardFFTImageFilter Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/SpectralAnalysis/VnlForwardFFTIm
    ageFilter Compute the FFT of an image

    https://www.itk.org/Wiki/ITK/Examples/SpectralAnalysis/CrossCorrelatio
    nInFourierDomain Compute the cross-correlation of two images in the
    Fourier domain
