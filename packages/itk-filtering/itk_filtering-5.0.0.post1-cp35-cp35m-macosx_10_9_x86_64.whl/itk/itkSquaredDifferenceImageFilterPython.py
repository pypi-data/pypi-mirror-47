...
class itkSquaredDifferenceImageFilterIF2IF2IF2(itkBinaryGeneratorImageFilterPython.itkBinaryGeneratorImageFilterIF2IF2IF2):
    ...
    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/SquaredDifferenc
    eImageFilter Compute the squared difference of corresponding pixels in
    two images

    C++ includes: itkSquaredDifferenceImageFilter.h 
    """
