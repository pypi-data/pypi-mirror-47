...
class itkHoughTransform2DLinesImageFilterFF(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    See:  LineSpatialObject Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/Conversions/HoughTransform2DLine
    sImageFilter HoughTransform2DLinesImageFilter
