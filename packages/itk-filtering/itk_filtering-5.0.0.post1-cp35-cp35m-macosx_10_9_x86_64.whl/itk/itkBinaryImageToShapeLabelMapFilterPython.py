...
class itkBinaryImageToShapeLabelMapFilterIUC2LM2(ITKLabelMapBasePython.itkImageToImageFilterIUC2LM2):
    ...
    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/BinaryImageToSha
    peLabelMapFilter Label binary regions in an image and get their
    properties

    C++ includes: itkBinaryImageToShapeLabelMapFilter.h 
    """
