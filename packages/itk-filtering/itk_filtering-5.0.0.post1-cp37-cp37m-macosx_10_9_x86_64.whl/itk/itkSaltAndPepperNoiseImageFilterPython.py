...
class itkSaltAndPepperNoiseImageFilterIF2IF2(itkNoiseBaseImageFilterPython.itkNoiseBaseImageFilterIF2IF2):
    ...
    C++ includes: itkSaltAndPepperNoiseImageFilter.h 
    """
    ...
    def GetProbability(self) -> "double":
        ...
        Set/Get the
        probability of the salt and pepper noise event. Defaults to 0.01. 
        """
    ...
    def SetSaltValue(self, _arg: 'float const') -> "void":
        ...
        Set/Get the salt/high
        pixel value. Defaults to NumericTraits<OutputImagePixelType>::max().
    ...
    def SetPepperValue(self, _arg: 'float const') -> "void":
        ...
        Set/Get the
        pepper/low pixel value. Defaults to
