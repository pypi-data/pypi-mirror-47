...
class itkRecursiveGaussianImageFilterIF2IF2(itkRecursiveSeparableImageFilterPython.itkRecursiveSeparableImageFilterIF2IF2):
    ...
    See:   DiscreteGaussianImageFilter Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/EdgesAndGradients/RecursiveGauss
    ianImageFilter Find higher derivatives of an image
