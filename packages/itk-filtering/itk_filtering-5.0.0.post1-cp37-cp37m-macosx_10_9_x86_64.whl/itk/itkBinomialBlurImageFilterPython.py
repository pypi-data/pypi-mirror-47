...
class itkBinomialBlurImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    https://www.itk.org/Wiki/ITK/Examples/Smoothing/BinomialBlurImageFilte
    r Blur an image

    C++ includes: itkBinomialBlurImageFilter.h 
    """
    ...
    def GenerateInputRequestedRegion(self) -> "void":
        ...
        This
        filter needs to request a larger input than its requested output. If
        this filter runs "Repetitions" iterations, then it needs an input
