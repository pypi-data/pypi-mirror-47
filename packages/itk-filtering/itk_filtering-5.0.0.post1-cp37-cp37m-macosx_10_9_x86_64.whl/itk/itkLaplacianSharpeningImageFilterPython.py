...
class itkLaplacianSharpeningImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    See:  LaplacianOperator Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/LaplacianSharpen
    ingImageFilter Sharpen an image

    C++ includes: itkLaplacianSharpeningImageFilter.h 
    """
    ...
    def GenerateInputRequestedRegion(self) -> "void":
        ...
        LaplacianSharpeningImageFilter needs a larger input requested region
        than the output requested region (larger in the direction of the
        derivative). As such, LaplacianSharpeningImageFilter needs to provide
