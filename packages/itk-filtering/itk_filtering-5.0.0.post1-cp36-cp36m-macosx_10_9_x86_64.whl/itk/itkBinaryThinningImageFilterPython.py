...
class itkBinaryThinningImageFilterISS2ISS2(itkImageToImageFilterAPython.itkImageToImageFilterISS2ISS2):
    ...
    See:  MorphologyImageFilter Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/BinaryThinningIm
    ageFilter Skeletonize/thin an image
