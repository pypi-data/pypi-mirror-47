...
class itkContourMeanDistanceImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    Teo Popa, ISIS Center, Georgetown University Wiki Examples:  All
    Examples

    https://www.itk.org/Wiki/ITK/Examples/Curves/ContourMeanDistanceImageF
    ilter Compute the mean distance between all points of two curves
