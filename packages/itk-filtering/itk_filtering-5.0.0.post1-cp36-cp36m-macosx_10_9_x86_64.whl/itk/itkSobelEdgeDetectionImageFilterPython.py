...
class itkSobelEdgeDetectionImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    https://www.itk.org/Wiki/ITK/Examples/EdgesAndGradients/SobelEdgeDetec
    tionImageFilter SobelEdgeDetectionImageFilter

    C++ includes: itkSobelEdgeDetectionImageFilter.h 
    """
    ...
    def GenerateInputRequestedRegion(self) -> "void":
        ...
        SobelEdgeDetectionImageFilter needs a larger input requested region
        than the output requested region (larger in the direction of the
        derivative). As such, SobelEdgeDetectionImageFilter needs to provide
