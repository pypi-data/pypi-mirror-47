...
class itkApproximateSignedDistanceMapImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    Zach Pincus Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/ImageProcessing/ApproximateSigne
    dDistanceMapImageFilter Compute a distance map from objects in a
    binary image
