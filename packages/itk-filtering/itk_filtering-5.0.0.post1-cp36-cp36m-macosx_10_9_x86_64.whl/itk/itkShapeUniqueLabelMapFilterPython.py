...
class itkShapeUniqueLabelMapFilterLM2(itkInPlaceLabelMapFilterPython.itkInPlaceLabelMapFilterLM2):
    ...
    C++ includes: itkShapeUniqueLabelMapFilter.h 
    """
    ...
    def GetReverseOrdering(self) -> "bool":
        ...
        Set/Get the
        ordering of the objects. By default, the objects with a the largest
        attribute value are kept. If set to true, the filter to keeps the
        object with the smallest attribute instead. 
        """
