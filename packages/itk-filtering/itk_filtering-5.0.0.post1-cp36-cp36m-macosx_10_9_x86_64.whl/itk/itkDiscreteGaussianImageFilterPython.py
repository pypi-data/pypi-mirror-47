...
class itkDiscreteGaussianImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    See:   RecursiveGaussianImageFilter Wiki Examples:  All Examples

    https://www.itk.org/Wiki/ITK/Examples/Smoothing/DiscreteGaussianImageF
    ilter Smooth an image with a discrete Gaussian filter
