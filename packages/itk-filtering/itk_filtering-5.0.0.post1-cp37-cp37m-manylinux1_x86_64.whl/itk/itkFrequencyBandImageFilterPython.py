...
class itkFrequencyBandImageFilterICF2(itkUnaryFrequencyDomainFilterPython.itkUnaryFrequencyDomainFilterICF2):
    ...
    C++ includes: itkFrequencyBandImageFilter.h 
    """
    ...
    def GetLowFrequencyThreshold(self) -> "double const &":
        ...
        Band
        range: Low threshold/boundary in Hertz 
        """
    ...
    def SetLowFrequencyThresholdInRadians(self, freqLowInRadians: 'double const &') -> "void":
        ...
        freqLowInRadians:  low freq in radians. 
        """
    ...
    def GetHighFrequencyThreshold(self) -> "double const &":
        ...
        Band
        range: High threshold/boundary in Hertz 
        """
    ...
    def SetFrequencyThresholds(self, freqLow: 'double const &', freqHigh: 'double const &') -> "void":
        ...
        Set
        LowFrequencyThreshold and HighFrequencyThreshold at the same time,
    ...
    def SetFrequencyThresholdsInRadians(self, freqLowInRadians: 'double const &', freqHighInRadians: 'double const &') -> "void":
        ...
        freqHighInRadians:  high freq in radians. 
        """
    ...
    def SetPassLowFrequencyThreshold(self, _arg: 'bool const') -> "void":
        ...
        The
        pixel values that correspond to m_LowFrequencyThreshold are passed to
        the output image, independent of m_PassBand 
        """
    ...
    def SetPassHighFrequencyThreshold(self, _arg: 'bool const') -> "void":
        ...
        The
        pixel values that correspond to m_HighFrequencyThreshold are passed to
        the output image, independent of m_PassBand 
        """
    ...
    def SetPassBand(self, *args) -> "void":
        ...
        Utility method
        equivalent to: SetPassBand(true)
        ...
        pass_low_threshold:  flag to let pass or not low boundary

        pass_high_threshold:  flag to let pass or not high boundary 
        """
    ...
    def SetStopBand(self, pass_low_threshold: 'bool const', pass_high_threshold: 'bool const') -> "void":
        ...
        Utility method
        equivalent to: SetPassBand(false)
        SetPassLowFrequencyThreshold(pass_low_threshold)
        SetPassHighFrequencyThreshold(pass_high_threshold)
    ...
    def SetRadialBand(self, _arg: 'bool const') -> "void":
        ...
        If true the frequency
        cut-off uses the radius of the frequency vector. If false, it uses the
        max absolute value of the frequency vector. 
        """
    ...
    def SetPassNegativeLowFrequencyThreshold(self, _arg: 'bool const') -> "void":
        ...
        Control if negative frequencies with absolute value equal to low
        frequency threshold are passing. Only effective when RadialBand is
        false 
        """
    ...
    def SetPassNegativeHighFrequencyThreshold(self, _arg: 'bool const') -> "void":
        ...
        Control if negative frequencies with absolute value equal to high
        frequency threshold are passing. Only effective when RadialBand is
        false 
        """
