...
class OrderApi(object):
    ...
    def add_order(self, store, order, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.add_order_with_http_info(store, order, **kwargs)  # noqa: E501
            return data
    ...
    def update_order(self, store, order, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_order_with_http_info(store, order, **kwargs)  # noqa: E501
            return data
