...
data=[
    ...
    ["zfcg_gqita_gg","http://www.ccgp-hunan.gov.cn/page/notice/more_city.jsp?noticeTypeID=prcmNotices&area_id=86",
...
if __name__=='__main__':
    ...
    work(conp=conp,pageloadtimeout=120,cdc_total=20,headless=False,num=1)
