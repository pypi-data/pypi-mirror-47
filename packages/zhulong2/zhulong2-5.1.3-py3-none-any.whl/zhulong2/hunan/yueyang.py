    ...
    for i in range(1, int(len(PAGE)) + 1):
        if sum(PAGE[:i - 1]) < num <= sum(PAGE[:i]):
            ...
            headers = {
                ...
                "Referer": "http://www.ccgp-hunan.gov.cn/page/notice/more_city.jsp?noticeTypeID=prcmNotices&area_id=54",
                       }
            ...
            for content in contents:
                ...
                if int(src_code) == 1:
                    ...
                    href = "http://www.ccgp-hunan.gov.cn/page/notice/notice.jsp?noticeId=" + str(href) + '&area_id=54'
...
data=[
    ...
    ["zfcg_gqita_gg","http://www.ccgp-hunan.gov.cn/page/notice/more_city.jsp?noticeTypeID=prcmNotices&area_id=54",
...
if __name__=='__main__':
    ...
    conp=["postgres","since2015","192.168.3.171","lch","hunan_yueyang"]
