...
data = [
    ...
    ["zfcg_zhaobiao_danyilaiyuan_gg", "http://www.ccgp-yuncheng.gov.cn/news_list/3/18/0/0/1.html",
     ["name", "ggstart_time", "href", "info"], add_info(f1,{'method':'单一来源'}), f2],
...
def work(conp, **arg):
    est_meta(conp, data=data, diqu="陕西省运城市", **arg)
