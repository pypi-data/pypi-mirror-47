...
class FileCache:
    def __init__(self, filename_prefix: str = 'fc', cache_dir: str = None):
        """
        Init file cache.
        
        :param str filename_prefix: 
        :param str cache_dir: 
        """
        self._prefix = filename_prefix
        self._dir = cache_dir or tempfile.gettempdir()
    ...
    def __filename(self, key: str):
        ...
        :return: str
        """
        return os.path.join(self._dir, '{}_{}.cache'.format(self._prefix, self.__md5(key)))
