...
def _basic_item_str(item_name, contents, modifiers: Optional[str] = None):
    from dero.latex.logic.format.contents import format_contents
    return rf'\{item_name}{{{format_contents(contents)}}}{modifiers if modifiers is not None else ""}'
